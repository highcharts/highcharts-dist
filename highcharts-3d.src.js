...
(function (Chart3D) {
    ...
    function compose(ChartClass, FxClass) {
        ...
        fxProto.matrixSetter = function () {
            let interpolated;
            if (this.pos < 1 &&
                ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(this.start) || (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(this.end))) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, genericDefaultOptions, Chart3D.defaultOptions);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'init', onInit);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'addSeries', onAddSeries);
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'afterInit', onAfterInit);
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'beforeRedraw', onBeforeRedraw);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(ChartClass, 'beforeRender', onBeforeRender);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(chartProto, 'isInsidePlot', wrapIsInsidePlot);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(chartProto, 'renderSeries', wrapRenderSeries);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(chartProto, 'setClassName', wrapSetClassName);
    }
...
function compose(AreaSeriesClass) {
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(composed, 'Area3DSeries')) {
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(AreaSeriesClass.prototype, 'getGraphPath', wrapAreaSeriesGetGraphPath);
    }
}
/**
...
function Tick3DComposition_compose(TickClass) {
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(Tick3DComposition_composed, 'Axis.Tick3D')) {
...
function onTickAfterGetLabelPosition(e) {
    ...
    if (axis3D) {
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(e.pos, axis3D.fix3dPosition(e.pos));
    }
}
/** @internal */
...
class Axis3DAdditions {
    ...
    static compose(AxisClass, TickClass) {
        ...
        if (!AxisClass.keepProps.includes('axis3D')) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(axisProto, 'getLinePath', wrapAxisGetLinePath);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(axisProto, 'getPlotBandPath', wrapAxisGetPlotBandPath);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(axisProto, 'getPlotLinePath', wrapAxisGetPlotLinePath);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(axisProto, 'getSlotWidth', wrapAxisGetSlotWidth);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(axisProto, 'getTitlePosition', wrapAxisGetTitlePosition);
        }
    }
    /* *
     *
...
class Series3D extends (highcharts_Series_commonjs_highcharts_Series_commonjs2_highcharts_Series_root_Highcharts_Series_default()) {
    ...
    static compose(SeriesClass) {
        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(Series3D_composed, 'Core.Series3D')) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(SeriesClass, 'afterTranslate', function () {
                if (this.chart.is3d()) {
                    this.translate3dPoints();
                }
            });
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(SeriesClass.prototype, {
 ...
 *
 * */
Series3D.defaultOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)((highcharts_Series_commonjs_highcharts_Series_commonjs2_highcharts_Series_root_Highcharts_Series_default()).defaultOptions);
/* *
 *
 *  Default Export
 *
...
(function (SVGRenderer3D) {
    ...
    function polyhedron(args) {
        ...
        result.attr = function (hash, val, complete, continueAnimation) {
            if (typeof hash === 'object' && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(hash.faces)) {
    ...
    function arc3d(attribs) {
        ...
        function extractCustom(params) {
            const ca = {};
            params = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(params); // Don't mutate the original object
            let key;
            for (key in params) {
        ...
        attribs = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(attribs);
...
function onChartAfterCreateAxes() {
    const zAxisOptions = this.options.zAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(this.options.zAxis || {});
    if (!this.is3d()) {
        return;
    }
    this.zAxis = [];
...
class ZAxis extends (highcharts_Axis_commonjs_highcharts_Axis_commonjs2_highcharts_Axis_root_Highcharts_Axis_default()) {
    ...
    static compose(ChartClass) {
        ...
        if (!chartProto.addZAxis) {
            ZAxis_defaultOptions.zAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(ZAxis_defaultOptions.xAxis, {
                offset: 0,
                lineWidth: 0
            });
...
function columnSeriesTranslate3dShapes() {
    ...
    for (const point of series.points) {
        ...
        if (point.y !== null) {
            const shapeArgs = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({ x: 0, y: 0, width: 0, height: 0 }, point.shapeArgs || {}), 
            ...
            point.shapeArgs = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(shapeArgs, {
                z,
                depth,
                insidePlotArea: true
            });
...
function Column3DComposition_compose(SeriesClass, StackItemClass) {
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(Column3DComposition_composed, 'Column3D')) {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(seriesProto, 'alignDataLabel', wrapSeriesAlignDataLabel);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(seriesProto, 'justifyDataLabel', wrapSeriesJustifyDataLabel);
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(stackItemProto, 'getStackBox', wrapStackItemGetStackBox);
        if (ColumnSeriesClass) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(columnSeriesProto, 'afterInit', onColumnSeriesAfterInit);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnPointProto, 'hasNewShapeType', wrapColumnPointHasNewShapeType);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnSeriesProto, 'animate', wrapColumnSeriesAnimate);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnSeriesProto, 'plotGroup', wrapColumnSeriesPlotGroup);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnSeriesProto, 'pointAttribs', wrapColumnSeriesPointAttribs);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnSeriesProto, 'setState', wrapColumnSeriesSetState);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnSeriesProto, 'setVisible', wrapColumnSeriesSetVisible);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnSeriesProto, 'translate', wrapColumnSeriesTranslate);
        }
        if (ColumnRangeSeriesClass) {
            ...
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnRangePointProto, 'hasNewShapeType', wrapColumnPointHasNewShapeType);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnRangeSeriesProto, 'plotGroup', wrapColumnSeriesPlotGroup);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnRangeSeriesProto, 'pointAttribs', wrapColumnSeriesPointAttribs);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnRangeSeriesProto, 'setState', wrapColumnSeriesSetState);
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(columnRangeSeriesProto, 'setVisible', wrapColumnSeriesSetVisible);
        }
    }
}
/**
