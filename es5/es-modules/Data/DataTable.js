...
var splice = ColumnUtils.splice, setLength = ColumnUtils.setLength;
...
var DataTable = /** @class */ (function (_super) {
    ...
    DataTable.prototype.deleteRows = function (rowIndex, rowCount, eventDetail) {
        ...
        var _a = this, columns = _a.columns, modifier = _a.modifier;
        var deletedRows = [];
        var indices;
        var actualRowCount;
        if (!defined(rowIndex)) {
        ...
        if (actualRowCount > 0) {
            ...
            for (var i = 0; i < columnIds.length; ++i) {
                ...
                if (indices.length === 1 && actualRowCount > 1) {
                    var result = splice(column, indices[0], actualRowCount);
    ...
    DataTable.prototype.setColumns = function (columns, rowIndex, eventDetail, typeAsOriginal) {
        var table = this, tableColumns = table.columns, tableModifier = table.modifier, columnIds = Object.keys(columns);
    ...
    DataTable.prototype.setRows = function (rows, rowIndex, insert, eventDetail) {
        ...
        var table = this, columns = table.columns, columnIds = Object.keys(columns), modifier = table.modifier, rowCount = rows.length;
        table.emit({
            type: 'setRows',
            detail: eventDetail,
            rowCount: rowCount,
