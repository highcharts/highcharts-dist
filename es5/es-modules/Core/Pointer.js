 ...
 */
var checkActionKey = function (e, key) {
    return !defined(key) || e["".concat(key, "Key")];
};
/* *
 *
 *  Class
...
var Pointer = /** @class */ (function () {
    ...
    Pointer.prototype.drag = function (e) {
        var chart = this.chart, _a = chart.mouseDownX, mouseDownX = _a === void 0 ? 0 : _a, _b = chart.mouseDownY, mouseDownY = _b === void 0 ? 0 : _b, chartOptions = chart.options, _c = chartOptions.chart, panning = _c.panning, panKey = _c.panKey, selectionMarkerFill = _c.selectionMarkerFill, plotLeft = chart.plotLeft, plotTop = chart.plotTop, plotWidth = chart.plotWidth, plotHeight = chart.plotHeight, panningEnabled = isObject(panning) ?
            panning.enabled :
    ...
    */
    ...
    Pointer.prototype.setDOMEvents = function () {
        ...
        getParent = function (el) {
            var _a, _b;
            return el.parentElement || ((_b = (_a = el.getRootNode()) === null || _a === void 0 ? void 0 : _a.host) === null || _b === void 0 ? void 0 : _b.parentElement);
        };
        ...
        var parent = getParent(this.chart.renderTo);
