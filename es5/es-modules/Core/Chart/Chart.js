...
var Chart = /** @class */ (function () {
    ...
    Chart.prototype.init = function (userOptions, callback) {
        ...
        fireEvent(this, 'init', { args: arguments }, function () {
            var _this = this;
            var _a, _b;
            var options = merge(defaultOptions, userOptions), optionsChart = options.chart, renderTo = this.renderTo || optionsChart.renderTo;
            /**
    ...
    Chart.prototype.getDataTable = function (options) {
        return (options.dataTable ? splat(options.dataTable) : []).map(function (dataTableOptions) { return (dataTableOptions.isDataTable ?
            dataTableOptions :
    ...
    Chart.prototype.layOutTitles = function (redraw) {
        ...
        ['title', 'subtitle', 'caption'].forEach(function (key) {
            ...
            if (desc && descOptions) {
                ...
                (_a = alignAttr.align) !== null && _a !== void 0 ? _a : (alignAttr.align = key === 'title' ?
                    ...
                    (_b = _this.title) === null || _b === void 0 ? void 0 : _b.alignValue);
    ...
    Chart.prototype.getContainer = function () {
         ...
         */
        chart.renderer = new SVGRenderer(container, chartWidth, chartHeight, void 0, optionsChart.forExport, (_b = options.exporting) === null || _b === void 0 ? void 0 : _b.allowHTML, chart.styledMode, options.palette, chart.index);
    ...
    Chart.prototype.setChartSize = function (skipAxes) {
        var _a, _b;
        var chart = this, chartHeight = chart.chartHeight, chartWidth = chart.chartWidth, clipOffset = chart.clipOffset, inverted = chart.inverted, spacing = chart.spacing, renderer = chart.renderer, clipRoundFunc = Math[inverted ? 'floor' : 'round'];
    ...
    Chart.prototype.drawChartBox = function () {
        var chart = this, optionsChart = chart.options.chart, backgroundColor = optionsChart.backgroundColor, plotBackgroundColor = optionsChart.plotBackgroundColor, plotBackgroundImage = optionsChart.plotBackgroundImage, _a = optionsChart.plotBorderRadius, plotBorderRadius = _a === void 0 ? 0 : _a, shadow = optionsChart.shadow, chartWidth = chart.chartWidth, chartHeight = chart.chartHeight, clipBox = chart.clipBox, clipOffset = chart.clipOffset, clipRect = chart.clipRect, plotBGImage = chart.plotBGImage, plotBox = chart.plotBox, plotLeft = chart.plotLeft, plotTop = chart.plotTop, plotWidth = chart.plotWidth, plotHeight = chart.plotHeight, renderer = chart.renderer, styledMode = chart.styledMode;
        ...
        plotBackground[verb](__assign(__assign({}, plotBox), { r: plotBorderRadius }));
        if (!styledMode) {
        ...
        var strokeWidth = plotBorder.strokeWidth(), plotBorderBox = merge(plotBorder.crisp(plotBox, -strokeWidth));
        ...
        if (clipOffset && !styledMode) {
            var extendUp = clipOffset[0] - strokeWidth / 2, extendLeft = clipOffset[3] - strokeWidth / 2;
        ...
        // the inside clip.
        ['plotClipOuter', 'plotClipInner'].forEach(function (prop, i) {
            var _a;
            var clip = chart[prop], sw = i ? -strokeWidth : strokeWidth;
            clip === null || clip === void 0 ? void 0 : clip[plotBorderRadius ? verb : 'attr']({
            ...
            (_a = clip === null || clip === void 0 ? void 0 : clip.parentGroup) === null || _a === void 0 ? void 0 : _a.attr({
    ...
    Chart.prototype.linkSeries = function (isUpdating) {
        ...
        chartSeries.forEach(function (series) {
            var _a, _b;
            var linkedTo = series.options.linkedTo, linkedParent = isString(linkedTo) && (linkedTo === ':previous' ?
            ...
            if (linkedParent &&
                ...
                series.visible = ((_b = (_a = series.options.visible) !== null && _a !== void 0 ? _a : linkedParent.options.visible) !== null && _b !== void 0 ? _b : series.visible); // #3879
            }
        });
    ...
    Chart.prototype.render = function () {
        var _a, _b, _c;
        var chart = this, axes = chart.axes, colorAxis = chart.colorAxis, renderer = chart.renderer, _d = chart.options.chart, _e = _d.axisLayoutRuns, axisLayoutRuns = _e === void 0 ? 2 : _e, plotBorderRadius = _d.plotBorderRadius, renderAxes = function (axes) {
            axes.forEach(function (axis) {
                if (axis.visible) {
                    axis.render();
                }
        ...
        for (var _i = 0, axes_1 = axes; _i < axes_1.length; _i++) {
            var axis = axes_1[_i];
            var options = axis.options, labels = options.labels, offset = options.offset;
        ...
        while ((redoHorizontal || redoVertical || axisLayoutRuns > 1) &&
            ...
            var tempWidth = chart.plotWidth, tempHeight = chart.plotHeight, threshold = [1.05, 1.1];
    ...
    Chart.prototype.addCredits = function (credits) {
        ...
        if (creds.enabled && !this.credits) {
            ...
            if ((_a = creds.events) === null || _a === void 0 ? void 0 : _a.click) {
     ...
     * @internal
     */
    Chart.prototype.warnIfCSSNotLoaded = function () {
        if (this.styledMode) {
            var containerStyle = win.getComputedStyle(this.container);
    ...
    Chart.prototype.showLoading = function (str) {
        var _a, _b, _c, _d;
        var chart = this, options = chart.options, loadingOptions = options.loading, loadingStyle = (_a = loadingOptions === null || loadingOptions === void 0 ? void 0 : loadingOptions.style) !== null && _a !== void 0 ? _a : {}, setLoadingSize = function () {
            var _a, _b, _c, _d;
            if (loadingDiv) {
                css(loadingDiv, {
                    left: (_a = loadingStyle.left) !== null && _a !== void 0 ? _a : chart.plotLeft + 'px',
                    top: (_b = loadingStyle.top) !== null && _b !== void 0 ? _b : chart.plotTop + 'px',
                    width: (_c = loadingStyle.width) !== null && _c !== void 0 ? _c : chart.plotWidth + 'px',
                    height: (_d = loadingStyle.height) !== null && _d !== void 0 ? _d : chart.plotHeight + 'px'
                });
            }
        };
    ...
    Chart.prototype.showResetZoom = function () {
        var chart = this, lang = chart.options.lang, btnOptions = chart.zooming.resetButton, theme = btnOptions.theme, alignTo = (btnOptions.relativeTo === 'chart' ||
    ...
    Chart.prototype.transform = function (params) {
        ...
        var _this = this;
        var _b, _c, _d;
        var _e = params.axes, axes = _e === void 0 ? this.axes : _e, event = params.event, _f = params.from, from = _f === void 0 ? {} : _f, reset = params.reset, selection = params.selection, _g = params.to, to = _g === void 0 ? {} : _g, trigger = params.trigger, _h = params.allowResetButton, allowResetButton = _h === void 0 ? true : _h, _j = this, inverted = _j.inverted, time = _j.time;
