 ...
 * @internal
 */
var clearTimeouts = function (tooltip) {
...
var Tooltip = /** @class */ (function () {
    ...
    Tooltip.prototype.getLabel = function (_a) {
        var _b, _c;
        var _d = _a === void 0 ? { anchorX: 0, anchorY: 0 } : _a, anchorX = _d.anchorX, anchorY = _d.anchorY;
        ...
        if (!this.label) {
            if (this.outside) {
                var chart = this.chart, chartStyle = chart.options.chart.style;
                /**
                ...
                css(container, {
                    ...
                    top: '1px',
                    pointerEvents: 'none',
                    zIndex: Math.max(options.style.zIndex || 0, ((chartStyle === null || chartStyle === void 0 ? void 0 : chartStyle.zIndex) || 0) + 3)
                });
                /**
            ...
            if (doSplit) {
                ...
                if (!styledMode) {
                    this.label
                        ...
                        'stroke-width': (_b = options.borderWidth) !== null && _b !== void 0 ? _b : +!options.fixed
                    })
                        // #2301, #2657
                        .css(options.style)
                        .css({
            ...
            this.label
                .attr({ zIndex: 8 })
                .shadow((_c = options.shadow) !== null && _c !== void 0 ? _c : !options.fixed)
                .add();
        }
    ...
    Tooltip.prototype.refresh = function (pointOrPoints, mouseEvent) {
        ...
        if (text === false) {
            ...
            this.showTimer = syncTimeout(function () {
                // Update text
                    ...
                    if (chart.polar ||
                        ...
                        if (!options.style.width || styledMode) {
                            label.css({
                                ...
                                width: (_this.outside ?
                                    _this.getPlayingField() :
                                    chart.spacingBox).width - 2 * options.padding + 'px'
                            });
                        }
                        label.attr({
                        ...
                        if (_this.outside) {
                            label.attr({
                                x: clamp(label.x || 0, 0, _this.getPlayingField().width -
                                    (label.width || 0) -
                                    1)
                            });
                        }
    ...
    Tooltip.prototype.renderSplit = function (labels, points) {
         ...
         * @internal
         */
        var defaultPositioner = function (boxWidth, boxHeight, point, ctx, anchor, alignedLeft) {
        ...
        function updatePartialTooltip(partialTooltip, point, str) {
            ...
            var isHeader = point.isHeader, series = point.series, ttOptions = series.tooltipOptions || options, specificOptions = isHeader ?
            ...
            if (!tt) {
                ...
                if (!styledMode) {
                    ...
                    attribs['stroke-width'] = (_a = specificOptions.borderWidth) !== null && _a !== void 0 ? _a : +!ttOptions.fixed;
                }
                tt = ren
        ...
        var boxes = labels.slice(0, points.length + 1).reduce(function (boxes, str, i) {
            if (str !== false && str !== '') {
                ...
                if (typeof anchorY === 'number') {
                    var size = bBox.height + 1, boxPosition = (positioner || defaultPositioner).call(tooltip, boxWidth, size, point, tooltip, [anchorX, anchorY]);
                    boxes.push({
        ...
        if (!hasFixedPosition && boxes.some(function (box) {
            ...
            boxes = boxes.map(function (box) {
                var _a = defaultPositioner.call(_this, box.boxWidth, box.size, box.point, void 0, [box.anchorX, box.anchorY], false), x = _a.x, y = _a.y;
                return extend(box, {
                    target: y,
                    x: x
                });
    ...
    Tooltip.prototype.updatePosition = function (point) {
        var _a, _b;
        var _c = this, chart = _c.chart, container = _c.container, distance = _c.distance, options = _c.options, pointer = _c.pointer, renderer = _c.renderer, label = this.getLabel(), _d = label.height, height = _d === void 0 ? 0 : _d, _e = label.width, width = _e === void 0 ? 0 : _e, fixed = options.fixed, positioner = options.positioner, 
        // Needed for outside: true (#11688)
        _f = pointer.getChartPosition(), left = _f.left, top = _f.top, scaleX = _f.scaleX, scaleY = _f.scaleY, pos = (positioner ||
        ...
        if (renderer && container) {
            ...
            if (positioner || fixed) {
                var _g = ((_a = chart
                    .scrollablePlotArea) === null || _a === void 0 ? void 0 : _a.scrollingContainer) || {}, _h = _g.scrollLeft, scrollLeft = _h === void 0 ? 0 : _h, _j = _g.scrollTop, scrollTop = _j === void 0 ? 0 : _j;
                pos.x += scrollLeft;
                pos.y += scrollTop;
            }
            // Pad it by the border width and distance. Add 2 to make room for
            // the default shadow (#19314).
            pad = ((_b = options.borderWidth) !== null && _b !== void 0 ? _b : +!fixed) + 2 * distance + 2;
            renderer.setSize(
