...
(function (RadialAxis) {
    ...
    function getLinePath(_lineWidth, radius, innerRadius) {
        ...
        var end, path, r = pick(radius, center[2] / 2 - this.offset);
    ...
    function getPlotBandPath(from, to, options) {
        ...
        var start, end, angle, xOnPerimeter, open, path, outerRadius = pick(radiusToPixels(options.outerRadius), fullRadius), innerRadius = radiusToPixels(options.innerRadius), thickness = radiusToPixels(options.thickness), brStart = true, brEnd = true;
    ...
    function getPlotLinePath(options) {
        ...
        var value = chart.time.parse(options.value) || 0, innerRatio, distance, a, b, otherAxis, xy, tickPositions, crossPos, path;
        var end = this.getPosition(value, center[2] / 2 + (this.isCircular ? this.offset : 0));
    ...
    function onAxisAfterTickSize(e) {
        ...
        if (this.chart.angular) {
            var _c = this, options = _c.options, pane = _c.pane;
            if (pane.hasSeriesType('gauge')) {
                e.tickSize = [
                    (_a = options["".concat(e.prefix, "Length")]) !== null && _a !== void 0 ? _a : 10,
                    (_b = options["".concat(e.prefix, "Width")]) !== null && _b !== void 0 ? _b : 1
                ];
                // Negate the length
                if (options["".concat(e.prefix, "Position")] === 'inside') {
                    e.tickSize[0] *= -1;
                }
            }
        }
    ...
    function onTickAfterGetLabelPosition(e) {
        ...
        if (axis.isRadial) { // Both X and Y axes in a polar chart
            ret = axis.getPosition(this.pos, (axis.center[2] / 2) +
                relativeLength((_a = labelOptions.distance) !== null && _a !== void 0 ? _a : -25, axis.center[2] / 2) +
                axis.offset);
