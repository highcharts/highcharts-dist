...
var Tick = /** @class */ (function () {
    ...
    Tick.prototype.addLabel = function () {
        var _a, _b;
        var tick = this, axis = tick.axis, options = axis.options, chart = axis.chart, categories = axis.categories, log = axis.logarithmic, names = axis.names, pos = tick.pos, labelOptions = pick((_a = tick.options) === null || _a === void 0 ? void 0 : _a.labels, options.labels), tickPositions = axis.tickPositions, isFirst = pos === tickPositions[0], isLast = pos === tickPositions[tickPositions.length - 1], tickPositionInfo = tickPositions.info, boundary = tickPositionInfo === null || tickPositionInfo === void 0 ? void 0 : tickPositionInfo.boundaryTicks[pos], DTLFormats = options.dateTimeLabelFormats;
        ...
        if (axis.dateTime && DTLFormats) {
            if (tickPositionInfo) {
                ...
                var unitName = tickPositionInfo.unitName, boundaryKey = boundariesMap[unitName], format = !((_b = options.grid) === null || _b === void 0 ? void 0 : _b.enabled) &&
                    boundary &&
                    boundaryKey &&
        ...
        var text = labelFormatter.call(ctx, ctx);
