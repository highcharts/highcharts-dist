            ...
            while (i--) {
                ...
                if (next.x - current.x > gapSize) {
                    ...
                    if (yAxis.stacking && this.options.stacking) {
                        stack = yAxis.stacking.stacks[this.stackKey][xRange] = new StackItem(yAxis, yAxis.options.stackLabels, false, xRange, (_a = this.stack) !== null && _a !== void 0 ? _a : '');
                        stack.total = 0;
                    }
                }
            ...
            if (hasBreaks) {
                ...
                axis.setAxisTranslation = function () {
                    ...
                    if (brokenAxis.hasBreaks) {
                        ...
                        var length_1 = 0, inBrk_1, repeat_1, min_1 = (_b = axis.userMin) !== null && _b !== void 0 ? _b : axis.min, max_1 = (_c = axis.userMax) !== null && _c !== void 0 ? _c : axis.max, start_1, i_1;
                        // Extend range to include visible breaks outside of
                        // series data.
                        var dataMin_1 = isNumber(min_1) ?
                            Math.min((_d = axis.dataMin) !== null && _d !== void 0 ? _d : min_1, min_1) :
                            ((_e = axis.dataMin) !== null && _e !== void 0 ? _e : min_1), dataMax_1 = isNumber(max_1) ?
                            Math.max((_f = axis.dataMax) !== null && _f !== void 0 ? _f : max_1, max_1) :
