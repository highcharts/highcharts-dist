...
var Axis = /** @class */ (function () {
    ...
    Axis.prototype.defaultLabelFormatter = function () {
        ...
        ret !== null && ret !== void 0 ? ret : (ret = numberFormatter(value, -1, void 0, 
     ...
     */
    Axis.prototype.nameToX = function (point, nameX) {
        var _a;
        var explicitCategories = isArray(this.options.categories), name = point.name, series = point.series, names = explicitCategories ? this.categories : this.names, namesMap = this.namesMap;
        var x;
        ...
        if (!defined(nameX)) {
            nameX = this.uniqueNames && names ?
                (explicitCategories ?
                    names.indexOf(name) :
                    ((_a = namesMap[name]) !== null && _a !== void 0 ? _a : -1)) :
    ...
    Axis.prototype.updateNames = function () {
        var axis = this, _a = this, names = _a.names, namesMap = _a.namesMap, i = names.length;
        if (i > 0) {
    ...
    Axis.prototype.setTickPositions = function () {
        ...
        if (!this.isDirty &&
            tickPositions.length !==
                ((_c = this.tickPositions) === null || _c === void 0 ? void 0 : _c.length)) {
            this.isDirty = true;
        }
        this.tickPositions = tickPositions;
    ...
    Axis.prototype.getThresholdAlignment = function (callerAxis) {
        if (!isNumber(this.dataMin) ||
            (this !== callerAxis &&
                this.series.some(function (s) { var _a; 
                // The xAxis.isDirty check is for setExtremes (#23677)
                return s.isDirty || s.isDirtyData || ((_a = s.xAxis) === null || _a === void 0 ? void 0 : _a.isDirty); }))) {
    ...
    Axis.prototype.autoLabelAlign = function (rotation) {
        var angle = ((rotation - this.side * 90) % 360 + 360) % 360, evt = { align: 'center' };
    ...
    Axis.prototype.tickSize = function (prefix) {
        ...
        var e = { tickSize: tickSize, prefix: prefix };
    ...
    Axis.prototype.renderUnsquish = function () {
        ...
        tickPositions.forEach(function (tickPosition) {
            var _a;
            maxLabelLength = Math.max(maxLabelLength, ((_a = ticks[tickPosition].label) === null || _a === void 0 ? void 0 : _a.textPxLength) || 0);
        });
        ...
        tickPositions.forEach(function (pos) {
            ...
            if (label) {
                ...
                if (tick.shortenLabel) {
                    ...
                    var wasSquished = label.styles.width ||
     ...
     * @internal
     */
    Axis.prototype.shuffleTicks = function () {
        var _this = this;
        var _a;
        var ticks = this.ticks, oldNames = (_a = this.old) === null || _a === void 0 ? void 0 : _a.names;
        if (this.type === 'category' && oldNames) {
            oldNames.forEach(function (name, oldPos) {
                ...
                if (defined(pos) && oldPos !== pos) {
                    ...
                    // new place to go
                    if (ticks[pos] &&
                        _this.names.indexOf(oldNames[pos]) === -1) {
    ...
    Axis.prototype.getOffset = function () {
        var axis = this, chart = axis.chart, horiz = axis.horiz, options = axis.options, side = axis.side, ticks = axis.ticks, tickPositions = axis.tickPositions, coll = axis.coll, hasData = axis.hasData(), axisTitleOptions = options.title, labelOptions = options.labels, hasCrossing = isNumber(options.crossing), axisOffset = chart.axisOffset, clipOffset = chart.clipOffset, directionFactor = [-1, 1, 1, -1][side];
        var tickRotCorr = axis.tickRotCorr || { x: 0, y: 0 }, absTickRotCorrX = 0, showAxis, titleOffset = 0, titleOffsetOption, titleMargin = 0, labelOffset = 0, // Reset
    ...
    Axis.prototype.drawCrosshair = function (e, point) {
        var _this = this;
        var _a, _b;
        var options = this.crosshair, snap = (_a = options === null || options === void 0 ? void 0 : options.snap) !== null && _a !== void 0 ? _a : true, chart = this.chart, graphic = this.cross;
        var path, pos, categorized, crossOptions;
        ...
        !options ||
            ...
            this.crossShowTimer = syncTimeout(function () {
                ...
                // Draw the cross
                if (!cross) {
                    _this.cross = cross = chart.renderer
                        .path()
