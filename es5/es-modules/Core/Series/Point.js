...
var Point = /** @class */ (function () {
    ...
    function Point(series, options, x) {
        ...
        this.category = (_e = (_d = (_c = series.xAxis) === null || _c === void 0 ? void 0 : _c.categories) === null || _d === void 0 ? void 0 : _d[this.x]) !== null && _e !== void 0 ? _e : this.x;
        this.key = (_f = this.name) !== null && _f !== void 0 ? _f : this.category;
     ...
     *         The Point instance.
     */
    Point.prototype.applyOptions = function (options, x, isMock) {
     ...
     */
    Point.prototype.getOrigin = function (_a, shape) {
        var _b;
        var _c = _a.x, x = _c === void 0 ? 0 : _c, _d = _a.y, y = _d === void 0 ? 0 : _d;
        if (shape === void 0) { shape = {}; }
        var _e = this, graphic = _e.graphic, series = _e.series;
        // The chart is inverted, but the marker group is not, like a scatter
        // series in an inverted chart.
        if (series.chart.inverted &&
            (graphic === null || graphic === void 0 ? void 0 : graphic.parentGroup) &&
            !((_b = graphic === null || graphic === void 0 ? void 0 : graphic.parentGroup) === null || _b === void 0 ? void 0 : _b.rotation)) {
            var pos = this.pos(false, x, y);
            if (pos) {
                x = pos[0];
                y = pos[1];
            }
    ...
    Point.prototype.destroy = function () {
        var _a;
        if (!this.condemned) {
            var point_1 = this, series = point_1.series, chart = series.chart, hoverPoints = chart.hoverPoints, globalAnimation = point_1.series.chart.renderer.globalAnimation, duration = animObject(globalAnimation).duration;
            /**
    ...
    Point.prototype.destroyElements = function (kinds) {
        if (kinds === void 0) { kinds = { graphic: 1, dataLabel: 1 }; }
     ...
     */
    Point.prototype.pos = function (chartCoordinates, plotX, plotY) {
        if (plotX === void 0) { plotX = this.plotX; }
        if (plotY === void 0) { plotY = this.plotY; }
        var series = this.series, _a = series || {}, chart = _a.chart, xAxis = _a.xAxis, yAxis = _a.yAxis;
        var posX = 0, posY = 0;
    ...
    Point.prototype.resolveColor = function () {
        var _a, _b;
        var _c = this, options = _c.options, series = _c.series, chart = series.chart, optionsChart = chart.options.chart, styledMode = chart.styledMode;
        var color, colorCount = optionsChart.colorCount, colorIndex;
        // Remove points nonZonedColor for later recalculation
        delete this.nonZonedColor;
        if (series.options.colorByPoint) {
            if (!styledMode) {
                var colors = series.options.colors ||
                    chart.options.colors;
                color = colors === null || colors === void 0 ? void 0 : colors[series.colorCounter];
                colorCount = colors === null || colors === void 0 ? void 0 : colors.length;
            }
        ...
        this.colorIndex = (_a = options.colorIndex) !== null && _a !== void 0 ? _a : colorIndex;
        this.color = (_b = options.color) !== null && _b !== void 0 ? _b : color;
    };
    /**
    ...
    Point.prototype.update = function (options, redraw, animation, runEvent) {
        ...
        var point = this, series = point.series, graphic = point.graphic, chart = series.chart, seriesOptions = series.options, dataOptions = seriesOptions.data;
        /**
        ...
        function update() {
            ...
            var hasMockGraphic = graphic && point.hasMockGraphic, index = point.index;
            ...
            if (isObject(options, true)) {
                ...
                if (graphic === null || graphic === void 0 ? void 0 : graphic.element) {
                    ...
                    if ((options === null || options === void 0 ? void 0 : options.marker) &&
            ...
            if (!series.hasProcessedDataTable) {
                ...
                if (dataOptions) {
                    dataOptions[index] = (isObject(dataOptions[index], true) ||
                        ...
                        point.options :
                        options !== null && options !== void 0 ? options : dataOptions[index];
                }
            }
            // Redraw
        ...
        point.firePointEvent(selected ? 'select' : 'unselect', { accumulate: accumulate }, function () {
            ...
            if (!accumulate) {
                chart.getSelectedPoints().forEach(function (loopPoint) {
                    var loopSeries = loopPoint.series, loopSeriesOptions = loopSeries.options;
