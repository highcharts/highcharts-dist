...
var Navigator = /** @class */ (function () {
    ...
    Navigator.prototype.renderElements = function () {
        ...
        if ((_b = navigatorOptions.handles) === null || _b === void 0 ? void 0 : _b.enabled) {
            ...
            if (redrawHandles_1) {
                ...
                navigator.partsEventsToUnbind = __spreadArray(__spreadArray([], navigator.getPartsEvents('mousedown'), true), navigator.getPartsEvents('touchstart'), true);
            }
        }
    };
    /**
        ...
        ['shades', 'handles'].forEach(function (name) {
            navigator[name].forEach(function (navigatorItem, index) {
                events.push(addEvent(navigatorItem.element, eventName, function (e) {
                    navigator["".concat(name, "Mousedown")](e, index);
                }));
            });
        });
        return events;
    ...
    Navigator.prototype.updateNavigatorSeries = function (addEvents, redraw) {
        ...
        if (baseSeries && baseSeries.length) {
            baseSeries.forEach(function (base) {
                ...
                (_a = defaultOptions.plotOptions[mergedNavSeriesOptions.type || 'line']) === null || _a === void 0 ? void 0 : _a.pointRange);
                // Merge data separately. Do a slice to avoid mutating the
                // navigator options from base series (#4923).
                var navigatorSeriesData = baseNavigatorOptions.data || userNavOptions.data, navigatorSeriesDataTable = baseNavigatorOptions.dataTable ||
        ...
        if (((chartNavigatorSeriesOptions === null || chartNavigatorSeriesOptions === void 0 ? void 0 : chartNavigatorSeriesOptions.data) ||
            ...
            chartNavigatorSeriesOptions.forEach(function (userSeriesOptions, i) {
                ...
                mergedNavSeriesOptions = merge((_a = defaultOptions.navigator) === null || _a === void 0 ? void 0 : _a.series, {
    ...
    Navigator.prototype.modifyBaseAxisExtremes = function () {
        var _a;
        var baseXAxis = this, navigator = baseXAxis.chart.navigator, baseExtremes = baseXAxis.getExtremes(), baseMin = baseExtremes.min, baseMax = baseExtremes.max, baseDataMin = baseExtremes.dataMin, baseDataMax = baseExtremes.dataMax, range = baseMax - baseMin, stickToMin = navigator === null || navigator === void 0 ? void 0 : navigator.stickToMin, stickToMax = navigator === null || navigator === void 0 ? void 0 : navigator.stickToMax, overscroll = pick((_a = baseXAxis.ordinal) === null || _a === void 0 ? void 0 : _a.convertOverscroll(baseXAxis.options.overscroll), 0), navigatorSeries = navigator.series && navigator.series[0], hasSetExtremes = !!baseXAxis.setExtremes, 
