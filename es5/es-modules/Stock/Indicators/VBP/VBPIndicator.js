...
var VBPIndicator = /** @class */ (function (_super) {
    ...
    VBPIndicator.prototype.init = function (chart, options) {
        ...
        var unbinder = addEvent(this.chart.constructor, 'afterLinkSeries', function () {
            ...
            if (indicator.options) {
                var params = indicator.options.params, baseSeries = indicator.linkedParent, volumeSeries = (params === null || params === void 0 ? void 0 : params.volumeSeriesID) ?
    ...
    VBPIndicator.prototype.getValues = function (series, params) {
        var indicator = this, xValues = series.getColumn('x', true), yValues = series.processedYData, chart = indicator.chart, ranges = params.ranges, VBP = [], xData = [], yData = [], volumeSeries = chart.get(params.volumeSeriesID);
