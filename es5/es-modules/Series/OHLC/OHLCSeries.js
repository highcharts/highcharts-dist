...
var OHLCSeries = /** @class */ (function (_super) {
    ...
    OHLCSeries.prototype.getPointPath = function (point) {
        var path = _super.prototype.getPointPath.call(this, point), strokeWidth = this.borderWidth, crispX = crisp(point.plotX || 0, strokeWidth), halfWidth = Math.round(point.shapeArgs.width / 2);
        if (point.open !== null) {
