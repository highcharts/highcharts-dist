...
var WaterfallSeries = /** @class */ (function (_super) {
    ...
    WaterfallSeries.prototype.processData = function (force) {
        ...
        var subSum, sum, dataMin, dataMax, y;
...
addEvent(WaterfallSeries, 'afterColumnTranslate', function () {
    var _a, _b;
    var _c, _d;
    var series = this, options = series.options, points = series.points, yAxis = series.yAxis, minPointLength = pick(options.minPointLength, 5), halfMinPointLength = minPointLength / 2, threshold = options.threshold || 0, stacking = options.stacking, actualStack = (_c = yAxis.waterfall) === null || _c === void 0 ? void 0 : _c.stacks[series.stackKey], processedYData = series.getColumn('y', true);
    var previousIntermediate = threshold, previousY = threshold, y, total, hPos;
