...
var TreemapSeries = /** @class */ (function (_super) {
    ...
    TreemapSeries.prototype.pointAttribs = function (point, state) {
        ...
        var series = this, mapOptionsToLevel = (isObject(series.mapOptionsToLevel) ?
            ...
            {}), level = (point === null || point === void 0 ? void 0 : point.node) && mapOptionsToLevel[point.node.level] || {}, options = this.options, stateOptions = state && options.states && options.states[state] || {}, className = (point === null || point === void 0 ? void 0 : point.node) && point.getClassName() || '', 
