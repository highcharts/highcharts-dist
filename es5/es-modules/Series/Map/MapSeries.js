...
var MapSeries = /** @class */ (function (_super) {
    ...
    MapSeries.prototype.pointAttribs = function (point, state) {
        var _a, _b, _c;
        var _d = ((point === null || point === void 0 ? void 0 : point.series) || this).chart, mapView = _d.mapView, styledMode = _d.styledMode;
        ...
        if (state) {
            var stateOptions = merge((_a = this.options.states) === null || _a === void 0 ? void 0 : _a[state], ((_b = point === null || point === void 0 ? void 0 : point.options.states) === null || _b === void 0 ? void 0 : _b[state]) || {}), stateStrokeWidth = this.getStrokeWidth(stateOptions);
    ...
    MapSeries.prototype.processData = function () {
        var options = this.options, dataTable = this.dataTable, chart = this.chart, chartOptions = chart.options.chart, joinBy = this.joinBy, dataUsed = [], mapMap = {}, mapView = this.chart.mapView, mapDataObject = mapView && (
