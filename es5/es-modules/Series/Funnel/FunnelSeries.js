...
var FunnelSeries = /** @class */ (function (_super) {
    ...
    FunnelSeries.prototype.alignDataLabel = function (point, dataLabel, options, alignTo, isNew) {
        var _a;
        var series = point.series, reversed = series.options.reversed, dlBox = point.dlBox || point.shapeArgs, align = options.align, verticalAlign = options.verticalAlign, padding = splat(options.padding || 0), inside = ((series.options || {}).dataLabels || {}).inside, centerY = series.center[1], plotY = point.plotY || 0, pointPlotY = (reversed ?
            2 * centerY - plotY :
            plotY), 
    ...
    FunnelSeries.prototype.getDataLabelPosition = function (point, distance) {
        var y = point.plotY || 0, sign = point.half ? 1 : -1, x = this.getXPos(y, !!point.half, point);
        return {
            distance: distance,
