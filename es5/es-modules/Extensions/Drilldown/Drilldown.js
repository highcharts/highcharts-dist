...
import { diffObjects, defined, extend, merge, objectEach, syncTimeout, fireEvent, addEvent, removeEvent, isObject } from '../../Shared/Utilities.js';
/* *
 *
 *  Variables
 *
...
var ChartAdditions = /** @class */ (function () {
    ...
    ChartAdditions.prototype.addSingleSeriesAsDrilldown = function (point, ddOptions) {
        ...
        var chart = (this.chart ||
            ...
            { color: point.color || oldSeries.color }, levelNumber = (_b = oldSeries.options._levelNumber) !== null && _b !== void 0 ? _b : 0;
        ...
        var newSeries = chart.addSeries(ddOptions, false);
                ...
                if (level.levelNumber === levelToRemove) {
                    level.levelSeries.forEach(function (series) {
                        ...
                        if (!chart.mapView) {
                            ...
                            var drillAnimOptions = animObject(animOptions);
    ...
    ChartAdditions.prototype.drillUp = function (isMultipleDrillUp) {
        ...
        var drilldownLevels = chart.drilldownLevels, levelNumber = drilldownLevels[drilldownLevels.length - 1].levelNumber, chartSeries = chart.series, drilldownLevelsNumber = chart.drilldownLevels.length, drilldownOptions = chart.options.drilldown || {}, addSeries = function (seriesOptions, oldSeries) {
            var addedSeries;
    ...
    ChartAdditions.prototype.fadeInGroup = function (group) {
        var _a;
        var animationOptions = animObject((_a = this.chart.options.drilldown) === null || _a === void 0 ? void 0 : _a.animation);
        if (group) {
            group.hide();
...
(function (Drilldown) {
    ...
    function compose(AxisClass, ChartClass, highchartsDefaultOptions, SeriesClass, seriesTypes, SVGRendererClass, TickClass) {
        ...
        if (!chartProto.drillUp) {
            var SVGElementClass = SVGRendererClass.prototype.Element, addonProto = ChartAdditions.prototype, axisProto = AxisClass.prototype, elementProto = SVGElementClass.prototype, tickProto = TickClass.prototype;
    ...
    function onChartRender() {
        (this.xAxis || []).forEach(function (axis) {
            ...
            axis.series.forEach(function (series) {
                var xData = series.getColumn('x'), points = series.points;
