...
var markerClusterAlgorithms = {
    ...
    kmeans: function (dataX, dataY, dataIndexes, options) {
        var _a;
        var series = this, clusters = [], noise = [], group = {}, pointMaxDistance = Number((_a = options.processedDistance) !== null && _a !== void 0 ? _a : relativeLength(options.distance ||
    ...
    optimizedKmeans: function (processedXData, processedYData, dataIndexes, options) {
        ...
        var series = this, pointMaxDistance = Number((_a = options.processedDistance) !== null && _a !== void 0 ? _a : relativeLength(options.distance ||
...
function onPointDrillToCluster(event) {
    ...
    point.firePointEvent('drillToCluster', event, function (e) {
        var _a, _b, _c;
        var _d;
        var point = e.point || e.target, series = point.series, xAxis = series.xAxis, yAxis = series.yAxis, chart = series.chart, inverted = chart.inverted, mapView = chart.mapView, pointer = chart.pointer, drillToCluster = (_d = series.options
...
function seriesAnimateClusterPoint(clusterObj) {
    ...
    var parentId, oldPointObj, newPointObj, newPointBBox, offset = 0, newX = 0, newY = 0, isOldPointGraphic = false, isCbHandled = false;
...
function seriesGetScaledGridSize(options) {
    var _a;
    var series = this, xAxis = series.xAxis, mapView = series.chart.mapView, processedGridSize = Number((_a = options.processedGridSize) !== null && _a !== void 0 ? _a : relativeLength(options.gridSize || clusterDefaults.layoutAlgorithm.gridSize, series.chart.plotWidth));
