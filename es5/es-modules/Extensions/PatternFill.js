 ...
 * */
/** @internal */
export var patterns = createPatterns();
/* *
 *
 *  Functions
 *
...
function createAnchoredPattern(pattern, element) {
    var anchoredPattern = merge({}, pattern);
...
function onRendererComplexColor(args) {
    ...
    var pattern = color.pattern, value = 'var(--highcharts-neutral-color-80)';
    // Handle patternIndex
...
function rendererAddPattern(options, animation) {
    var _this = this;
    var animate = pick(animation, true), animationOptions = animObject(animate), color = options.color ||
