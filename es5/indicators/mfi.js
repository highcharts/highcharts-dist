...
module:a[b]}})))}a=a?a._modules:{};f(a,"Stock/Indicators/MFI/MFIIndicator.js",[a["Core/Series/SeriesRegistry.js"],a["Core/Utilities.js"]],function(a,b){function f(a){return a.reduce(function(a,d){return a+d})}function k(a){return(a[1]+a[2]+a[3])/3}var p=this&&this.__extends||function(){var a=function(b,d){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,d){a.__proto__=d}||function(a,d){for(var c in d)Object.prototype.hasOwnProperty.call(d,c)&&(a[c]=d[c])};return a(b,d)};return function(b,
...
c]),t.push(d[b]),u.push(c);return{values:r,xData:t,yData:u}}};b.defaultOptions=w(l.defaultOptions,{params:{index:void 0,volumeSeriesID:"volume",decimals:4}});return b}(l);v(b.prototype,{nameBase:"Money Flow Index"});a.registerSeriesType("mfi",b);"";return b});f(a,"masters/indicators/mfi.src.js",[],function(){})});
