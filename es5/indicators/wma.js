...
module:a[d]}})))}a=a?a._modules:{};f(a,"Stock/Indicators/WMA/WMAIndicator.js",[a["Core/Series/SeriesRegistry.js"],a["Core/Utilities.js"]],function(a,d){function f(a,c){c*=(c+1)/2;return a.reduce(function(b,a,c){return[null,b[1]+a[1]*(c+1)]})[1]/c}function l(a,c,b,g){b=f(a,a.length);c=c[g-1];a.shift();return[c,b]}var q=this&&this.__extends||function(){function a(c,b){a=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,b){a.__proto__=b}||function(a,b){for(var c in b)Object.prototype.hasOwnProperty.call(b,
