...
})(typeof window === 'undefined' ? this : window, function(__WEBPACK_EXTERNAL_MODULE__944__, __WEBPACK_EXTERNAL_MODULE__960__, __WEBPACK_EXTERNAL_MODULE__512__, __WEBPACK_EXTERNAL_MODULE__956__, __WEBPACK_EXTERNAL_MODULE__620__) {
...
var ADIndicator = /** @class */ (function (_super) {
    ...
    ADIndicator.prototype.getValues = function (series, params) {
        ...
        if (!volumeSeries) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)('Series ' +
                volumeSeriesID +
...
var ChaikinIndicator = /** @class */ (function (_super) {
    ...
    ChaikinIndicator.prototype.getValues = function (series, params) {
        ...
        if (periods.length !== 2 || periods[1] <= periods[0]) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)('Error: "Chaikin requires two periods. Notice, first ' +
...
var APOIndicator = /** @class */ (function (_super) {
    ...
    APOIndicator.prototype.getValues = function (series, params) {
        ...
        // Check if periods are correct
        if (periods.length !== 2 || periods[1] <= periods[0]) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)('Error: "APO requires two periods. Notice, first period ' +
...
var KlingerIndicator = /** @class */ (function (_super) {
    ...
    KlingerIndicator.prototype.getCM = function (previousCM, DM, trend, previousTrend, previousDM) {
...
var PPOIndicator = /** @class */ (function (_super) {
    ...
    PPOIndicator.prototype.getValues = function (series, params) {
        ...
        // Check if periods are correct
        if (periods.length !== 2 || periods[1] <= periods[0]) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)('Error: "PPO requires two periods. Notice, first period ' +
                'should be lower than the second one."');
            return;
        }
        // Shorter Period EMA
...
var SupertrendIndicator = /** @class */ (function (_super) {
    ...
    SupertrendIndicator.prototype.init = function () {
        ...
        var unbinder = addEvent(this.chart.constructor, 'afterLinkSeries',
            ...
            _b,
            _c;
            var linkedParent = indicator.linkedParent,
                options = indicator.options;
            ...
            if (options && linkedParent) {
                ...
                // (#9787)
                options.cropThreshold = (((_a = linkedParent.options.cropThreshold) !== null && _a !== void 0 ? _a : 0) -
                    (((_c = (_b = options.params) === null || _b === void 0 ? void 0 : _b.period) !== null && _c !== void 0 ? _c : 0) - 1));
            }
            unbinder();
        }, {
            order: 1
...
var VBPIndicator = /** @class */ (function (_super) {
    ...
    VBPIndicator.prototype.init = function (chart, options) {
        ...
        var unbinder = addEvent(this.chart.constructor, 'afterLinkSeries',
            ...
            volumeSeries = (params === null || params === void 0 ? void 0 : params.volumeSeriesID) ?
                        chart.get(params === null || params === void 0 ? void 0 : params.volumeSeriesID) :
                        void 0;
    ...
    VBPIndicator.prototype.getValues = function (series, params) {
        ...
        if (!series.chart) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)('Base series not found! In case it has been removed, add ' +
