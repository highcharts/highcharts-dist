    ...
    _registerModule(_modules, 'Series/Funnel3D/SVGElement3DFunnel.js', [_modules['Core/Color/Color.js'], _modules['Core/Globals.js'], _modules['Core/Renderer/SVG/SVGElement3D.js'], _modules['Core/Utilities.js']], function (Color, H, SVGElement3D, U) {
        ...
        var SVGElement3DFunnel = /** @class */ (function (_super) {
            ...
            SVGElement3DFunnel.prototype.opacitySetter = function (value, _key, _element) {
                var funnel3d = this, opacity = parseFloat(value), parts = funnel3d.parts, chart = H.charts[funnel3d.renderer.chartIndex], filterId = 'group-opacity-' + opacity + '-' + chart.index;
