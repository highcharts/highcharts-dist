...
var PointAndFigureSeries = /** @class */ (function (_super) {
    ...
    PointAndFigureSeries.prototype.getProcessedData = function () {
        ...
        var series = this, options = series.options, xData = series.getColumn('x', true), yData = series.getColumn('y', true), boxSize = options.boxSize, calculatedBoxSize = isNumber(boxSize) ?
