...
(function (factory) {
    ...
    _registerModule(_modules, 'Extensions/ParallelCoordinates/ParallelSeries.js', [_modules['Core/Templating.js'], _modules['Core/Utilities.js']], function (T, U) {
         ...
         * */
        var format = T.format;
        var addEvent = U.addEvent, defined = U.defined, erase = U.erase, extend = U.extend, insertItem = U.insertItem, isNumber = U.isNumber, pick = U.pick, pushUnique = U.pushUnique, wrap = U.wrap;
        /* *
         *
         *  Composition
         *
        ...
        (function (ParallelSeries) {
            ...
            function compose(SeriesClass) {
                var _a = SeriesClass.types, LinePointClass = _a.line.prototype.pointClass, SplinePointClass = _a.spline.prototype.pointClass;
                if (LinePointClass &&
