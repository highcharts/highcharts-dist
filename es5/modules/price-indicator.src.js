/**
 * @license Highstock JS v11.1.0 (2023-10-18)
 *
...
(function (factory) {
    ...
    _registerModule(_modules, 'Extensions/PriceIndication.js', [_modules['Core/Utilities.js']], function (U) {
         ...
         */
        var addEvent = U.addEvent, isArray = U.isArray, merge = U.merge, pushUnique = U.pushUnique;
        /* *
         *
         *  Constants
         *
        ...
        function onSeriesAfterRender() {
            ...
            if ((lastVisiblePrice || lastPrice) &&
                ...
                var xAxis = series.xAxis, yAxis = series.yAxis, origOptions = yAxis.crosshair, origGraphic = yAxis.cross, origLabel = yAxis.crossLabel, points = series.points, yLength = series.yData.length, pLength = points.length, x = series.xData[series.xData.length - 1], y = series.yData[yLength - 1];
                var yValue = void 0;
