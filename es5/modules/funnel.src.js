...
var FunnelSeries = /** @class */ (function (_super) {
    ...
    FunnelSeries.prototype.translate = function () {
        var series = this,
            ...
            borderRadius = Utilities_relativeLength(borderRadiusObject.radius,
            width),
        ...
        series.getXPos = function (y, half, point) {
            ...
            return centerX + (half ? -1 : 1) *
                ((series.getWidthAt(reversed ? 2 * centerY - y : y) / 2) +
                    ((_c = (_b = (_a = point.dataLabel) === null || _a === void 0 ? void 0 : _a.dataLabelPosition) === null || _b === void 0 ? void 0 : _b.distance) !== null && _c !== void 0 ? _c : Utilities_relativeLength(((_d = this.options.dataLabels) === null || _d === void 0 ? void 0 : _d.distance) || 0, width)));
        };
        // Expose
