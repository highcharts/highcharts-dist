        ...
        for (var _i = 0, _h = series.points; _i < _h.length; _i++) {
            ...
            if (!point.isNull) { // Condition like in pie chart
                var paneInnerSize = yAxis.pane.options.innerSize,
                    radius = ((Utilities_relativeLength((_c = (_b = point.options.radius) !== null && _b !== void 0 ? _b : options.radius) !== null && _c !== void 0 ? _c : '100%',
                    center[2] / 2))),
                    innerRadius = Math.min((Utilities_relativeLength((_f = (_e = (_d = point.options.innerRadius) !== null && _d !== void 0 ? _d : options.innerRadius) !== null && _e !== void 0 ? _e : (isNumber(paneInnerSize) ?
                        paneInnerSize / 2 :
