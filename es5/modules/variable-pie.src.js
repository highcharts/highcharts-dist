...
var VariablePieSeries_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
var VariablePieSeries = /** @class */ (function (_super) {
    ...
    VariablePieSeries.prototype.calculateExtremes = function () {
        var series = this,
            ...
            zData = VariablePieSeries_spreadArray([],
            this.getColumn('z',
            false,
            true),
            true),
    ...
    VariablePieSeries.prototype.getRadii = function (zMin, zMax, minSize, maxSize) {
        var zData = VariablePieSeries_spreadArray([], this.getColumn('z', false, true), true), radii = [], options = this.options, sizeByArea = options.sizeBy !== 'radius', zRange = zMax - zMin;
        var pos,
            value,
            radius;
