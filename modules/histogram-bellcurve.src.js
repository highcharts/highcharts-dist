...
(function (DerivedComposition) {
    ...
    function addBaseSeriesEvents() {
        this.eventRemovers.push((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this.baseSeries, 'updatedData', () => {
            this.setDerivedData();
        }), (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(this.baseSeries, 'destroy', () => {
            this.baseSeries = null;
            this.initialised = false;
        }));
    }
...
class HistogramSeries extends ColumnSeries {
    ...
    setData(data, redraw = true, animation, updatePoints) {
        ...
        if (typeof data !== 'undefined' && data.length > 0) {
            ...
            data = data.map(function (item) {
                return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(item) ? item : item?.y ?? 0;
            });
    ...
    derivedData(baseData, binsNumber, binWidth) {
        ...
        min = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.correctFloat)((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMin)(baseData)), frequencies = [], bins = {}, data = [];
        let x;
...
class BellcurveSeries extends AreaSplineSeries {
    ...
    setData(data, redraw = true, animation, updatePoints) {
        ...
        if (typeof data !== 'undefined' && data.length > 0) {
            ...
            data = data
                .map(function (item) {
                return (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(item) ? item : item?.y;
            })
