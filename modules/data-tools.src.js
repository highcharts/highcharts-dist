...
class DataModifier {
    ...
    benchmark(dataTable, options) {
        ...
        const { iterations } = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(defaultOptions, options);
...
class DataTable extends Data_DataTableCore {
    ...
    setColumns(columns, rowIndex, eventDetail, typeAsOriginal) {
        ...
        if (!(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(rowIndex) && !typeAsOriginal) {
            super.setColumns(columns, rowIndex, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(eventDetail, { silent: true }));
        }
        else {
...
class DataConnector {
    ...
    getColumnOrder() {
        ...
        if (names.length) {
            return names.sort((a, b) => ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(columns[a].index, 0) - (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(columns[b].index, 0)));
        }
    }
    /**
...
class DataConverter {
    ...
    constructor(options) {
        ...
        const mergedOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(DataConverter.defaultOptions, options);
...
class CSVConverter extends Converters_DataConverter {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(CSVConverter.defaultOptions, options);
        super(mergedOptions);
        /* *
         *
         *  Properties
    ...
    parse(options, eventDetail) {
        const converter = this, dataTypes = converter.dataTypes, parserOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(this.options, options), { beforeParse, lineDelimiter, firstRowAsNames, itemDelimiter } = parserOptions;
...
class CSVConnector extends Connectors_DataConnector {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(CSVConnector.defaultOptions, options);
        super(mergedOptions);
        this.options = mergedOptions;
...
class JSONConverter extends Converters_DataConverter {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(JSONConverter.defaultOptions, options);
        super(mergedOptions);
        /* *
         *
         *  Properties
    ...
    convertItemToRow(rowObj, columnIds) {
        ...
        if (columnIds && !(Array.isArray(columnIds))) {
            const newRow = [];
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(columnIds, (arrayWithPath, name) => {
...
class JSONConnector extends Connectors_DataConnector {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(JSONConnector.defaultOptions, options);
        super(mergedOptions);
        this.options = mergedOptions;
        if (mergedOptions.enablePolling) {
            this.startPolling(Math.max(mergedOptions.dataRefreshRate || 0, 1) * 1000);
...
class GoogleSheetsConverter extends Converters_DataConverter {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(GoogleSheetsConverter.defaultOptions, options);
        super(mergedOptions);
        this.header = [];
        this.options = mergedOptions;
    }
     ...
     */
    parse(options, eventDetail) {
        const converter = this, parseOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(converter.options, options);
 ...
 */
    constructor(options) {
        const mergedOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(GoogleSheetsConnector.defaultOptions, options);
        super(mergedOptions);
        this.options = mergedOptions;
    }
    /* *
...
class HTMLTableConverter extends Converters_DataConverter {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(HTMLTableConverter.defaultOptions, options);
        super(mergedOptions);
        this.headers = [];
        this.options = mergedOptions;
     ...
     */
    parse(options, eventDetail) {
        const converter = this, columnsArray = [], headers = [], parseOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(converter.options, options), { endRow, startColumn, endColumn, firstRowAsNames } = parseOptions, tableHTML = parseOptions.tableElement || this.tableElement;
...
class HTMLTableConnector extends Connectors_DataConnector {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(HTMLTableConnector.defaultOptions, options);
        super(mergedOptions);
        this.options = mergedOptions;
    ...
    async load(eventDetail) {
        ...
        const columns = converter.parse((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({ tableElement: connector.tableElement }, options), eventDetail);
...
class ChainModifier extends Modifiers_DataModifier {
    ...
    constructor(options, ...chain) {
        super();
        this.chain = chain;
        this.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(ChainModifier.defaultOptions, options);
...
class InvertModifier extends Modifiers_DataModifier {
    ...
    constructor(options) {
        super();
        this.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(InvertModifier.defaultOptions, options);
    }
    /* *
     *
     *  Functions
...
class RangeModifier extends Modifiers_DataModifier {
    ...
    constructor(options) {
        super();
        this.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(RangeModifier.defaultOptions, options);
    }
    /* *
     *
     *  Functions
...
class SortModifier extends Modifiers_DataModifier {
    ...
    constructor(options) {
        super();
        this.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(SortModifier.defaultOptions, options);
    }
    /* *
     *
     *  Functions
...
class FilterModifier extends Modifiers_DataModifier {
    ...
    constructor(options) {
        super();
        this.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(FilterModifier.defaultOptions, options);
    }
    /* *
     *
     *  Functions
