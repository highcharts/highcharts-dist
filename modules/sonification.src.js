...
const { isSafari, win: DownloadURL_win, win: { document: DownloadURL_doc } } = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());
/* *
 *
 *  Constants
 *
...
class Sonification {
    ...
    speak(text, speakerOptions, delayMs = 0) {
        const speaker = new Sonification_SonificationSpeaker(merge({
            language: 'en-US',
            rate: 1.5,
            volume: 0.4
        }, speakerOptions || {}));
