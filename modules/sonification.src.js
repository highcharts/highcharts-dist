...
class Oscillator {
    ...
    scheduleFilterTrackingChange(frequency, time, glideDuration) {
        const opts = this.options, rampTime = glideDuration ? glideDuration / 1000 :
            ...
            const multiplier = getPitchTrackedMultiplierVal(filterOptions.frequencyPitchTrackingMultiplier || 1, frequency), f = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)((filterOptions.frequency || 1000) * multiplier, 0, 21000);
    ...
    createGain() {
        const opts = this.options, needsGainNode = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(opts.volume) ||
...
class SynthPatch {
    constructor(audioContext, options) {
        ...
        this.oscillators = (this.options.oscillators || []).map((oscOpts) => new Oscillator(audioContext, oscOpts, (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(oscOpts.fmOscillator) || (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(oscOpts.vmOscillator) ?
            void 0 : inputNode));
...
class SonificationInstrument {
    ...
    scheduleEventAtTime(time, params) {
        const mergedParams = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(this.curParams, params), freq = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(params.frequency) ?
            params.frequency : (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(params.note) ?
...
function filterChannels(filter, channels) {
    ...
    return filtered.map((c) => (new Sonification_TimelineChannel(c.channel.type, c.channel.engine, c.channel.showPlayMarker, c.filteredEvents.map((e) => (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(e, { time: e.time - minTime })), c.channel.muted)));
}
/**
                    ...
                    this.scheduledCallbacks.push(setTimeout(() => {
                        ...
                        if (point) {
                            ...
                            chart && chart.hoverPoints &&
                                ...
                                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(chart.hoverPoints, (p) => p === point) &&
    ...
    playClosestToPropValue(prop, targetVal, onEnd, onBoundaryHit, eventFilter) {
        ...
        (this.playingChannels || this.channels).forEach((channel) => {
            ...
            while (i--) {
                ...
                const val = events[i].relatedPoint[prop], diff = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(val) && Math.abs(targetVal - val);
...
function timelineFromChart(audioContext, destinationNode, chart) {
    const options = chart.options.sonification ||
        {}, defaultInstrOpts = options.defaultInstrumentOptions, defaultSpeechOpts = options.defaultSpeechOptions, defaultPointGroupOpts = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({
        enabled: true,
        groupTimespan: 15,
        algorithm: 'minmax',
        prop: 'y'
    ...
    chart.series.forEach((series, seriesIx) => {
        ...
        if (series.visible && sOptions.enabled !== false) {
            const seriesDuration = isSequential ? getAvailableDurationForSeries(series, totalDuration, propMetrics, afterSeriesWait) : totalDuration, seriesDefaultInstrOpts = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(defaultInstrOpts, sOptions.defaultInstrumentOptions), seriesDefaultSpeechOpts = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(defaultSpeechOpts, sOptions.defaultSpeechOptions), seriesPointGroupOpts = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(defaultPointGroupOpts, sOptions.pointGrouping), mainTracks = (sOptions.tracks || [seriesDefaultInstrOpts])
            ...
            mainTracks.forEach((trackOpts) => {
                const mergedOpts = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({
            ...
            contextTracks.forEach((trackOpts) => {
                const mergedOpts = trackOpts.type === 'speech' ?
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(defaultSpeechOpts, trackOpts) :
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(defaultInstrOpts, {
...
class Sonification {
    ...
    speak(text, speakerOptions, delayMs = 0) {
        const speaker = new Sonification_SonificationSpeaker((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({
            language: 'en-US',
            rate: 1.5,
            volume: 0.4
        }, speakerOptions || {}));
