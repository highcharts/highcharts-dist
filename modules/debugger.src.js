...
(function (factory) {
    ...
    _registerModule(_modules, 'Extensions/Debugger/Debugger.js', [_modules['Core/Chart/Chart.js'], _modules['Core/Globals.js'], _modules['Core/Utilities.js']], function (Chart, H, U) {
        /* *
         *
         *  (c) 2010-2021 Torstein Honsi
         *
