 ...
 * Traduction by: Jonnthan Rodríguez
 *
		...
		H.setOptions({
		    lang: {
		        ...
		        accessibility: {
		            ...
		            screenReaderRegionLabel: 'Información para el lector de pantallas.',
		            navigationHint: 'Usa regiones / puntos de referencia para saltarte hacia delante para ver el gráfico {#plural(numSeries, y navegar en las series,)}',
		            defaultChartTitle: 'Gráfico',
		            longDescriptionHeading: 'Descripción larga.',
		            noDescription: 'No hay descripción disponible.',
		            structureHeading: 'Structure.',
		            viewAsDataTable: 'Ver en tabla.',
		            chartHeading: 'Gráfico.',
		            chartContainerLabel: 'Gráfico interactivo. {title}. Use las flechas para navegar sobre los puntos.',
		            ...
		            chartTypes: {
		                ...
		                defaultSingle: 'Gráfico con {numPoints} data {#plural(numPoints, points, point)}.',
		                defaultMultiple: 'Gráfico con {numSeries} data series.',
		                splineSingle: 'Line Gráfico con {numPoints} data {#plural(numPoints, points, point)}.',
		                splineMultiple: 'Line Gráfico con {numSeries} lines.',
		                lineSingle: 'Line Gráfico con {numPoints} data {#plural(numPoints, points, point)}.',
		                lineMultiple: 'Line Gráfico con {numSeries} lines.',
		                columnSingle: 'Bar Gráfico con {numPoints} {#plural(numPoints, bars, bar)}.',
		                columnMultiple: 'Bar Gráfico con {numSeries} data series.',
		                barSingle: 'Bar Gráfico con {numPoints} {#plural(numPoints, bars, bar)}.',
		                barMultiple: 'Bar Gráfico con {numSeries} data series.',
		                pieSingle: 'Gráfico de pastel con {numPoints} {#plural(numPoints, slices, slice)}.',
		                pieMultiple: 'Pie Gráfico con {numSeries} pies.',
		                scatterSingle: 'Scatter Gráfico con {numPoints} {#plural(numPoints, points, point)}.',
		                scatterMultiple: 'Scatter Gráfico con {numSeries} data series.',
		                boxplotSingle: 'Boxplot with {numPoints} {#plural(numPoints, boxes, box)}.',
		                boxplotMultiple: 'Boxplot with {numSeries} data series.',
		                bubbleSingle: 'Bubble Gráfico con {numPoints} {#plural(numPoints, bubbles, bubble)}.',
		                bubbleMultiple: 'Bubble Gráfico con {numSeries} data series.'
		            },
		             ...
		             */
		            axis: {
		                xAxisDescriptionSingular: 'El gráfico tiene 1 eje X mostrando {names[0]}.',
		                xAxisDescriptionPlural: 'EL gráfico tiene {numAxes} ejes X  mostrando {#each(names, -1) } y {names[-1]}',
		                yAxisDescriptionSingular: 'El gráfico tiene 1 eje Y mostrando {names[0]}.',
		                yAxisDescriptionPlural: 'El gráfico tiene {numAxes}  ejes X  mostrando {#each(names, -1) } y {names[-1]}'
		            },
		             ...
		             */
		            exporting: {
		                chartMenuLabel: 'Exportar',
		                menuButtonLabel: 'Vista del Menú de exportación',
		            ...
		            series: {
		                 ...
		                 */
		                summary: {
		                    default: '{name}, series {ix} de {numSeries} con {numPoints} datos {#plural(numPoints, points, point)}.',
		                    defaultCombination: '{name}, series {ix} de {numSeries} con {numPoints} datos {#plural(numPoints, points, point)}.',
		                    ...
		                    pie: '{name}, pie {ix} de {numSeries} con {numPoints} {#plural(numPoints, slices, slice)}.',
