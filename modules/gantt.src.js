...
class Connection {
    ...
    render() {
        ...
        let options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(chart.options.connectors, series.options.connectors, fromPoint.options.connectors, connection.options);
        // Set path attribs
        if (!chart.styledMode) {
...
class GanttChart extends (highcharts_Chart_commonjs_highcharts_Chart_commonjs2_highcharts_Chart_root_Highcharts_Chart_default()) {
    ...
    init(userOptions, callback) {
        ...
        const options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(true, {
            chart: {
                type: 'gantt'
            },
            title: {
        ...
        options.yAxis = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(userOptions.yAxis || {})).map((yAxisOptions) => (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(
        // Defaults
        {
            grid: {
                enabled: true
...
function preferredInputType(format) {
    ...
    const ms = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isString)(format) ?
        format.indexOf('%L') !== -1 :
    ...
    const date = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isString)(format) ?
        ['a', 'A', 'd', 'e', 'w', 'b', 'B', 'm', 'o', 'y', 'Y']
            .some(hasTimeKey) :
        format.dateStyle || format.day || format.month || format.year;
    const time = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isString)(format) ?
...
class RangeSelector {
    ...
    clickButton(i, redraw) {
        ...
        let dataMin = unionExtremes.dataMin, dataMax = unionExtremes.dataMax, newMin, newMax = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(baseAxis?.max) ? Math.round(Math.min(baseAxis.max, dataMax ?? baseAxis.max)) : void 0, // #1568
        ...
        if (!baseAxis) {
            ...
            const axisRangeUpdateEvent = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(chart, 'afterCreateAxes', function () {
    ...
    updateButtonStates() {
        ...
        unionExtremes = (chart.scroller &&
            ...
            .fill(0), selectedExists = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(selected), buttons = rangeSelector.buttons;
    ...
    setInputValue(name, inputTime) {
        ...
        if (input) {
            ...
            let updatedTime = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(hcTimeAttr) ? Number(hcTimeAttr) : void 0;
    ...
    renderButtons() {
        ...
        const buttonTheme = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options.buttonTheme);
        ...
        const dropdown = this.dropdown = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('select', void 0, {
            position: 'absolute',
            padding: 0,
            border: 0,
            cursor: 'pointer',
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(dropdown, 'touchstart', () => {
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(dropdown, mouseOver, () => {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(this.dropdownLabel.element, mouseOver);
        });
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(dropdown, mouseOut, () => {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(this.dropdownLabel.element, mouseOut);
        });
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(dropdown, 'change', () => {
    ...
    createButton(rangeOptions, i, width, states) {
        ...
        const renderer = chart.renderer;
        const buttonTheme = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options.buttonTheme);
        dropdown?.add((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.createElement)('option', {
            ...
            if (series.visible && !series.options.isInternal) {
                series.points.forEach(function (point) {
                    ...
                    const connects = point.options?.connect ?
                        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(point.options.connect) :
                        [];
                    let to;
...
const { composed: StaticScale_composed } = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());
/* *
 *
 *  Composition
 *
...
class XRangeSeries extends ColumnSeries {
    ...
    findPointIndex(options) {
        ...
        let pointIndex;
        if (id) {
            const point = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(points, (point) => point.id === id);
            pointIndex = point ? point.index : void 0;
        }
        if (typeof pointIndex === 'undefined') {
            const point = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(points, (point) => (point.x === options.x &&
                point.x2 === options.x2 &&
                !point.touched));
            pointIndex = point ? point.index : void 0;
        }
    ...
    alignDataLabel(point) {
        ...
        point.plotX = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point.dlBox?.centerX, point.plotX);
    ...
    translatePoint(point) {
        const xAxis = this.xAxis, yAxis = this.yAxis, metrics = this.columnMetrics, options = this.options, minPointLength = options.minPointLength || 0, oldColWidth = (point.shapeArgs?.width || 0) / 2, seriesXOffset = this.pointXOffset = metrics.offset, posX = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point.x2, point.x + (point.len || 0)), borderRadius = options.borderRadius, plotTop = this.chart.plotTop, plotLeft = this.chart.plotLeft;
        let plotX = point.plotX, plotX2 = xAxis.translate(posX, 0, 0, 0, 1);
        const length = Math.abs(plotX2 - plotX), inverted = this.chart.inverted, borderWidth = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(options.borderWidth, 1);
        ...
        const x = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(Math.min(plotX, plotX2), borderWidth), x2 = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(Math.max(plotX, plotX2), borderWidth), width = x2 - x;
        const r = Math.min((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)((typeof borderRadius === 'object' ?
            borderRadius.radius :
            borderRadius || 0), pointHeight), Math.min(width, pointHeight) / 2);
        const shapeArgs = {
            x,
            y: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)((point.plotY || 0) + yOffset, borderWidth),
            width,
            height: pointHeight,
            r
        };
    ...
    drawPoint(point, verb) {
        const seriesOpts = this.options, renderer = this.chart.renderer, type = point.shapeType, shapeArgs = point.shapeArgs, partShapeArgs = point.partShapeArgs, clipRectArgs = point.clipRectArgs, pointState = point.state, stateOpts = (seriesOpts.states[pointState || 'normal'] ||
            ...
            'attr' : verb, pointAttr = this.pointAttribs(point, pointState), animation = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(this.chart.options.chart.animation, stateOpts.animation);
...
(function (BrokenAxis) {
                ...
                points.forEach(function (point) {
                    ...
                    breaks.forEach(function (brk) {
                        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(threshold) && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(y)) {
                            ...
                            if (eventName) {
                                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.fireEvent)(axis, eventName, { point, brk });
                            }
                        }
                    });
                });
    ...
    class Additions {
        ...
        static lin2Val(val) {
            ...
            if (!breakArray?.length || !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(val)) {
                return val;
            }
            let nval = val;
        ...
        setBreaks(breaks, redraw) {
            const brokenAxis = this, axis = brokenAxis.axis, time = axis.chart.time, hasBreaks = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(breaks) &&
            ...
            if (hasBreaks) {
                ...
                axis.setAxisTranslation = function () {
                    ...
                    if (brokenAxis.hasBreaks) {
                        ...
                        // series data.
                        const dataMin = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(min) ?
                            Math.min(axis.dataMin ?? min, min) :
                            (axis.dataMin ?? min), dataMax = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(max) ?
                        ...
                        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(dataMin) && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(dataMax)) {
                            breaks.forEach(function (brk) {
                                start = brk.from;
                                repeat = brk.repeat || Infinity;
                        ...
                        breakArrayTemp.forEach((brk) => {
                            ...
                            if (inBrk === 0 && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(start)) {
                                breakArray.push({
                                    from: start,
                                    to: brk.value,
                        ...
                        if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(min) &&
                            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(max) &&
...
function onAfterInit() {
    ...
    if (gridOptions.columns) {
        ...
        while (++columnIndex < gridOptions.columns.length) {
            const columnOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(userOptions, gridOptions.columns[columnIndex], {
                isInternal: true,
                linkedTo: 0,
            ...
            !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(userOptions.tickPixelInterval) &&
                ...
                gridAxisOptions.tickPositioner = function (min, max) {
                    ...
                    if (parentInfo) {
                        ...
                        const unit = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(unitIdx) && units[unitIdx + 1]);
                        if (unit) {
                        ...
                        const unitRange = highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.timeUnits[unitName];
...
function onInit(e) {
    const axis = this;
    const userOptions = e.userOptions || {};
    const gridOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({ borderColor: 'var(--highcharts-neutral-color-20)' }, userOptions.grid || {});
...
function onTickAfterGetLabelPosition(e) {
    ...
    side = GridAxisSide[axis.side], tickmarkOffset = e.tickmarkOffset, tickPositions = axis.tickPositions, tickPos = tick.pos - tickmarkOffset, nextTickPos = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(tickPositions[e.index + 1]) ?
...
function onTickLabelFormat(ctx) {
    ...
    if (axis.options.grid?.enabled) {
        ...
        const point = allSeries[0] && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.find)(allSeriesData, function (p) {
...
function onTrimTicks() {
    ...
    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(min) &&
        min >= firstPos + tickInterval &&
        min < secondPos), endMoreThanMin = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(min) &&
        firstPos < min &&
        firstPos + tickInterval > min), startLessThanMax = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(max) &&
        lastPos > max &&
        lastPos - tickInterval < max), endMoreThanMax = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(max) &&
...
function onTickHoverExit(label, options) {
    const css = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(options.style) ? options.style : {};
...
function renderLabelIcon(tick, params) {
    ...
    }, rotation = params.collapsed ? 90 : 180, shouldRender = params.show && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(iconCenter.y);
...
function wrapGetLabelPosition(proceed, x, y, label, horiz, labelOptions, tickmarkOffset, index, step) {
    const tick = this, lbOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(tick.options?.labels, labelOptions), pos = tick.pos, axis = tick.axis, isTreeGrid = axis.type === 'treegrid', result = proceed.apply(tick, [x, y, label, horiz, lbOptions, tickmarkOffset, index, step]);
    let mapOfPosToGridNode, node, level;
    if (isTreeGrid) {
        const { width = 0, padding = axis.linkedParent ? 0 : 5 } = (lbOptions && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(lbOptions.symbol, true) ?
            lbOptions.symbol :
            {}), indentation = (lbOptions && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(lbOptions.indentation) ?
...
function setTreeValues(tree, options) {
    ...
    tree.children.forEach((child, i) => {
        const newOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({}, options);
...
function getTreeGridFromData(data, uniqueNames, numberOfSeries) {
    ...
    const treeParams = {
        ...
        before: function (node) {
            const data = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(node.data, true) ?
                node.data :
                {}, name = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isString)(data.name) ? data.name : '', parentNode = mapOfIdToNode[node.parent], parentGridNode = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(parentNode, true) ?
