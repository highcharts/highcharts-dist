    ...
    dataLabels: {
        ...
        formatter: function () {
            const point = this && this.point ?
                this.point :
                {}, name = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isString)(point.name) ? point.name : '';
            return name;
        },
        /**
...
class TreemapSeries extends ScatterSeries {
        ...
        if (cluster?.enabled) {
            ...
            const checkIfHide = (node) => {
                if (node?.point?.shapeArgs) {
                    ...
                    const { pixelWidth = 0, pixelHeight = 0 } = cluster, compareHeight = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(pixelHeight), thresholdArea = pixelHeight ?
    ...
    calculateChildrenAreas(parent, area) {
        const series = this, options = series.options, mapOptionsToLevel = series.mapOptionsToLevel, level = mapOptionsToLevel[parent.level + 1], algorithm = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)((level?.layoutAlgorithm &&
        ...
        for (const child of children) {
            ...
            if (child.children.length &&
                ...
                const dlHeight = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMax)(child.point.dataLabels.map((dl) => dl.options
        ...
        if (options.nodeSizeBy === 'leaf' &&
            ...
            !getChildrenRecursive(rootNode, void 0, false)
                .some((point) => (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(point.options.value)) &&
            !(0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(rootNode.point?.options.value)) {
            ...
            leaves.forEach((point, i) => {
                ...
                // rendered too big
                fit = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(areaPerValue / expectedAreaPerValue, 0.8, 1.4);
                let miss = 1 - fit;
                if (point.value) {
    ...
    drawDataLabels() {
        const series = this, mapOptionsToLevel = series.mapOptionsToLevel, points = series.points.filter(function (n) {
            return n.node.visible || (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(n.dataLabel);
        }), padding = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(series.options.dataLabels || {})[0]?.padding, positionsAreSet = points.some((p) => (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(p.plotY));
            ...
            if (point.shapeArgs && positionsAreSet) {
                ...
                if (width > 32 && height > 16 && point.shouldDraw()) {
                    const dataLabelWidth = width -
                        2 * ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(options.padding)[0] || (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(padding)[0] || 0);
    ...
    getListOfParents(data, existingIds) {
        const arr = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(data) ? data : [], ids = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(existingIds) ? existingIds : [], listOfParents = arr.reduce(function (prev, curr, i) {
            const parent = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(curr.parent, '');
    ...
    init(chart, options) {
        const series = this, breadcrumbsOptions = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(options.drillUpButton, options.breadcrumbs), setOptionsEvent = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(series, 'setOptions', (event) => {
            ...
            const dataLabels = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(options.dataLabels || {});
    ...
    pointAttribs(point, state) {
        const series = this, mapOptionsToLevel = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(series.mapOptionsToLevel) ?
        ...
        attr = {
            'stroke': (point && point.borderColor) ||
                ...
                options.borderColor,
            'stroke-width': (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point && point.borderWidth, level.borderWidth, stateOptions.borderWidth, options.borderWidth),
    ...
    setPointValues() {
        ...
        for (const point of points) {
            ...
            if (values && visible) {
                ...
                x1 = xValue === 0 ?
                    strokeWidth / 2 :
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(xAxis.toPixels(x, true), strokeWidth, true), x2 = x2Value === xAxis.len ?
                    xAxis.len - strokeWidth / 2 :
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(xAxis.toPixels(x + width, true), strokeWidth, true), y1 = yValue === yAxis.len ?
                    yAxis.len - strokeWidth / 2 :
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(yAxis.toPixels(y, true), strokeWidth, true), y2 = y2Value === 0 ?
                    strokeWidth / 2 :
                    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.crisp)(yAxis.toPixels(y + height, true), strokeWidth, true);
                // Set point values
                const shapeArgs = {
                    x: Math.min(x1, x2),
                    y: Math.min(y1, y2),
    ...
    setRootNode(id, redraw, eventArguments) {
        const series = this, eventArgs = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)({
            newRootId: id,
    ...
    setTreeValues(tree) {
        ...
        // Set the values
        let val = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point?.simulatedValue, point?.options.value, childrenTotal);
        if (point) {
            point.value = val;
        }
        ...
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.extend)(tree, {
            ...
            ignore: !((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point?.visible, true) && (val > 0)),
            isLeaf: tree.visible && !(series.type === 'treegraph' ?
                children.length > 0 :
                childrenTotal),
            isGroup: point?.isGroup,
            levelDynamic: (tree.level - (levelIsConstant ? 0 : nodeRoot.level)),
            name: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point?.name, ''),
            sortIndex: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(point?.sortIndex, -val),
            val: val
        });
        return tree;
    }
...
class SunburstPoint extends SunburstPoint_TreemapPoint {
    ...
    getDataLabelPath(label) {
        const renderer = this.series.chart.renderer, shapeArgs = this.shapeExisting, r = shapeArgs.r + (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pInt)(label.options?.distance || 0);
...
function calculateLevelSizes(levelOptions, params) {
    const p = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(params) ? params : {};
...
function getDlOptions(params) {
    // Set options to new object to avoid problems with scope
    const point = params.point, shape = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(params.shapeArgs) ? params.shapeArgs : {}, { end = 0, radius = 0, start = 0 } = shape, optionsPoint = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(params.optionsPoint) ?
        params.optionsPoint.dataLabels :
        {}), 
    // The splat was used because levels dataLabels
    // options doesn't work as an array
    optionsLevel = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(params.level) ?
        params.level.dataLabels :
        {})[0], options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(optionsLevel, optionsPoint), style = options.style = options.style || {}, padding = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(options.padding || 0), paddingLeft = padding[3 % padding.length], paddingRight = padding[1 % padding.length], { innerArcLength = 0, outerArcLength = 0 } = point;
    let rotationRad, rotation, rotationMode = options.rotationMode, width = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.defined)(style.width) ?
...
class SunburstSeries extends SunburstSeries_TreemapSeries {
    ...
    layoutAlgorithm(parent, children, options) {
        ...
        const range = parent.end - startAngle, total = parent.val, x = parent.x, y = parent.y, radius = ((options &&
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(options.levelSize) &&
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(options.levelSize.value)) ?
            options.levelSize.value :
            0), innerRadius = parent.r, outerRadius = innerRadius + radius, slicedOffset = options && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(options.slicedOffset) ?
    ...
    translate() {
        ...
        const idTop = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isString)(nodeRoot.parent) ? nodeRoot.parent : '', nodeTop = mapIdToNode[idTop], { from, to } = Sunburst_SunburstUtilities.getLevelFromAndTo(nodeRoot);
