...
class TimelinePoint extends LinePoint {
    ...
    getConnectorPath() {
        ...
        if (dataLabel) {
            ...
            let coords = {
                ...
                y1: plotY,
                x2: plotX,
                y2: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(targetDLPos.y) ? targetDLPos.y : dataLabel.y
            };
    ...
    applyOptions(options, x, isMock) {
        ...
        if (!x && !options?.x) {
            ...
            else if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(series?.xIncrement) || NaN) {
...
class TimelineSeries extends LineSeries {
    ...
    markerAttribs(point, state) {
        const series = this, seriesMarkerOptions = series.options.marker, pointMarkerOptions = point.marker || {}, symbol = (pointMarkerOptions.symbol || seriesMarkerOptions?.symbol), width = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(pointMarkerOptions.width, seriesMarkerOptions?.width, series.closestPointRangePx), height = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(pointMarkerOptions.height, seriesMarkerOptions?.height);
        ...
        if (state) {
            ...
            radius = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pick)(pointStateOptions?.radius, seriesStateOptions?.radius, radius + (seriesStateOptions?.radiusPlus || 0));
        }
