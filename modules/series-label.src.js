...
function onChartRedraw(e) {
    if (this.renderer) {
        ...
        if (chart.seriesLabelTimer) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.internalClearTimeout)(chart.seriesLabelTimer);
        }
        ...
        chart.seriesLabelTimer = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.syncTimeout)(function () {
