...
class VennSeries extends ScatterSeries {
    ...
    drawPoints() {
        ...
        for (const point of points) {
            const attribs = {
                zIndex: (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(point.sets) ? point.sets.length : 0
    ...
    translate() {
        ...
        for (const point of this.points) {
            const sets = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isArray)(point.sets) ? point.sets : [], id = sets.join(), shape = mapOfIdToShape[id], dataLabelValues = mapOfIdToLabelValues[id] || {}, dlOptions = point.options?.dataLabels;
