    ...
    function onAfterSetOptions(e) {
        ...
        if (chart.hasParallelCoordinates) {
            ...
            if (axis.isXAxis) {
                ...
                axis.options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(axis.options, axis.chart.options.chart.parallelAxes, e.userOptions);
    ...
    function onGetSeriesExtremes(e) {
        ...
        if (chart && chart.hasParallelCoordinates && !axis.isXAxis) {
            ...
            axis.series.forEach(function (series) {
                if (series.visible && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(index)) {
            ...
            currentPoints = currentPoints.filter(highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber);
            axis.dataMin = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMin)(currentPoints);
            axis.dataMax = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.arrayMax)(currentPoints);
            e.preventDefault();
        }
    }
    /**
...
const { composed: ParallelSeries_composed } = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());
    ...
    function onSeriesBindAxes(e) {
        ...
        if (chart.hasParallelCoordinates) {
            ...
            for (const axis of chart.axes) {
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.insertItem)(series, axis.series);
                axis.isDirty = true;
            }
...
(function (ParallelCoordinates) {
    ...
    function onChartInit(e) {
        const chart = this, options = e.args[0], defaultYAxis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.splat)(options.yAxis || {}), newYAxes = [];
