...
function onChartCallback(chart) {
    ...
    let prevX = -1;
    let prevY = -1;
    (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.addEvent)(chart.pointer, 'afterGetHoverData', (e) => {
...
class WGLRenderer {
    ...
    destroy() {
        ...
        if (gl) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.objectEach)(this.textureHandles, (texture) => {
                if (texture.handle) {
    ...
    if ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.pushUnique)(BoostSeries_composed, 'Boost.Series')) {
        ...
        if (wglMode) {
            ...
            if (BubbleSeries) {
                ...
                (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.wrap)(bubbleProto, 'markerAttribs', function (proceed) {
                    if (this.boosted) {
                        return false;
                    }
                    return proceed.apply(this, [].slice.call(arguments, 1));
...
function hasExtremes(series, checkX) {
    ...
    return (dataLength >= threshold &&
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(yAxis?.min) &&
        (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(yAxis?.max) &&
        (!checkX || ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(xAxis?.min) && (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(xAxis?.max))) &&
...
const getSeriesBoosting = (series, data) => {
    ...
    return BoostSeries_isChartSeriesBoosting(chart) || (data?.length ?? 0) >= threshold;
};
/**
...
function scatterProcessData(force) {
    ...
    yCropMin = yAxis.userMin ?? ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(yAxis.options.min) ?
        yAxis.options.min : -Number.MAX_VALUE), yCropMax = yAxis.userMax ?? ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(yAxis.options.max) ?
    ...
    const processedXData = [], processedYData = [], processedDataIndices = [], xRangeNeeded = !((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(xExtremes.max) || (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(xExtremes.min)), yRangeNeeded = !((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(yExtremes.max) || (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(yExtremes.min));
...
(function (BoostCanvas) {
    ...
    function seriesRenderCanvas() {
        const series = this, options = series.options, chart = series.chart, xAxis = series.xAxis, yAxis = series.yAxis, activeBoostSettings = chart.options.boost || {}, boostSettings = {
            ...
            highcharts_Color_commonjs_highcharts_Color_commonjs2_highcharts_Color_root_Highcharts_Color_default().parse(series.color).setOpacity((options.fillOpacity ?? 0.75)).get() :
