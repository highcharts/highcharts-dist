...
class SankeySeries extends SankeySeries_ColumnSeries {
    ...
    static getDLOptions(params) {
        const optionsPoint = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(params.optionsPoint) ?
            params.optionsPoint.dataLabels :
            {}), optionsLevel = ((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isObject)(params.level) ?
            params.level.dataLabels :
            {}), options = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)({
            style: {}
