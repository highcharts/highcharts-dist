...
class ContourSeries extends ScatterSeries {
    ...
    update(options, redraw) {
        ...
        const allOptions = (hasNonUniformOptions ?
            void 0 :
            this.setOptions((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.merge)(this.userOptions, options))), hasNonUniformPlotOptions = allOptions ?
            Object.keys((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.diffObjects)(allOptions, this.options)).some((key) => !isUniformOption(key)) :
            false;
