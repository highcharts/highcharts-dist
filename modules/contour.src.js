...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("highcharts/modules/contour", ["highcharts/highcharts"], function (amd1) {return factory(amd1,amd1["Axis"],amd1["Color"],amd1["LegendSymbol"],amd1["SeriesRegistry"]);});
	else if(typeof exports === 'object')
		exports["highcharts/modules/contour"] = factory(root["_Highcharts"], root["_Highcharts"]["Axis"], root["_Highcharts"]["Color"], root["_Highcharts"]["LegendSymbol"], root["_Highcharts"]["SeriesRegistry"]);
	else
...
class ContourSeries extends ScatterSeries {
    ...
    async run() {
        ...
        if (!gpu || !context) {
            (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.error)(36, false);
            return;
        }
        if (context) {
...
const contour_src_G = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());
