...
(function (factory) {
    ...
    _registerModule(_modules, 'Series/Funnel3D/SVGElement3DFunnel.js', [_modules['Core/Color/Color.js'], _modules['Core/Globals.js'], _modules['Core/Renderer/SVG/SVGElement3D.js'], _modules['Core/Utilities.js']], function (Color, H, SVGElement3D, U) {
        /* *
         *
        ...
        class SVGElement3DFunnel extends SVGElement3D {
            ...
            opacitySetter(value, _key, _element) {
                const funnel3d = this, opacity = parseFloat(value), parts = funnel3d.parts, chart = H.charts[funnel3d.renderer.chartIndex], filterId = 'group-opacity-' + opacity + '-' + chart.index;
    ...
    _registerModule(_modules, 'Series/Funnel3D/Funnel3DComposition.js', [_modules['Series/Funnel3D/SVGElement3DFunnel.js'], _modules['Core/Globals.js'], _modules['Core/Renderer/SVG/SVGRenderer3D.js'], _modules['Core/Utilities.js']], function (SVGElement3DFunnel, H, SVGRenderer3D, U) {
        /* *
         *
         *  Highcharts funnel3d series module
         *
