...
class AxisResizer {
    ...
    render() {
        ...
        pos = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(axis.top + axis.height + y, chart.plotTop, chart.plotTop + chart.plotHeight);
        let attr = {};
        if (!chart.styledMode) {
            attr = {
    ...
    updateAxes(chartY) {
        ...
        axesConfigs = [], plotTop = chart.plotTop, plotHeight = chart.plotHeight, plotBottom = plotTop + plotHeight, calculatePercent = (value) => (value * 100 / plotHeight + '%'), normalize = (val, min, max) => (Math.round((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.clamp)(val, min, max)));
        ...
        for (const axesGroup of [prevAxes, nextAxes]) {
            for (const axisInfo of axesGroup) {
                ...
                const axis = (0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.isNumber)(axisInfo) ?
                ...
                top = axis.top;
                const minLength = Math.round((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(axisOptions.minLength || NaN, plotHeight)), maxLength = Math.round((0,highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_.relativeLength)(axisOptions.maxLength || NaN, plotHeight));
