...
declare module "../highcharts" {
     ...
     */
    interface PlotWmaAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotWmaDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotWmaDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotWmaDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotWmaDataSortingOptions {
        /**
     ...
     */
    interface PlotWmaLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotWmaMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotWmaMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotWmaOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotWmaOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotWmaOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotWmaOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotWmaOnPointPositionOptions {
        /**
    ...
    interface PlotWmaOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotWmaDataLabelsOptions|Array<Highcharts.PlotWmaDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotWmaDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotWmaOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotWmaParamsOptions;
        /**
     ...
     */
    interface PlotWmaParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotWmaStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotWmaStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotWmaStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotWmaTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotWmaTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotWmaTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesWmaOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesWmaOptions {
     * customProperty: string; }
     *
     */
    interface SeriesWmaOptions extends Highcharts.PlotWmaOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
