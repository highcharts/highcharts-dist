...
declare module "../highcharts.src" {
     ...
     */
    interface PlotVennClusterDataLabelsAnimationOptions {
        /**
    ...
    interface PlotVennClusterDataLabelsOptions {
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotVennClusterDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
         ...
         */
        style?: (Highcharts.CSSObject|Highcharts.PlotVennClusterDataLabelsStyleOptions);
        /**
     ...
     * inside long words.
     */
    interface PlotVennClusterDataLabelsStyleOptions {
        color?: string;
    }
     ...
     * line-type series.
     */
    interface PlotVennStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotVennTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * a split tooltip.
     */
    interface PlotVennTooltipHeaderOptions {
        /**
