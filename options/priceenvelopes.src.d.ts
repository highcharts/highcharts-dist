...
declare module "../highcharts.src" {
     ...
     */
    interface PlotPriceenvelopesAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotPriceenvelopesBottomLineOptions {
        styles?: Highcharts.PlotPriceenvelopesBottomLineStylesOptions;
    }
    interface PlotPriceenvelopesBottomLineStylesOptions {
        /**
     ...
     */
    interface PlotPriceenvelopesDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotPriceenvelopesDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotPriceenvelopesDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotPriceenvelopesDataSortingOptions {
        /**
     ...
     */
    interface PlotPriceenvelopesLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotPriceenvelopesMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotPriceenvelopesMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotPriceenvelopesOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotPriceenvelopesOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotPriceenvelopesOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotPriceenvelopesOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotPriceenvelopesOnPointPositionOptions {
        /**
     ...
     */
    interface PlotPriceenvelopesOptions {
        /**
         ...
         * (Highstock) Bottom line options.
         */
        bottomLine?: Highcharts.PlotPriceenvelopesBottomLineOptions;
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotPriceenvelopesDataLabelsOptions|Array<Highcharts.PlotPriceenvelopesDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotPriceenvelopesDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotPriceenvelopesOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotPriceenvelopesParamsOptions;
        /**
         ...
         */
        topLine?: Highcharts.PlotPriceenvelopesTopLineOptions;
        /**
     ...
     */
    interface PlotPriceenvelopesParamsOptions {
        /**
         * (Highstock) Percentage below the moving average that should be
         * displayed. 0.1 means 90%. Relative to the calculated value.
         */
        bottomBand?: number;
        /**
        ...
        period?: number;
        /**
         * (Highstock) Percentage above the moving average that should be
         * displayed. 0.1 means 110%. Relative to the calculated value.
         */
        topBand?: number;
    }
    /**
     ...
     */
    interface PlotPriceenvelopesStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotPriceenvelopesStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotPriceenvelopesTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotPriceenvelopesTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotPriceenvelopesTooltipPositionOptions {
        /**
    ...
    /**
     * (Highstock) A price envelopes indicator. If the type option is not
     ...
     * SeriesPriceenvelopesOptions { customProperty: string; }
     *
     */
    interface SeriesPriceenvelopesOptions extends Highcharts.PlotPriceenvelopesOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
