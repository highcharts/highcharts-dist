...
declare module "../highcharts.src" {
     ...
     */
    interface PlotStreamgraphAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotStreamgraphDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotStreamgraphDataLabelsOptions {
        /**
     ...
     */
    interface PlotStreamgraphDataSortingOptions {
        /**
     ...
     */
    interface PlotStreamgraphMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface PlotStreamgraphMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotStreamgraphOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotStreamgraphOnPointOptions {
        /**
         * (Highcharts, Highstock) Options for the connector in the _Series on
         * point_ feature.
         *
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotStreamgraphOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
     ...
     */
    interface PlotStreamgraphOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotStreamgraphDataLabelsOptions|Array<Highcharts.PlotStreamgraphDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotStreamgraphDataSortingOptions;
        /**
         ...
         */
        negativeFillColor?: Highcharts.ColorType;
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotStreamgraphOnPointOptions);
        /**
     ...
     * line-type series.
     */
    interface PlotStreamgraphStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotStreamgraphStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotStreamgraphStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotStreamgraphTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotStreamgraphTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesStreamgraphDataDataLabelsAnimationOptions {
        /**
     ...
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesStreamgraphDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesStreamgraphDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesStreamgraphOptions` via an interface to
     * allow custom properties: ``` declare interface SeriesStreamgraphOptions {
     * customProperty: string; }
     *
     */
    interface SeriesStreamgraphOptions extends Highcharts.PlotStreamgraphOptions, Highcharts.SeriesOptions {
        /**
         * (Highcharts, Highstock) An array of data points for the series. For
         * the `streamgraph` series type, points can be given in the following
         * ways:
         *
