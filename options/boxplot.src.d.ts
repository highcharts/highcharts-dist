...
declare module "../highcharts.src" {
     ...
     */
    interface PlotBoxplotAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotBoxplotDataLabelsOptions {
        /**
     ...
     */
    interface PlotBoxplotOnPointOptions {
        /**
         ...
         */
        connectorOptions?: (Highcharts.PlotBoxplotOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
    ...
    interface PlotBoxplotOptions {
         ...
         */
        onPoint?: (object|Highcharts.PlotBoxplotOnPointOptions);
        /**
         ...
         * marking low and high values. When `undefined`, the general lineWidth
         * applies.
         *
