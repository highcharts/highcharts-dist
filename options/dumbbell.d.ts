...
declare module "../highcharts" {
     ...
     */
    interface PlotDumbbellDataLabelsAnimationOptions {
        /**
     ...
     */
    interface PlotDumbbellLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotDumbbellOnPointOptions {
        /**
         ...
         */
        connectorOptions?: (Highcharts.PlotDumbbellOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
    ...
    interface PlotDumbbellOptions {
         ...
         */
        dataSorting?: Highcharts.PlotDumbbellDataSortingOptions;
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotDumbbellOnPointOptions);
        /**
     ...
     */
    interface PlotDumbbellTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
