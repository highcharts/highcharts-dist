...
declare module "../highcharts.src" {
     ...
     */
    interface PlotAroonoscillatorAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotAroonoscillatorDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotAroonoscillatorDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotAroonoscillatorLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotAroonoscillatorMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotAroonoscillatorMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotAroonoscillatorOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotAroonoscillatorOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotAroonoscillatorOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     ...
     */
    interface PlotAroonoscillatorOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotAroonoscillatorDataLabelsOptions|Array<Highcharts.PlotAroonoscillatorDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotAroonoscillatorDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotAroonoscillatorOnPointOptions);
        /**
         ...
         */
        params?: Highcharts.PlotAroonoscillatorParamsOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotAroonoscillatorStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotAroonoscillatorStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotAroonoscillatorStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotAroonoscillatorTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotAroonoscillatorTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotAroonoscillatorTooltipPositionOptions {
        /**
