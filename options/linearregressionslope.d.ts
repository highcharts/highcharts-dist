...
declare module "../highcharts" {
     ...
     */
    interface PlotLinearregressionslopeAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotLinearregressionslopeDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotLinearregressionslopeDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotLinearregressionslopeLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotLinearregressionslopeMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotLinearregressionslopeMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotLinearregressionslopeOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotLinearregressionslopeOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotLinearregressionslopeOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     ...
     */
    interface PlotLinearregressionslopeOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotLinearregressionslopeDataLabelsOptions|Array<Highcharts.PlotLinearregressionslopeDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotLinearregressionslopeDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotLinearregressionslopeOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotLinearregressionslopeParamsOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotLinearregressionslopeStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotLinearregressionslopeStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotLinearregressionslopeStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotLinearregressionslopeTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotLinearregressionslopeTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotLinearregressionslopeTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesLinearregressionslopeOptions` via an
     * interface to allow custom properties: ``` declare interface
     * SeriesLinearregressionslopeOptions { customProperty: string; }
     *
     */
    interface SeriesLinearregressionslopeOptions extends Highcharts.PlotLinearregressionslopeOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
