...
declare module "../highcharts.src" {
     ...
     */
    interface PlotColumnrangeAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotColumnrangeDataLabelsAnimationOptions {
        /**
     ...
     */
    interface PlotColumnrangeOnPointOptions {
        /**
         ...
         */
        connectorOptions?: (Highcharts.PlotColumnrangeOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
     ...
     */
    interface PlotColumnrangeOptions {
        /**
         ...
         */
        borderRadius?: (number|string|Highcharts.BorderRadiusOptionsObject|Highcharts.PlotColumnrangeBorderRadiusOptions);
        /**
         ...
         * Range series data labels have no `x` and `y` options. Instead, they
         ...
         */
        dataSorting?: Highcharts.PlotColumnrangeDataSortingOptions;
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotColumnrangeOnPointOptions);
        /**
     ...
     */
    interface PlotColumnrangeTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotColumnrangeTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesColumnrangeDataDataLabelsAnimationOptions {
        /**
         * (Highcharts, Highstock) The animation delay time in milliseconds. Set
         * to `0` to render the data labels immediately. As `undefined` inherits
         * defer time from the series.animation.defer.
