...
declare module "../highcharts.src" {
     ...
     */
    interface PlotCandlestickAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotCandlestickDataLabelsOptions {
        /**
     ...
     */
    interface PlotCandlestickOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotCandlestickOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotCandlestickOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     ...
     */
    interface PlotCandlestickOptions {
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotCandlestickOnPointOptions);
        /**
     ...
     * line-type series.
     */
    interface PlotCandlestickStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotCandlestickTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotCandlestickTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesCandlestickDataDataLabelsAnimationOptions {
        /**
