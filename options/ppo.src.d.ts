...
declare module "../highcharts.src" {
     ...
     */
    interface PlotPpoAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotPpoDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotPpoDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotPpoLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotPpoMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotPpoOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotPpoOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotPpoOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
    ...
    interface PlotPpoOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotPpoDataLabelsOptions|Array<Highcharts.PlotPpoDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotPpoDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotPpoOnPointOptions);
        /**
        ...
        opacity?: number;
        /**
         * (Highstock) Parameters used in calculation of Percentage Price
         * Oscillator series points.
         */
        params?: Highcharts.PlotPpoParamsOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotPpoStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotPpoTooltipHeaderOptions {
        /**
