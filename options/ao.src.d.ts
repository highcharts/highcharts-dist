...
declare module "../highcharts.src" {
     ...
     */
    interface PlotAoAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotAoDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotAoDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotAoDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotAoDataSortingOptions {
        /**
     ...
     */
    interface PlotAoLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotAoMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotAoMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotAoOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotAoOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotAoOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotAoOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotAoOnPointPositionOptions {
        /**
    ...
    interface PlotAoOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotAoDataLabelsOptions|Array<Highcharts.PlotAoDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotAoDataSortingOptions;
        /**
        ...
        /**
         * (Highstock) Color of the Awesome oscillator series bar that is
         * greater than the previous one. Note that if a `color` is defined, the
         * `color` takes precedence and the `greaterBarColor` is ignored.
         */
        greaterBarColor?: Highcharts.ColorType;
        groupPadding?: number;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotAoOnPointOptions);
        /**
         * (Highstock) Opacity of a series parts: line, fill (e.g. area) and
         * dataLabels.
         */
        opacity?: number;
        params?: Highcharts.PlotAoParamsOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotAoStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotAoStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotAoStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotAoTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotAoTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotAoTooltipPositionOptions {
        /**
     ...
     * properties: ``` declare interface SeriesAoOptions { customProperty:
     * string; }
     *
     */
    interface SeriesAoOptions extends Highcharts.PlotAoOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
