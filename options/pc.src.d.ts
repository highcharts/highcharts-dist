...
declare module "../highcharts.src" {
     ...
     */
    interface PlotPcAccessibilityPointOptions {
        /**
    ...
    interface PlotPcBottomLineOptions {
        styles?: Highcharts.PlotPcBottomLineStylesOptions;
    }
    interface PlotPcBottomLineStylesOptions {
        /**
     ...
     */
    interface PlotPcDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotPcDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotPcDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotPcDataSortingOptions {
        /**
     ...
     */
    interface PlotPcLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotPcMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotPcMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotPcOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotPcOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotPcOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotPcOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotPcOnPointPositionOptions {
        /**
    ...
    interface PlotPcOptions {
        ...
        bottomLine?: Highcharts.PlotPcBottomLineOptions;
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotPcDataLabelsOptions|Array<Highcharts.PlotPcDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotPcDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotPcOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotPcParamsOptions;
        /**
        ...
        topLine?: Highcharts.PlotPcTopLineOptions;
        /**
     ...
     */
    interface PlotPcStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotPcTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotPcTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotPcTooltipPositionOptions {
        /**
    ...
    interface PlotPcTopLineOptions {
        styles?: Highcharts.PlotPcTopLineStylesOptions;
    }
    interface PlotPcTopLineStylesOptions {
        /**
    ...
    /**
     * (Highstock) A Price channel indicator. If the type option is not
     ...
     * properties: ``` declare interface SeriesPcOptions { customProperty:
     * string; }
     *
     */
    interface SeriesPcOptions extends Highcharts.PlotPcOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
