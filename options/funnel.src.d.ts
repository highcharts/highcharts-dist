...
declare module "../highcharts.src" {
     ...
     */
    interface PlotFunnel3dAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotFunnel3dDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotFunnel3dDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotFunnel3dOnPointConnectorOptions {
        /**
     ...
     * series in the _Series on point_ feature.
     */
    interface PlotFunnel3dOnPointPositionOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotFunnel3dStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotFunnel3dTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotFunnel3dTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotFunnel3dTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface PlotFunnelDataLabelsAnimationOptions {
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The animation delay time in
         * milliseconds. Set to `0` to render the data labels immediately. As
         * `undefined` inherits defer time from the series.animation.defer.
     ...
     * `sunburst` series are supported at this moment.
     */
    interface PlotFunnelOnPointOptions {
        /**
         * (Highcharts) Options for the connector in the _Series on point_
         * feature.
         *
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotFunnelOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         * (Highcharts) The `id` of the point that we connect the series to.
         * Only points with a given `plotX` and `plotY` values and map points
         * are valid.
         ...
         * series in the _Series on point_ feature.
         */
        position?: (object|Highcharts.PlotFunnelOnPointPositionOptions);
    }
    /**
     * (Highcharts) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
    ...
    interface PlotFunnelOptions {
         ...
         * or series. A number signifies pixels. A percentage string, like for
         * example `50%`, signifies a size relative to the series width.
         */
        borderRadius?: number;
        /**
         ...
         * it defines the pixel height, if it is a percentage string it is the
         ...
         * and `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotFunnelOnPointOptions);
        /**
         * (Highcharts) Opacity of a series parts: line, fill (e.g. area) and
         * dataLabels.
         */
     ...
     * line-type series.
     */
    interface PlotFunnelStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * configuration, see dateFormat.
     */
    interface PlotFunnelTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * enabled. The header is the box containing the X value in a split tooltip.
     */
    interface PlotFunnelTooltipHeaderOptions {
        /**
         * (Highcharts) Background color for the tooltip header when
         * tooltip.split is enabled.
         */
     ...
     * line-type series.
     */
    interface SeriesFunnel3dDataStatesHoverAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface SeriesFunnel3dDataStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
    ...
    /**
     * (Highcharts) A `funnel3d` series. If the type option is not specified, it
     ...
     *
     */
    interface SeriesFunnel3dOptions extends Highcharts.PlotFunnel3dOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
         ...
         * `funnel3d` series type, points can be given in the following ways:
         *
    ...
    /**
     * (Highcharts) A `funnel` series. If the type option is not specified, it
     * is inherited from chart.type.
     *
     * Configuration options for the series are given in three levels:
     *
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesFunnelOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesFunnelOptions {
     * customProperty: string; }
     *
     */
    interface SeriesFunnelOptions extends Highcharts.PlotFunnelOptions, Highcharts.SeriesOptions {
        /**
