...
declare module "../highcharts" {
     ...
     */
    interface PlotLinearregressioninterceptAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotLinearregressioninterceptDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotLinearregressioninterceptDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotLinearregressioninterceptDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotLinearregressioninterceptDataSortingOptions {
        /**
     ...
     */
    interface PlotLinearregressioninterceptLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotLinearregressioninterceptMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotLinearregressioninterceptMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotLinearregressioninterceptOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotLinearregressioninterceptOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotLinearregressioninterceptOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotLinearregressioninterceptOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotLinearregressioninterceptOnPointPositionOptions {
        /**
     ...
     */
    interface PlotLinearregressioninterceptOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotLinearregressioninterceptDataLabelsOptions|Array<Highcharts.PlotLinearregressioninterceptDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotLinearregressioninterceptDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotLinearregressioninterceptOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotLinearregressioninterceptParamsOptions;
        /**
     ...
     */
    interface PlotLinearregressioninterceptParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotLinearregressioninterceptStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotLinearregressioninterceptStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotLinearregressioninterceptTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotLinearregressioninterceptTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotLinearregressioninterceptTooltipPositionOptions {
        /**
    ...
    /**
     * (Highstock) A linear regression intercept series. If the type option is
     ...
     *
     */
    interface SeriesLinearregressioninterceptOptions extends Highcharts.PlotLinearregressioninterceptOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
