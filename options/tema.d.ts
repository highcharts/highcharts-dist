...
declare module "../highcharts" {
     ...
     */
    interface PlotTemaAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotTemaDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotTemaDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotTemaDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotTemaDataSortingOptions {
        /**
     ...
     */
    interface PlotTemaLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotTemaMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotTemaMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotTemaOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotTemaOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotTemaOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotTemaOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotTemaOnPointPositionOptions {
        /**
    ...
    interface PlotTemaOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotTemaDataLabelsOptions|Array<Highcharts.PlotTemaDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotTemaDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotTemaOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotTemaParamsOptions;
        /**
     ...
     */
    interface PlotTemaParamsOptions {
        /**
     ...
     */
    interface PlotTemaStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotTemaTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotTemaTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotTemaTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesTemaOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesTemaOptions {
     * customProperty: string; }
     *
     */
    interface SeriesTemaOptions extends Highcharts.PlotTemaOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
