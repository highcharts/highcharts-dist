...
declare module "../highcharts" {
     ...
     */
    interface PlotColumnAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotColumnDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotColumnDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotColumnDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotColumnDataSortingOptions {
        /**
     ...
     */
    interface PlotColumnLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotColumnOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotColumnOnPointOptions {
        /**
         * (Highcharts, Highstock) Options for the connector in the _Series on
         * point_ feature.
         *
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotColumnOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
    ...
    interface PlotColumnOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotColumnDataLabelsOptions|Array<Highcharts.PlotColumnDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotColumnDataSortingOptions;
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotColumnOnPointOptions);
        /**
     ...
     */
    interface PlotColumnStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotColumnTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * tooltip.
     */
    interface PlotColumnTooltipHeaderOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesColumnDataDataLabelsAnimationOptions {
        /**
     ...
     * (Highcharts, Highstock) Animation when not hovering over the marker.
     */
    interface SeriesColumnDataStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
