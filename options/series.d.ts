...
declare module "../highcharts" {
     ...
     * a series.
     */
    interface PlotSeriesAccessibilityPointOptions {
        /**
        ...
        dateFormat?: string;
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) Formatter function to
         * determine the date/time format used with points on datetime axes when
         * describing them to screen reader users. Receives one argument,
         * `point`, referring to the point to describe. Should return a date
         * format string compatible with dateFormat.
         */
         ...
         * values in the point descriptions. Uses tooltip.valueDecimals if not
         * defined.
         */
        valueDecimals?: number;
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) Format to use for describing
         * the values of data points to assistive technology - including screen
         ...
         * in the point descriptions. Uses tooltip.valuePrefix if not defined.
         */
        valuePrefix?: string;
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) Suffix to add to the values
         * in the point descriptions. Uses tooltip.valueSuffix if not defined.
         */
        valueSuffix?: string;
    }
    /**
    ...
    interface PlotSeriesDataLabelsOptions {
         ...
         */
        animation?: (boolean|Highcharts.PlotSeriesDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotSeriesLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
    ...
    interface PlotSeriesOptions {
         ...
         * table and the series data points. This is used in conjunction with
         * the `dataTable` option (on chart or series level) to map columns from
         * the data table to the properties of the data points. The keys of the
         ...
         */
        dataSorting?: Highcharts.PlotSeriesDataSortingOptions;
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) Options for a specific
         * series-level data table or an array of data tables. The `dataTable`
         * option can be either a configuration object or an instance of the
         * `DataTable` class. If a `DataTable` instance is passed, it will be
         * used directly. If a configuration object or an array is passed, a new
        ...
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The line cap used for line
         * ends and line joins on the graph.
         */
     ...
     * when tooltip.split is enabled. The header is the box containing the X
     * value in a split tooltip.
     */
    interface PlotSeriesTooltipHeaderOptions {
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) Background color for the
        ...
        borderColor?: Highcharts.ColorType;
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The width of the border for
         * the tooltip header when tooltip.split is enabled.
         */
        borderWidth?: number;
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) Distance between the plot
         * area and the header (except the chevron) in a split tooltip, in
         * pixels. The default value makes the header text align with the axis
         * labels.
         */
        distance?: number;
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The name of a symbol to use
         * for the border around the tooltip header. Applies only when
         ...
         * header. The default is `{ fontSize: '1em' }`, ensuring that the
