...
declare module "../highcharts.src" {
     ...
     */
    interface PlotDmiAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotDmiDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotDmiDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotDmiDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotDmiDataSortingOptions {
        /**
     ...
     */
    interface PlotDmiLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotDmiMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotDmiMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) -DI line options.
     */
    interface PlotDmiMinusDILineOptions {
        /**
         * (Highstock) Styles for the -DI line.
         */
        styles?: Highcharts.PlotDmiMinusDILineStylesOptions;
    }
    /**
     * (Highstock) Styles for the -DI line.
     */
    interface PlotDmiMinusDILineStylesOptions {
        /**
     ...
     */
    interface PlotDmiOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotDmiOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotDmiOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotDmiOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotDmiOnPointPositionOptions {
        /**
    ...
    interface PlotDmiOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotDmiDataLabelsOptions|Array<Highcharts.PlotDmiDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotDmiDataSortingOptions;
        /**
         ...
         * (Highstock) -DI line options.
         */
        minusDILine?: Highcharts.PlotDmiMinusDILineOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotDmiOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotDmiParamsOptions;
        /**
         * (Highstock) +DI line options.
         */
        plusDILine?: Highcharts.PlotDmiPlusDILineOptions;
        /**
     ...
     */
    interface PlotDmiParamsOptions {
        index?: string;
        /**
     ...
     * (Highstock) +DI line options.
     */
    interface PlotDmiPlusDILineOptions {
        /**
         * (Highstock) Styles for the +DI line.
         */
        styles?: Highcharts.PlotDmiPlusDILineStylesOptions;
    }
    /**
     * (Highstock) Styles for the +DI line.
     */
    interface PlotDmiPlusDILineStylesOptions {
        /**
         * (Highstock) Color of the line.
         */
        lineColor?: Highcharts.ColorString;
     ...
     * line-type series.
     */
    interface PlotDmiStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotDmiStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotDmiStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotDmiTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotDmiTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotDmiTooltipPositionOptions {
        /**
