...
declare module "../highcharts.src" {
     ...
     */
    interface PlotPyramid3dDataLabelsAnimationOptions {
        /**
     ...
     */
    interface PlotPyramid3dOnPointOptions {
        /**
         ...
         */
        connectorOptions?: (Highcharts.PlotPyramid3dOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
    ...
    interface PlotPyramid3dOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotPyramid3dDataLabelsOptions|Array<Highcharts.PlotPyramid3dDataLabelsOptions>);
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotPyramid3dOnPointOptions);
        /**
        ...
        /**
         * (Highcharts) A reversed pyramid3d is funnel3d, but the latter
         * supports neck related options: neckHeight and neckWidth
         */
        reversed?: boolean;
        /**
     ...
     */
    interface PlotPyramid3dTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotPyramid3dTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface PlotPyramidDataLabelsAnimationOptions {
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The animation delay time in
         * milliseconds. Set to `0` to render the data labels immediately. As
         * `undefined` inherits defer time from the series.animation.defer.
     ...
     * `sunburst` series are supported at this moment.
     */
    interface PlotPyramidOnPointOptions {
        /**
         * (Highcharts) Options for the connector in the _Series on point_
         * feature.
         *
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotPyramidOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         * (Highcharts) The `id` of the point that we connect the series to.
         * Only points with a given `plotX` and `plotY` values and map points
         * are valid.
    ...
    interface PlotPyramidOptions {
         ...
         * and `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotPyramidOnPointOptions);
        /**
         * (Highcharts) Opacity of a series parts: line, fill (e.g. area) and
         * dataLabels.
         */
     ...
     * configuration, see dateFormat.
     */
    interface PlotPyramidTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * when tooltip.fixed is `true`.
     */
    interface PlotPyramidTooltipPositionOptions {
        /**
         * (Highcharts) The horizontal alignment of the fixed tooltip.
         */
        align?: Highcharts.AlignValue;
     ...
     * line-type series.
     */
    interface SeriesPyramid3dDataStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesPyramidDataDataLabelsAnimationOptions {
        /**
