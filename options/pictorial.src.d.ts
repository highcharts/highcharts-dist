...
declare module "../highcharts.src" {
     ...
     */
    interface PlotPictorialAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotPictorialDataLabelsOptions {
        /**
         ...
         */
        animation?: (boolean|Highcharts.PlotPictorialDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotPictorialOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotPictorialDataLabelsOptions|Array<Highcharts.PlotPictorialDataLabelsOptions>);
        /**
     ...
     */
    interface PlotPictorialTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
