...
declare module "../highcharts" {
     ...
     */
    interface PlotChaikinAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotChaikinDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotChaikinDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotChaikinDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotChaikinDataSortingOptions {
        /**
     ...
     */
    interface PlotChaikinLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotChaikinMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotChaikinMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotChaikinOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotChaikinOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotChaikinOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotChaikinOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotChaikinOnPointPositionOptions {
        /**
    ...
    interface PlotChaikinOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotChaikinDataLabelsOptions|Array<Highcharts.PlotChaikinDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotChaikinDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotChaikinOnPointOptions);
        /**
        ...
        opacity?: number;
        /**
         * (Highstock) Parameters used in calculation of Chaikin Oscillator
         * series points.
         */
        params?: Highcharts.PlotChaikinParamsOptions;
        /**
     ...
     * points.
     */
    interface PlotChaikinParamsOptions {
        index?: string;
        /**
         * (Highstock) Parameter used indirectly for calculating the `AD`
         * indicator. Decides about the number of data points that are taken
     ...
     * line-type series.
     */
    interface PlotChaikinStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotChaikinStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotChaikinStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotChaikinTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotChaikinTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotChaikinTooltipPositionOptions {
        /**
