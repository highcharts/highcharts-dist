...
declare module "../highcharts" {
     ...
     */
    interface PlotBulletAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotBulletDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotBulletDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotBulletDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotBulletLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotBulletOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotBulletOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotBulletOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotBulletOnPointPositionOptions);
    }
    /**
     * (Highcharts) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotBulletOnPointPositionOptions {
        /**
    ...
    interface PlotBulletOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotBulletDataLabelsOptions|Array<Highcharts.PlotBulletDataLabelsOptions>);
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotBulletOnPointOptions);
        /**
         ...
         * targets.
         */
        targetOptions?: Highcharts.PlotBulletTargetOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotBulletStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotBulletTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotBulletTooltipHeaderOptions {
        /**
     ...
     * (Highcharts, Highstock) Animation when not hovering over the marker.
     */
    interface SeriesBulletDataStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface SeriesBulletDataTargetOptions {
        /**
         * (Highcharts) The border color of the rectangle representing the
         * target. When not set, the point's border color is used.
         *
