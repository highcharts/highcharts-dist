...
declare module "../highcharts" {
    ...
    interface PlotXrangeOptions {
        ...
        /**
         * (Highcharts, Highstock, Gantt) Options for a specific series-level
         * data table or an array of data tables. The `dataTable` option can be
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesXrangeDataDataLabelsAnimationOptions {
        /**
     ...
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesXrangeDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
