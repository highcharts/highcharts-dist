...
declare module "../highcharts.src" {
     ...
     */
    interface PlotMfiAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotMfiDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotMfiDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotMfiDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotMfiDataSortingOptions {
        /**
     ...
     */
    interface PlotMfiLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotMfiMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotMfiMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotMfiOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotMfiOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotMfiOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotMfiOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotMfiOnPointPositionOptions {
        /**
    ...
    interface PlotMfiOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotMfiDataLabelsOptions|Array<Highcharts.PlotMfiDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotMfiDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotMfiOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotMfiParamsOptions;
        /**
     ...
     */
    interface PlotMfiParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotMfiStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotMfiStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotMfiTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotMfiTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotMfiTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesMfiOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesMfiOptions {
     * customProperty: string; }
     *
     */
    interface SeriesMfiOptions extends Highcharts.PlotMfiOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
