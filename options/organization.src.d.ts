...
declare module "../highcharts.src" {
     ...
     */
    interface PlotOrganizationDataLabelsAnimationOptions {
        /**
     ...
     * inside long words.
     */
    interface PlotOrganizationDataLabelsStyleOptions {
        fontSize?: number;
        fontWeight?: string;
        textAlign?: string;
    }
     ...
     */
    interface PlotOrganizationLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotOrganizationLevelsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotOrganizationLevelsStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotOrganizationLevelsStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotOrganizationLevelsStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotOrganizationOnPointConnectorOptions {
        /**
     ...
     * series in the _Series on point_ feature.
     */
    interface PlotOrganizationOnPointPositionOptions {
        /**
    ...
    interface PlotOrganizationOptions {
         ...
         * height of the **hanging** nodes only, in pixels too.
         *
     ...
     * line-type series.
     */
    interface PlotOrganizationStatesHoverAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * (Highcharts, Highstock) Animation when not hovering over the marker.
     */
    interface PlotOrganizationStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotOrganizationStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotOrganizationTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotOrganizationTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotOrganizationTooltipPositionOptions {
        /**
    ...
    /**
     * (Highcharts) An `organization` series. If the type option is not
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesOrganizationOptions` via an interface to
     * allow custom properties: ``` declare interface SeriesOrganizationOptions
     * { customProperty: string; }
     *
     */
    interface SeriesOrganizationOptions extends Highcharts.PlotOrganizationOptions, Highcharts.SeriesOptions {
        /**
        ...
        /**
         * (Highcharts) The color of the links between nodes. This option is
         * moved to link.color.
         *
         * @deprecated 10.3.0
         */
        linkColor?: Highcharts.ColorString;
        /**
         * (Highcharts) The line width of the links connecting nodes, in pixels.
        ...
        /**
         * (Highcharts) Radius for the rounded corners of the links between
         * nodes. This option is now deprecated, and moved to link.radius.
         *
         * @deprecated 10.3.0
         */
        linkRadius?: object;
         ...
         * nodes in an org chart are auto-generated instances of
