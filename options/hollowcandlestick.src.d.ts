...
declare module "../highcharts.src" {
     ...
     */
    interface PlotHollowcandlestickAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotHollowcandlestickDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotHollowcandlestickDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotHollowcandlestickDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotHollowcandlestickLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotHollowcandlestickOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotHollowcandlestickOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotHollowcandlestickOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotHollowcandlestickOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotHollowcandlestickOnPointPositionOptions {
        /**
     ...
     */
    interface PlotHollowcandlestickOptions {
        /**
        ...
        clip?: boolean;
        /**
         * (Highstock) The fill color of the candlestick when the current close
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotHollowcandlestickDataLabelsOptions|Array<Highcharts.PlotHollowcandlestickDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotHollowcandlestickDataSortingOptions;
        /**
        ...
        /**
         * (Highstock) The color of the line/border of the hollow candlestick
         * when the current close is lower than the previous one.
         */
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotHollowcandlestickOnPointOptions);
        /**
        ...
        /**
         * (Highstock) The color of the line/border of the hollow candlestick
         * when the current close is higher than the previous one.
         */
     ...
     */
    interface PlotHollowcandlestickStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotHollowcandlestickTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
