...
declare module "../highcharts" {
     ...
     */
    interface PlotMacdAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotMacdDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotMacdDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotMacdLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
    ...
    interface PlotMacdMacdLineStylesOptions {
        /**
     ...
     */
    interface PlotMacdMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotMacdMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotMacdOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotMacdOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotMacdOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
    ...
    interface PlotMacdOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotMacdDataLabelsOptions|Array<Highcharts.PlotMacdDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotMacdDataSortingOptions;
        /**
         ...
         * (Highstock) The styles for macd line
         */
        macdLine?: Highcharts.PlotMacdMacdLineOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotMacdOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotMacdParamsOptions;
        /**
         ...
         */
        signalLine?: Highcharts.PlotMacdSignalLineOptions;
        /**
     ...
     * (Highstock) The styles for signal line
     */
    interface PlotMacdSignalLineOptions {
        styles?: Highcharts.PlotMacdSignalLineStylesOptions;
        /**
         * (Highcharts, Highstock) An array defining zones within a series.
         * Zones can be applied to the X axis, Y axis or Z axis for bubbles,
         * according to the `zoneAxis` option. The zone definitions have to be
     ...
     * line-type series.
     */
    interface PlotMacdStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotMacdStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotMacdStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotMacdTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotMacdTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotMacdTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesMacdOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesMacdOptions {
     * customProperty: string; }
     *
     */
    interface SeriesMacdOptions extends Highcharts.PlotMacdOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
