...
declare module "../highcharts.src" {
     ...
     */
    interface PlotAtrAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotAtrDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotAtrDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotAtrDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotAtrDataSortingOptions {
        /**
     ...
     */
    interface PlotAtrLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotAtrMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotAtrMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotAtrOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotAtrOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotAtrOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotAtrOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotAtrOnPointPositionOptions {
        /**
    ...
    interface PlotAtrOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotAtrDataLabelsOptions|Array<Highcharts.PlotAtrDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotAtrDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotAtrOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotAtrParamsOptions;
        /**
     ...
     */
    interface PlotAtrParamsOptions {
        index?: string;
        /**
     ...
     * line-type series.
     */
    interface PlotAtrStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotAtrStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotAtrStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotAtrTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotAtrTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotAtrTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesAtrOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesAtrOptions {
     * customProperty: string; }
     *
     */
    interface SeriesAtrOptions extends Highcharts.PlotAtrOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
