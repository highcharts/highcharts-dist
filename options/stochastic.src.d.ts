...
declare module "../highcharts.src" {
     ...
     */
    interface PlotStochasticAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotStochasticDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotStochasticDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotStochasticDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotStochasticDataSortingOptions {
        /**
     ...
     */
    interface PlotStochasticLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotStochasticMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotStochasticMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotStochasticOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotStochasticOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotStochasticOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotStochasticOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotStochasticOnPointPositionOptions {
        /**
     ...
     */
    interface PlotStochasticOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotStochasticDataLabelsOptions|Array<Highcharts.PlotStochasticDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotStochasticDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotStochasticOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotStochasticParamsOptions;
        /**
         ...
         */
        smoothedLine?: Highcharts.PlotStochasticSmoothedLineOptions;
        /**
     ...
     */
    interface PlotStochasticParamsOptions {
        index?: string;
        period?: string;
        /**
     ...
     * (Highstock) Smoothed line options.
     */
    interface PlotStochasticSmoothedLineOptions {
        /**
         * (Highstock) Styles for a smoothed line.
         */
        styles?: Highcharts.PlotStochasticSmoothedLineStylesOptions;
    }
    /**
     * (Highstock) Styles for a smoothed line.
     */
    interface PlotStochasticSmoothedLineStylesOptions {
        /**
     ...
     */
    interface PlotStochasticStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotStochasticStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotStochasticTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotStochasticTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotStochasticTooltipPositionOptions {
        /**
    ...
    /**
     * (Highstock) A Stochastic indicator. If the type option is not specified,
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesStochasticOptions` via an interface to
     * allow custom properties: ``` declare interface SeriesStochasticOptions {
     * customProperty: string; }
     *
     */
    interface SeriesStochasticOptions extends Highcharts.PlotStochasticOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
