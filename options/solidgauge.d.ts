...
declare module "../highcharts" {
    ...
    interface PlotSolidgaugeDataLabelsOptions {
         ...
         */
        style?: (Highcharts.CSSObject|Highcharts.PlotSolidgaugeDataLabelsStyleOptions);
        /**
    ...
    interface PlotSolidgaugeOptions {
         ...
         * given either as a pixel value (number), or as a percentage string,
         * like `"50%"`. Defaults to match the `pane.innerSize`.
         */
        innerRadius?: string;
        /**
         ...
         * given either as a pixel value (number), or as a percentage string,
         * like `"100%"`. Defaults to match the `pane.size`.
         */
        radius?: string;
        /**
     ...
     */
    interface PlotSolidgaugeTooltipHeaderOptions {
        /**
    ...
    /**
     * (Highcharts) A `solidgauge` series. If the type option is not specified,
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesSolidgaugeOptions` via an interface to
     * allow custom properties: ``` declare interface SeriesSolidgaugeOptions {
     * customProperty: string; }
     *
     */
    interface SeriesSolidgaugeOptions extends Highcharts.PlotSolidgaugeOptions, Highcharts.SeriesOptions {
        /**
         * (Highcharts) An array of data points for the series. For the
         * `solidgauge` series type, points can be given in the following ways:
         *
