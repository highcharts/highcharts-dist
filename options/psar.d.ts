...
declare module "../highcharts" {
     ...
     */
    interface PlotPsarAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotPsarDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotPsarDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotPsarDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotPsarDataSortingOptions {
        /**
     ...
     */
    interface PlotPsarLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotPsarMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotPsarMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotPsarOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotPsarOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotPsarOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotPsarOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotPsarOnPointPositionOptions {
        /**
    ...
    interface PlotPsarOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotPsarDataLabelsOptions|Array<Highcharts.PlotPsarDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotPsarDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotPsarOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotPsarParamsOptions;
        /**
     ...
     */
    interface PlotPsarParamsOptions {
        /**
         ...
         * factor is starting with this value and increases by specified
         * increment each time the extreme point makes a new high. AF can reach
         * a maximum of maxAccelerationFactor, no matter how long the uptrend
         * extends.
         */
        initialAccelerationFactor?: number;
        /**
         * (Highstock) The Maximum value for acceleration factor. AF can reach a
         * maximum of maxAccelerationFactor, no matter how long the uptrend
         * extends.
         */
     ...
     * line-type series.
     */
    interface PlotPsarStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotPsarStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotPsarStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotPsarTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotPsarTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotPsarTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesPsarOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesPsarOptions {
     * customProperty: string; }
     *
     */
    interface SeriesPsarOptions extends Highcharts.PlotPsarOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
