...
declare module "../highcharts.src" {
     ...
     */
    interface PlotCmoAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotCmoDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotCmoDataLabelsOptions {
        /**
     ...
     */
    interface PlotCmoDataSortingOptions {
        /**
     ...
     */
    interface PlotCmoMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotCmoMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotCmoOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotCmoOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotCmoOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotCmoOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotCmoOnPointPositionOptions {
        /**
    ...
    interface PlotCmoOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotCmoDataLabelsOptions|Array<Highcharts.PlotCmoDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotCmoDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotCmoOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotCmoParamsOptions;
        /**
     ...
     */
    interface PlotCmoParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotCmoStatesHoverAnimationOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotCmoStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotCmoTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotCmoTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesCmoOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesCmoOptions {
     * customProperty: string; }
     *
     */
    interface SeriesCmoOptions extends Highcharts.PlotCmoOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
