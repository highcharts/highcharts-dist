...
declare module "../highcharts" {
     ...
     */
    interface PlotObvAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotObvDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotObvDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotObvDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotObvDataSortingOptions {
        /**
     ...
     */
    interface PlotObvLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotObvMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotObvMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotObvOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotObvOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotObvOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotObvOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotObvOnPointPositionOptions {
        /**
    ...
    interface PlotObvOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotObvDataLabelsOptions|Array<Highcharts.PlotObvDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotObvDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotObvOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotObvParamsOptions;
        /**
     ...
     */
    interface PlotObvParamsOptions {
        index?: string;
        period?: string;
        /**
     ...
     * line-type series.
     */
    interface PlotObvStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotObvStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotObvStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotObvTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotObvTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotObvTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesObvOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesObvOptions {
     * customProperty: string; }
     *
     */
    interface SeriesObvOptions extends Highcharts.PlotObvOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
