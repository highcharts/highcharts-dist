...
declare module "../highcharts.src" {
     ...
     */
    interface PlotDpoAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotDpoDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotDpoDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotDpoDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotDpoDataSortingOptions {
        /**
     ...
     */
    interface PlotDpoLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotDpoMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotDpoMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotDpoOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotDpoOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotDpoOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotDpoOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotDpoOnPointPositionOptions {
        /**
    ...
    interface PlotDpoOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotDpoDataLabelsOptions|Array<Highcharts.PlotDpoDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotDpoDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotDpoOnPointOptions);
        /**
        ...
        opacity?: number;
        /**
         * (Highstock) Parameters used in calculation of Detrended Price
         * Oscillator series points.
         */
        params?: Highcharts.PlotDpoParamsOptions;
        /**
     ...
     * series points.
     */
    interface PlotDpoParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotDpoStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotDpoStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotDpoStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotDpoTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotDpoTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotDpoTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesDpoOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesDpoOptions {
     * customProperty: string; }
     *
     */
    interface SeriesDpoOptions extends Highcharts.PlotDpoOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
