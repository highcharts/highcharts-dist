...
declare module "../highcharts.src" {
     ...
     */
    interface PlotBbAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotBbBottomLineOptions {
        /**
         * (Highstock) Styles for the bottom line.
         */
        styles?: Highcharts.PlotBbBottomLineStylesOptions;
    }
    /**
     * (Highstock) Styles for the bottom line.
     */
    interface PlotBbBottomLineStylesOptions {
        /**
     ...
     */
    interface PlotBbDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotBbDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotBbDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotBbDataSortingOptions {
        /**
     ...
     */
    interface PlotBbLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotBbMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotBbMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotBbOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotBbOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotBbOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
    ...
    interface PlotBbOptions {
         ...
         */
        topLine?: Highcharts.PlotBbTopLineOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotBbStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotBbTooltipHeaderOptions {
        /**
    ...
    interface PlotBbTopLineOptions {
         ...
         */
        styles?: Highcharts.PlotBbTopLineStylesOptions;
    }
    /**
     * (Highstock) Styles for the top line.
     */
    ...
    /**
     * (Highstock) A bollinger bands indicator. If the type option is not
     ...
     *
     */
    interface SeriesBbOptions extends Highcharts.PlotBbOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
