...
declare module "../highcharts" {
     ...
     */
    interface PlotVwapAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotVwapDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotVwapDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotVwapDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotVwapDataSortingOptions {
        /**
     ...
     */
    interface PlotVwapLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotVwapMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotVwapMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
