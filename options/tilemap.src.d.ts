...
declare module "../highcharts.src" {
    ...
    interface PlotTilemapDataLabelsOptions {
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotTilemapDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotTilemapOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotTilemapOnPointPositionOptions {
        /**
     ...
     */
    interface PlotTilemapStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotTilemapTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotTilemapTooltipPositionOptions {
        /**
