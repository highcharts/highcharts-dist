...
declare module "../highcharts.src" {
     ...
     */
    interface PlotAreaAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotAreaDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotAreaDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotAreaDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotAreaLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotAreaMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface PlotAreaMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotAreaOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotAreaOnPointOptions {
        /**
         * (Highcharts, Highstock) Options for the connector in the _Series on
         * point_ feature.
         *
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotAreaOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
    ...
    interface PlotAreaOptions {
         ...
         */
        onPoint?: (object|Highcharts.PlotAreaOnPointOptions);
        /**
     ...
     */
    interface PlotAreaStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotAreaStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * tooltip.
     */
    interface PlotAreaTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotAreaTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesAreaDataDataLabelsAnimationOptions {
        /**
     ...
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesAreaDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesAreaDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) A `area` series. If the type option is not
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesAreaOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesAreaOptions {
     * customProperty: string; }
     *
     */
    interface SeriesAreaOptions extends Highcharts.PlotAreaOptions, Highcharts.SeriesOptions {
        /**
         * (Highcharts, Highstock) An array of data points for the series. For
         * the `area` series type, points can be given in the following ways:
         *
         ...
         * or from `pointStart` * and `pointInterval` given in the series
