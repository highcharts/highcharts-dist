...
declare module "../highcharts.src" {
     ...
     */
    interface PlotKlingerAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotKlingerDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotKlingerDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotKlingerDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotKlingerDataSortingOptions {
        /**
     ...
     */
    interface PlotKlingerLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotKlingerMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotKlingerMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotKlingerOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotKlingerOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotKlingerOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotKlingerOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotKlingerOnPointPositionOptions {
        /**
    ...
    interface PlotKlingerOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotKlingerDataLabelsOptions|Array<Highcharts.PlotKlingerDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotKlingerDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotKlingerOnPointOptions);
        /**
         ...
         */
        params?: Highcharts.PlotKlingerParamsOptions;
        /**
        ...
        signalLine?: Highcharts.PlotKlingerSignalLineOptions;
        /**
     ...
     * (Highstock) Parameters used in calculation of Klinger Oscillator.
     */
    interface PlotKlingerParamsOptions {
        /**
         ...
         * for the indiator calculation.
         */
        volumeSeriesID?: string;
    }
    interface PlotKlingerSignalLineOptions {
        /**
         * (Highstock) Styles for a signal line.
         */
        styles?: Highcharts.PlotKlingerSignalLineStylesOptions;
    }
    /**
     * (Highstock) Styles for a signal line.
     */
    interface PlotKlingerSignalLineStylesOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotKlingerStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotKlingerStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotKlingerStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotKlingerTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotKlingerTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotKlingerTooltipPositionOptions {
        /**
    ...
    /**
     * (Highstock) A Klinger oscillator. If the type option is not specified, it
     ...
     *
     */
    interface SeriesKlingerOptions extends Highcharts.PlotKlingerOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
