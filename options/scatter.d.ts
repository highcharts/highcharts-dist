...
declare module "../highcharts" {
     ...
     */
    interface PlotScatter3dLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotScatter3dMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts) Animation when hovering over the marker.
     */
    interface PlotScatter3dMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotScatter3dOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotScatter3dOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotScatter3dOnPointPositionOptions);
    }
    /**
     * (Highcharts) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     ...
     */
    interface PlotScatter3dOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotScatter3dDataLabelsOptions|Array<Highcharts.PlotScatter3dDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotScatter3dDataSortingOptions;
        /**
         ...
         * supported.
         */
        jitter?: Highcharts.PlotScatter3dJitterOptions;
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotScatter3dOnPointOptions);
        /**
     ...
     * line-type series.
     */
    interface PlotScatter3dStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotScatter3dStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotScatter3dStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotScatter3dTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * a split tooltip.
     */
    interface PlotScatter3dTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotScatter3dTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface PlotScatterClusterDataLabelsAnimationOptions {
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The animation delay time in
         * milliseconds. Set to `0` to render the data labels immediately. As
         * `undefined` inherits defer time from the series.animation.defer.
     ...
     * labels.
     */
    interface PlotScatterClusterDataLabelsOptions {
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The alignment of the data
         * label compared to the point. If `right`, the right side of the label
         * should be touching the point. For points with an extent, like
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotScatterClusterDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The background color or
         * gradient for the data label. In addition to regular colors, there are
         * two special setting for this option:
         ...
         * break inside long words.
         */
        style?: (Highcharts.CSSObject|Highcharts.PlotScatterClusterDataLabelsStyleOptions);
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) Options for a label text
         * which should follow marker's shape. Border and background are
         * disabled for a label that follows a path.
     ...
     * inside long words.
     */
    interface PlotScatterClusterDataLabelsStyleOptions {
        color?: string;
    }
    interface PlotScatterClusterEventsOptions {
        /**
     ...
     */
    interface PlotScatterClusterOptions {
        /**
         ...
         * labels.
         */
        dataLabels?: (Highcharts.DataLabelsOptions|Highcharts.PlotScatterClusterDataLabelsOptions);
        /**
         ...
         */
        enabled?: boolean;
        events?: Highcharts.PlotScatterClusterEventsOptions;
        /**
         * (Highcharts, Highmaps) Options for layout algorithm. Inside there are
         * options to change the type of the algorithm, gridSize, distance or
         * iterations.
         */
        layoutAlgorithm?: Highcharts.PlotScatterClusterLayoutAlgorithmOptions;
        /**
        ...
        states?: Highcharts.PlotScatterClusterStatesOptions;
        /**
         ...
         * `className` option.
         */
        zones?: Array<Highcharts.PlotScatterClusterZonesOptions>;
    }
    ...
    interface PlotScatterClusterStatesOptions {
        hover?: Highcharts.PlotScatterClusterStatesHoverOptions;
    }
    /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface PlotScatterDataLabelsAnimationOptions {
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The animation delay time in
         * milliseconds. Set to `0` to render the data labels immediately. As
         * `undefined` inherits defer time from the series.animation.defer.
     ...
     * (Highcharts, Highstock) Options for series data sorting.
     */
    interface PlotScatterDataSortingOptions {
        /**
         * (Highcharts, Highstock) Enable or disable data sorting for the
         * series. Use xAxis.reversed to change the sorting order.
         */
     ...
     * defaults to the series color, or a contrast color if `onArea`.
     */
    interface PlotScatterLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotScatterMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface PlotScatterMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
    ...
    interface PlotScatterOptions {
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotScatterDataSortingOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotScatterStatesHoverAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * (Highcharts, Highstock) Animation when not hovering over the marker.
     */
    interface PlotScatterStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotScatterStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * configuration, see dateFormat.
     */
    interface PlotScatterTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * a split tooltip.
     */
    interface PlotScatterTooltipHeaderOptions {
        /**
         * (Highcharts, Highstock, Highmaps) Background color for the tooltip
         * header when tooltip.split is enabled.
         */
     ...
     * taking effect only when tooltip.fixed is `true`.
     */
    interface PlotScatterTooltipPositionOptions {
        /**
         * (Highcharts, Highstock, Highmaps) The horizontal alignment of the
         * fixed tooltip.
         */
     ...
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesScatter3dDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesScatter3dDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts) A `scatter3d` series. If the type option is not specified,
     ...
     *
     */
    interface SeriesScatter3dOptions extends Highcharts.PlotScatter3dOptions, Highcharts.SeriesOptions {
        /**
         * (Highcharts) An array of data points for the series. For the
         * `scatter3d` series type, points can be given in the following ways:
         *
         * 1. An array of arrays with 3 values. In this case, the values
         * correspond to `x,y,z`. If the first value is a string, it is applied
         * as the name of the point, and the `x` value is inferred. (see online
         * documentation for example)
         *
     ...
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesScatterDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesScatterDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     *
     */
    interface SeriesScatterOptions extends Highcharts.PlotScatterOptions, Highcharts.SeriesOptions {
        /**
         * (Highcharts, Highstock) An array of data points for the series. For
         * the `scatter` series type, points can be given in the following ways:
         *
