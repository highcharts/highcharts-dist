...
declare module "../highcharts.src" {
     ...
     */
    interface PlotBarAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotBarDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotBarDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotBarDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotBarDataSortingOptions {
        /**
     ...
     */
    interface PlotBarLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotBarOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotBarOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotBarOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotBarOnPointPositionOptions);
    }
    /**
     * (Highcharts) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotBarOnPointPositionOptions {
        /**
    ...
    interface PlotBarOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotBarDataLabelsOptions|Array<Highcharts.PlotBarDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotBarDataSortingOptions;
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotBarOnPointOptions);
        /**
     ...
     */
    interface PlotBarStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotBarStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotBarTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotBarTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotBarTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesBarDataDataLabelsAnimationOptions {
        /**
     ...
     * line-type series.
     */
    interface SeriesBarDataStatesHoverAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * (Highcharts, Highstock) Animation when not hovering over the marker.
     */
    interface SeriesBarDataStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface SeriesBarDataStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesBarOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesBarOptions {
     * customProperty: string; }
     *
     */
    interface SeriesBarOptions extends Highcharts.PlotBarOptions, Highcharts.SeriesOptions {
        /**
