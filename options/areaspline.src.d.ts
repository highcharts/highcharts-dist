...
declare module "../highcharts.src" {
     ...
     */
    interface PlotAreasplineAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotAreasplineDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotAreasplineDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotAreasplineLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotAreasplineMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface PlotAreasplineMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotAreasplineOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotAreasplineOnPointPositionOptions {
        /**
    ...
    interface PlotAreasplineOptions {
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotAreasplineDataSortingOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotAreasplineStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotAreasplineStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotAreasplineTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * tooltip.
     */
    interface PlotAreasplineTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotAreasplineTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesAreasplineDataDataLabelsAnimationOptions {
        /**
     ...
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesAreasplineDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesAreasplineDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
