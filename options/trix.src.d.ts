...
declare module "../highcharts.src" {
     ...
     */
    interface PlotTrixAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotTrixDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotTrixDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotTrixDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotTrixDataSortingOptions {
        /**
     ...
     */
    interface PlotTrixLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotTrixMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotTrixMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotTrixOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotTrixOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotTrixOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotTrixOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotTrixOnPointPositionOptions {
        /**
    ...
    interface PlotTrixOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotTrixDataLabelsOptions|Array<Highcharts.PlotTrixDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotTrixDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotTrixOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotTrixParamsOptions;
        /**
     ...
     */
    interface PlotTrixParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotTrixStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotTrixStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotTrixStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotTrixTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotTrixTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotTrixTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesTrixOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesTrixOptions {
     * customProperty: string; }
     *
     */
    interface SeriesTrixOptions extends Highcharts.PlotTrixOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
