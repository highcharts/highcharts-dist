...
declare module "../highcharts.src" {
     ...
     */
    interface PlotErrorbarDataLabelsAnimationOptions {
        /**
     ...
     */
    interface PlotErrorbarDataSortingOptions {
        /**
     ...
     */
    interface PlotErrorbarLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotErrorbarOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotErrorbarOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotErrorbarOnPointPositionOptions);
    }
    /**
     * (Highcharts) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
    ...
    interface PlotErrorbarOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotErrorbarDataLabelsOptions|Array<Highcharts.PlotErrorbarDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotErrorbarDataSortingOptions;
        /**
        ...
        lineWidth?: number;
        /**
         * (Highcharts) The parent series of the error bar. The default value
         * links it to the previous series. Otherwise, use the id of the parent
         * series.
         */
        linkedTo?: string;
        /**
        ...
        /**
         * (Highcharts) The color of the median line. If `undefined`, the
         * general series color applies.
         *
         ...
         */
        medianDashStyle?: Highcharts.DashStyleValue;
        /**
         * (Highcharts) The pixel width of the median line. If `null`, the
         * lineWidth is used.
         *
         * In styled mode, the median stroke width can be set with the
         * `.highcharts-boxplot-median` class.
         ...
         */
        onPoint?: (object|Highcharts.PlotErrorbarOnPointOptions);
        /**
        ...
        /**
         * (Highcharts) The color of the stem, the vertical line extending from
         * the box to the whiskers. If `undefined`, the series color is used.
         *
         ...
         */
        stemDashStyle?: Highcharts.DashStyleValue;
        /**
         * (Highcharts) The width of the stem, the vertical line extending from
         * the box to the whiskers. If `undefined`, the width is inherited from
        ...
        visible?: boolean;
        /**
         * (Highcharts) The color of the whiskers, the horizontal lines marking
         * low and high values. When `undefined`, the general series color is
         * used.
         *
         ...
         */
        whiskerDashStyle?: Highcharts.DashStyleValue;
        /**
         * (Highcharts) The length of the whiskers, the horizontal lines marking
         * low and high values. It can be a numerical pixel value, or a
         * percentage value of the box width. Set `0` to disable whiskers.
         */
        whiskerLength?: (number|string);
        /**
         * (Highcharts) The line width of the whiskers, the horizontal lines
         * marking low and high values. When `null`, the general lineWidth
         * applies.
         */
        whiskerWidth?: number;
        /**
     ...
     */
    interface PlotErrorbarTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotErrorbarTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotErrorbarTooltipPositionOptions {
        /**
    ...
    /**
     * (Highcharts) A `errorbar` series. If the type option is not specified, it
     ...
     *
     */
    interface SeriesErrorbarOptions extends Highcharts.PlotErrorbarOptions, Highcharts.SeriesOptions {
        /**
         * (Highcharts) An array of data points for the series. For the
         * `errorbar` series type, points can be given in the following ways:
         *
