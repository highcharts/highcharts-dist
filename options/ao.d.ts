...
declare module "../highcharts" {
    ...
    interface PlotAoOptions {
         ...
         */
        dataSorting?: (Highcharts.DataSortingOptionsObject|Highcharts.PlotAoDataSortingOptions);
        /**
         ...
         */
        greaterBarColor?: (Highcharts.ColorString|Highcharts.GradientColorObject|Highcharts.PatternObject);
        groupPadding?: number;
        /**
         ...
         */
        lowerBarColor?: (Highcharts.ColorString|Highcharts.GradientColorObject|Highcharts.PatternObject);
        /**
