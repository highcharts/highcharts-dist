...
declare module "../highcharts.src" {
     ...
     */
    interface PlotRocAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotRocDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotRocDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotRocLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotRocMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotRocMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotRocOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotRocOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotRocOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
    ...
    interface PlotRocOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotRocDataLabelsOptions|Array<Highcharts.PlotRocDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotRocDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotRocOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotRocParamsOptions;
        /**
     ...
     */
    interface PlotRocStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotRocTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotRocTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotRocTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesRocOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesRocOptions {
     * customProperty: string; }
     *
     */
    interface SeriesRocOptions extends Highcharts.PlotRocOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
