...
declare module "../highcharts" {
     ...
     */
    interface PlotWaterfallAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotWaterfallDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotWaterfallDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotWaterfallLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
    ...
    interface PlotWaterfallOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotWaterfallDataLabelsOptions|Array<Highcharts.PlotWaterfallDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotWaterfallDataSortingOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotWaterfallStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotWaterfallStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotWaterfallStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotWaterfallTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotWaterfallTooltipHeaderOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesWaterfallDataDataLabelsAnimationOptions {
        /**
