...
declare module "../highcharts" {
     ...
     */
    interface PlotIkhAccessibilityPointOptions {
        /**
    ...
    interface PlotIkhChikouLineStylesOptions {
        /**
     ...
     * (see example).
     */
    interface PlotIkhDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotIkhDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotIkhKijunLineOptions {
        styles?: Highcharts.PlotIkhKijunLineStylesOptions;
    }
     ...
     */
    interface PlotIkhLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotIkhMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotIkhMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotIkhOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotIkhOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotIkhOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
    ...
    interface PlotIkhOptions {
         ...
         * (Highstock) The styles for Chikou line
         */
        chikouLine?: Highcharts.PlotIkhChikouLineOptions;
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotIkhDataLabelsOptions|Array<Highcharts.PlotIkhDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotIkhDataSortingOptions;
        /**
         ...
         * (Highstock) The styles for Kijun line
         */
        kijunLine?: Highcharts.PlotIkhKijunLineOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotIkhOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotIkhParamsOptions;
        /**
         ...
         */
        senkouSpan?: Highcharts.PlotIkhSenkouSpanOptions;
        /**
         * (Highstock) The styles for Senkou Span A line
         */
        senkouSpanA?: Highcharts.PlotIkhSenkouSpanAOptions;
        /**
         * (Highstock) The styles for Senkou Span B line
         */
        senkouSpanB?: Highcharts.PlotIkhSenkouSpanBOptions;
        /**
         ...
         */
        tenkanLine?: Highcharts.PlotIkhTenkanLineOptions;
        /**
     ...
     * (Highstock) The styles for Senkou Span A line
     */
    interface PlotIkhSenkouSpanAOptions {
        styles?: Highcharts.PlotIkhSenkouSpanAStylesOptions;
    }
     ...
     * (Highstock) The styles for Senkou Span B line
     */
    interface PlotIkhSenkouSpanBOptions {
        styles?: Highcharts.PlotIkhSenkouSpanBStylesOptions;
    }
     ...
     * (Highstock) The styles for area between Senkou Span A and B.
     */
    interface PlotIkhSenkouSpanOptions {
        /**
         * (Highstock) Color of the area between Senkou Span A and B, when
         * Senkou Span A is above Senkou Span B. Note that if a `style.fill` is
         * defined, the `color` takes precedence and the `style.fill` is
         * ignored.
         */
        color?: Highcharts.ColorType;
        /**
         * (Highstock) Color of the area between Senkou Span A and B, when
         * Senkou Span A is under Senkou Span B.
         */
        negativeColor?: Highcharts.ColorType;
    }
    /**
     ...
     */
    interface PlotIkhStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotIkhStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
    ...
    interface PlotIkhTenkanLineStylesOptions {
        /**
         * (Highstock) Color of the line.
         */
        lineColor?: Highcharts.ColorString;
     ...
     */
    interface PlotIkhTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotIkhTooltipHeaderOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesIkhOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesIkhOptions {
     * customProperty: string; }
     *
     */
    interface SeriesIkhOptions extends Highcharts.PlotIkhOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
