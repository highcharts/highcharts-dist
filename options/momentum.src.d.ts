...
declare module "../highcharts.src" {
     ...
     */
    interface PlotMomentumAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotMomentumDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotMomentumDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotMomentumDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotMomentumDataSortingOptions {
        /**
     ...
     */
    interface PlotMomentumLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotMomentumMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotMomentumMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotMomentumOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotMomentumOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotMomentumOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotMomentumOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotMomentumOnPointPositionOptions {
        /**
    ...
    interface PlotMomentumOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotMomentumDataLabelsOptions|Array<Highcharts.PlotMomentumDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotMomentumDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotMomentumOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotMomentumParamsOptions;
        /**
     ...
     */
    interface PlotMomentumParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotMomentumStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotMomentumStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotMomentumTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotMomentumTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotMomentumTooltipPositionOptions {
        /**
    ...
    /**
     * (Highstock) A `Momentum` series. If the type option is not specified, it
     ...
     *
     */
    interface SeriesMomentumOptions extends Highcharts.PlotMomentumOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
