...
declare module "../highcharts" {
     ...
     */
    interface PlotArcdiagramDataLabelsAnimationOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotArcdiagramLevelsStatesHoverAnimationOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotArcdiagramLevelsStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * (Highcharts) Animation when hovering over the marker.
     */
    interface PlotArcdiagramMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     * line-type series.
     */
    interface PlotArcdiagramStatesHoverAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotArcdiagramStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotArcdiagramTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotArcdiagramTooltipHeaderOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesArcdiagramDataDataLabelsAnimationOptions {
        /**
    ...
    /**
     * (Highcharts) An `arcdiagram` series. If the type option is not specified,
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesArcdiagramOptions` via an interface to
     * allow custom properties: ``` declare interface SeriesArcdiagramOptions {
     * customProperty: string; }
     *
     */
    interface SeriesArcdiagramOptions extends Highcharts.PlotArcdiagramOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
         ...
         * `arcdiagram` series type, points can be given in the following way:
         *
         ...
         * semi-circle between the nodes, except when overflowing the edge of
         * the plot area, in which case an arc touching the edge is rendered. If
         ...
         * nodes in an arc diagram are auto-generated instances of
         * `Highcharts.Point`, but options can be applied here and linked by the
         * `id`.
         */
        nodes?: Array<Highcharts.SeriesSankeyNodesOptionsObject>;
        /**
         * (Highcharts) The offset of an arc diagram nodes column in relation to
         * the `plotArea`. The offset equal to 50% places nodes in the center of
         * a chart. By default the series is placed so that the biggest node is
