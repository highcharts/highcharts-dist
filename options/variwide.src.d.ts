...
declare module "../highcharts.src" {
     ...
     */
    interface PlotVariwideAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotVariwideDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotVariwideDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotVariwideLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotVariwideOnPointConnectorOptions {
        /**
     ...
     * series in the _Series on point_ feature.
     */
    interface PlotVariwideOnPointPositionOptions {
        /**
    ...
    interface PlotVariwideOptions {
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotVariwideDataSortingOptions;
        /**
     ...
     */
    interface PlotVariwideStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotVariwideStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotVariwideTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotVariwideTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotVariwideTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesVariwideDataDataLabelsAnimationOptions {
        /**
