...
declare module "../highcharts" {
    ...
    interface PlotSupertrendOptions {
         ...
         * (Highcharts, Highstock) Options for the series data sorting.
         */
        dataSorting?: (Highcharts.DataSortingOptionsObject|Highcharts.PlotSupertrendDataSortingOptions);
        /**
         ...
         * main series.
         */
        fallingTrendColor?: (Highcharts.ColorString|Highcharts.GradientColorObject|Highcharts.PatternObject);
        /**
         ...
         * main series.
         */
        risingTrendColor?: (Highcharts.ColorString|Highcharts.GradientColorObject|Highcharts.PatternObject);
        /**
