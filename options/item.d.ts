...
declare module "../highcharts" {
     ...
     */
    interface PlotItemOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotItemOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotItemOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotItemOnPointPositionOptions);
    }
    /**
     * (Highcharts) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotItemOnPointPositionOptions {
        /**
    ...
    interface PlotItemOptions {
         ...
         * diameter of the circle. Can be a percentage or pixel value.
         * Percentages are relative to the outer perimeter. Pixel values are
         * given as integers.
         *
         ...
         * where the size of the item is 1.
         */
        itemPadding?: number;
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotItemOnPointOptions);
        /**
         ...
         * circular view. If the `innerSize` is set, it will be overridden by
         * the `rows` setting.
         */
        rows?: number;
        /**
     ...
     * line-type series.
     */
    interface PlotItemStatesHoverAnimationOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotItemStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotItemTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotItemTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotItemTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesItemDataDataLabelsAnimationOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesItemOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesItemOptions {
     * customProperty: string; }
     *
     */
    interface SeriesItemOptions extends Highcharts.PlotItemOptions, Highcharts.SeriesOptions {
        /**
