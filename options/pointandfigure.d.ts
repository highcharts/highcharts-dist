...
declare module "../highcharts" {
     ...
     * line-type series.
     */
    interface PlotPointandfigureStatesHoverAnimationOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotPointandfigureStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * a split tooltip.
     */
    interface PlotPointandfigureTooltipHeaderOptions {
        /**
