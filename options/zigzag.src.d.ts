...
declare module "../highcharts.src" {
     ...
     */
    interface PlotZigzagAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotZigzagDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotZigzagDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotZigzagDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotZigzagDataSortingOptions {
        /**
     ...
     */
    interface PlotZigzagLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotZigzagMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotZigzagMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotZigzagOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotZigzagOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotZigzagOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotZigzagOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotZigzagOnPointPositionOptions {
        /**
    ...
    interface PlotZigzagOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotZigzagDataLabelsOptions|Array<Highcharts.PlotZigzagDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotZigzagDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotZigzagOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotZigzagParamsOptions;
        /**
     ...
     */
    interface PlotZigzagParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotZigzagStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotZigzagStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotZigzagTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotZigzagTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotZigzagTooltipPositionOptions {
        /**
    ...
    /**
     * (Highstock) A `Zig Zag` series. If the type option is not specified, it
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesZigzagOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesZigzagOptions {
     * customProperty: string; }
     *
     */
    interface SeriesZigzagOptions extends Highcharts.PlotZigzagOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
