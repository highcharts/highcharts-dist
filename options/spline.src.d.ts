...
declare module "../highcharts.src" {
     ...
     */
    interface PlotSplineAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotSplineDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotSplineDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotSplineDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotSplineDataSortingOptions {
        /**
     ...
     */
    interface PlotSplineLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotSplineMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface PlotSplineMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotSplineOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotSplineOnPointOptions {
        /**
         * (Highcharts, Highstock) Options for the connector in the _Series on
         * point_ feature.
         *
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotSplineOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
    ...
    interface PlotSplineOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotSplineDataLabelsOptions|Array<Highcharts.PlotSplineDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotSplineDataSortingOptions;
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotSplineOnPointOptions);
        /**
     ...
     * line-type series.
     */
    interface PlotSplineStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotSplineStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotSplineStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotSplineTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * tooltip.
     */
    interface PlotSplineTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotSplineTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesSplineDataDataLabelsAnimationOptions {
        /**
     ...
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesSplineDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesSplineDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesSplineOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesSplineOptions {
     * customProperty: string; }
     *
     */
    interface SeriesSplineOptions extends Highcharts.PlotSplineOptions, Highcharts.SeriesOptions {
        /**
         * (Highcharts, Highstock) An array of data points for the series. For
         * the `spline` series type, points can be given in the following ways:
         *
