...
declare module "../highcharts" {
     ...
     */
    interface PlotKeltnerchannelsAccessibilityPointOptions {
        /**
     ...
     * (Highstock) Styles for a bottom line.
     */
    interface PlotKeltnerchannelsBottomLineStylesOptions {
        /**
     ...
     * (see example).
     */
    interface PlotKeltnerchannelsDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotKeltnerchannelsDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotKeltnerchannelsLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotKeltnerchannelsMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotKeltnerchannelsOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotKeltnerchannelsOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotKeltnerchannelsOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     ...
     */
    interface PlotKeltnerchannelsOptions {
        /**
         ...
         * (Highstock) Bottom line options.
         */
        bottomLine?: Highcharts.PlotKeltnerchannelsBottomLineOptions;
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotKeltnerchannelsDataLabelsOptions|Array<Highcharts.PlotKeltnerchannelsDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotKeltnerchannelsDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotKeltnerchannelsOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotKeltnerchannelsParamsOptions;
        /**
         ...
         */
        topLine?: Highcharts.PlotKeltnerchannelsTopLineOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotKeltnerchannelsStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotKeltnerchannelsTooltipHeaderOptions {
        /**
     ...
     * (Highstock) Top line options.
     */
    interface PlotKeltnerchannelsTopLineOptions {
        /**
         * (Highstock) Styles for a bottom line.
         */
        styles?: Highcharts.PlotKeltnerchannelsTopLineStylesOptions;
    }
    /**
     * (Highstock) Styles for a bottom line.
     */
     ...
     * SeriesKeltnerchannelsOptions { customProperty: string; }
     *
     */
    interface SeriesKeltnerchannelsOptions extends Highcharts.PlotKeltnerchannelsOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
