...
declare module "../highcharts" {
     ...
     */
    interface PlotAbandsAccessibilityPointOptions {
        /**
    ...
    interface PlotAbandsBottomLineOptions {
        styles?: Highcharts.PlotAbandsBottomLineStylesOptions;
    }
    interface PlotAbandsBottomLineStylesOptions {
        /**
     ...
     */
    interface PlotAbandsDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotAbandsDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotAbandsDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotAbandsDataSortingOptions {
        /**
     ...
     */
    interface PlotAbandsLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotAbandsMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotAbandsMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotAbandsOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotAbandsOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotAbandsOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotAbandsOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotAbandsOnPointPositionOptions {
        /**
    ...
    interface PlotAbandsOptions {
        ...
        bottomLine?: Highcharts.PlotAbandsBottomLineOptions;
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotAbandsDataLabelsOptions|Array<Highcharts.PlotAbandsDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotAbandsDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotAbandsOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotAbandsParamsOptions;
        /**
        ...
        topLine?: Highcharts.PlotAbandsTopLineOptions;
        /**
     ...
     */
    interface PlotAbandsParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotAbandsStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotAbandsStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotAbandsStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotAbandsTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotAbandsTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotAbandsTooltipPositionOptions {
        /**
    ...
    interface PlotAbandsTopLineOptions {
        styles?: Highcharts.PlotAbandsTopLineStylesOptions;
    }
    interface PlotAbandsTopLineStylesOptions {
        /**
         * (Highstock) Pixel width of the line.
         */
        lineWidth?: number;
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesAbandsOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesAbandsOptions {
     * customProperty: string; }
     *
     */
    interface SeriesAbandsOptions extends Highcharts.PlotAbandsOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
