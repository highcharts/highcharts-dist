...
declare module "../highcharts" {
     ...
     * a split tooltip.
     */
    interface PlotFlowmapTooltipHeaderOptions {
        /**
     ...
     */
    interface SeriesFlowmapDataMarkerEndOptions {
        /**
     ...
     *
     */
    interface SeriesFlowmapOptions extends Highcharts.PlotFlowmapOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
         ...
         * series type, points can be given in the following ways:
         *
         * 1. An array of arrays with options as values. In this case, the
         * values correspond to `from, to, weight`. Example: (see online
         * documentation for example)
         *
         * 2. An array of objects with named values. The following snippet shows
         * only a few settings, see the complete options set below. (see online
         * documentation for example)
         *
         * 3. For objects with named values, instead of using the `mappoint`
         * `id`, you can use `[longitude, latitude]` arrays. (see online
         * documentation for example)
         */
        data?: Array<(number|null|Highcharts.SeriesFlowmapDataOptions)>;
        /**
         * Not available
         */
        mapData?: undefined;
