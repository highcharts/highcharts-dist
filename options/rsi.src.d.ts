...
declare module "../highcharts.src" {
     ...
     */
    interface PlotRsiAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotRsiDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotRsiDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotRsiDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotRsiDataSortingOptions {
        /**
     ...
     */
    interface PlotRsiLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotRsiMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotRsiMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotRsiOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotRsiOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotRsiOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotRsiOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotRsiOnPointPositionOptions {
        /**
    ...
    interface PlotRsiOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotRsiDataLabelsOptions|Array<Highcharts.PlotRsiDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotRsiDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotRsiOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotRsiParamsOptions;
        /**
     ...
     */
    interface PlotRsiParamsOptions {
        decimals?: number;
        /**
     ...
     * line-type series.
     */
    interface PlotRsiStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotRsiStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotRsiStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotRsiTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotRsiTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotRsiTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesRsiOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesRsiOptions {
     * customProperty: string; }
     *
     */
    interface SeriesRsiOptions extends Highcharts.PlotRsiOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
