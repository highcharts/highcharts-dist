...
declare module "../highcharts.src" {
     ...
     */
    interface PlotBubbleAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotBubbleDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotBubbleDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotBubbleDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotBubbleDataSortingOptions {
        /**
     ...
     */
    interface PlotBubbleJitterOptions {
        /**
     ...
     */
    interface PlotBubbleLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotBubbleMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface PlotBubbleMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotBubbleOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotBubbleOnPointOptions {
        /**
         * (Highcharts, Highstock) Options for the connector in the _Series on
         * point_ feature.
         *
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotBubbleOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
    ...
    interface PlotBubbleOptions {
         ...
         * the `animationLimit`, the animation won't run. Animation affects
         * overall performance and doesn't work well with heavy data series.
         */
        ...
        /**
         * (Highcharts, Highstock) When using automatic point colors pulled from
         * the global colors or series-specific plotOptions.bubble.colors
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotBubbleDataLabelsOptions|Array<Highcharts.PlotBubbleDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotBubbleDataSortingOptions;
        /**
         ...
         * The threshold is given by the zThreshold option, and negative bubbles
         ...
         * supported.
         */
        jitter?: Highcharts.PlotBubbleJitterOptions;
        /**
         ...
         * `z` value of each bubble. Can be either pixels (when no unit is
         * given), or a percentage of the smallest one of the plot width and
         * height.
         */
         ...
         */
        onPoint?: (object|Highcharts.PlotBubbleOnPointOptions);
        /**
         ...
         * represented by the area or the width of the bubble. The default,
         * `area`, corresponds best to the human perception of the size of each
         * bubble.
         */
        sizeBy?: Highcharts.BubbleSizeByValue;
        /**
         * (Highcharts) When this is true, the absolute value of z determines
         * the size of the bubble. This means that with the default `zThreshold`
         * of 0, a bubble of value -1 will have the same size as a bubble of
         * value 1, while a bubble of value 0 will have a smaller size according
         * to `minSize`.
         */
     ...
     * line-type series.
     */
    interface PlotBubbleStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotBubbleStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotBubbleTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * a split tooltip.
     */
    interface PlotBubbleTooltipHeaderOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesBubbleDataDataLabelsAnimationOptions {
        /**
     ...
     */
    interface SeriesBubbleDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts) Animation when hovering over the marker.
     */
    interface SeriesBubbleDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesBubbleOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesBubbleOptions {
     * customProperty: string; }
     *
     */
    interface SeriesBubbleOptions extends Highcharts.PlotBubbleOptions, Highcharts.SeriesOptions {
        /**
