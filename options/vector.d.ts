...
declare module "../highcharts" {
     ...
     */
    interface PlotVectorClusterDataLabelsAnimationOptions {
        /**
    ...
    interface PlotVectorClusterDataLabelsOptions {
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotVectorClusterDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
         ...
         */
        style?: (Highcharts.CSSObject|Highcharts.PlotVectorClusterDataLabelsStyleOptions);
        /**
     ...
     * inside long words.
     */
    interface PlotVectorClusterDataLabelsStyleOptions {
        color?: string;
    }
     ...
     * iterations.
     */
    interface PlotVectorClusterLayoutAlgorithmOptions {
        /**
    ...
    interface PlotVectorClusterOptions {
         ...
         * labels.
         */
        dataLabels?: (Highcharts.DataLabelsOptions|Highcharts.PlotVectorClusterDataLabelsOptions);
        /**
    ...
    interface PlotVectorClusterStatesHoverOptions {
        /**
     ...
     * `className` option.
     */
    interface PlotVectorClusterZonesOptions {
        /**
     ...
     * (see example).
     */
    interface PlotVectorDataLabelsOptions {
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The alignment of the data
         * label compared to the point. If `right`, the right side of the label
         * should be touching the point. For points with an extent, like
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotVectorDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) The background color or
         * gradient for the data label. In addition to regular colors, there are
         * two special setting for this option:
     ...
     */
    interface PlotVectorLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
    ...
    interface PlotVectorOptions {
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotVectorDataSortingOptions;
        /**
     ...
     */
    interface PlotVectorStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotVectorStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotVectorTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * a split tooltip.
     */
    interface PlotVectorTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotVectorTooltipPositionOptions {
        /**
     ...
     */
    interface SeriesVectorDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesVectorDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesVectorOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesVectorOptions {
     * customProperty: string; }
     *
     */
    interface SeriesVectorOptions extends Highcharts.PlotVectorOptions, Highcharts.SeriesOptions {
        /**
         * (Highcharts, Highstock) An array of data points for the series. For
         * the `vector` series type, points can be given in the following ways:
         *
         * 1. An array of arrays with 4 values. In this case, the values
         * correspond to to `x,y,length,direction`. If the first value is a
         * string, it is applied as the name of the point, and the `x` value is
         * inferred. (see online documentation for example)
         *
         ...
         */
        data?: Array<([(number|string), number, number, number]|Highcharts.PointOptionsObject)>;
        /**
