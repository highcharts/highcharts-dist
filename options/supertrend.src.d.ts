...
declare module "../highcharts.src" {
     ...
     */
    interface PlotSupertrendAccessibilityPointOptions {
        /**
     ...
     * series.
     */
    interface PlotSupertrendChangeTrendLineOptions {
        styles?: Highcharts.PlotSupertrendChangeTrendLineStylesOptions;
    }
    interface PlotSupertrendChangeTrendLineStylesOptions {
        /**
         * (Highstock) The dash or dot style of the grid lines. For possible
     ...
     */
    interface PlotSupertrendDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotSupertrendDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotSupertrendDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotSupertrendDataSortingOptions {
        /**
     ...
     */
    interface PlotSupertrendLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotSupertrendMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotSupertrendMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotSupertrendOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotSupertrendOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotSupertrendOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotSupertrendOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotSupertrendOnPointPositionOptions {
        /**
     ...
     */
    interface PlotSupertrendOptions {
        /**
         ...
         * series.
         */
        changeTrendLine?: Highcharts.PlotSupertrendChangeTrendLineOptions;
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotSupertrendDataLabelsOptions|Array<Highcharts.PlotSupertrendDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotSupertrendDataSortingOptions;
        /**
        ...
        /**
         * (Highstock) Color of the Supertrend series line that is above the
         * main series.
         */
        fallingTrendColor?: Highcharts.ColorType;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotSupertrendOnPointOptions);
        /**
        ...
        opacity?: number;
        /**
         * (Highstock) Parameters used in calculation of Supertrend indicator
         * series points.
         */
        params?: Highcharts.PlotSupertrendParamsOptions;
        /**
        ...
        /**
         * (Highstock) Color of the Supertrend series line that is beneath the
         * main series.
         */
        risingTrendColor?: Highcharts.ColorType;
        /**
     ...
     * points.
     */
    interface PlotSupertrendParamsOptions {
        index?: string;
        /**
     ...
     * line-type series.
     */
    interface PlotSupertrendStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotSupertrendStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotSupertrendTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotSupertrendTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotSupertrendTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesSupertrendOptions` via an interface to
     * allow custom properties: ``` declare interface SeriesSupertrendOptions {
     * customProperty: string; }
     *
     */
    interface SeriesSupertrendOptions extends Highcharts.PlotSupertrendOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
