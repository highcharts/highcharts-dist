...
declare module "../highcharts.src" {
     ...
     */
    interface PlotHeikinashiAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotHeikinashiDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotHeikinashiDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotHeikinashiDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotHeikinashiDataSortingOptions {
        /**
     ...
     */
    interface PlotHeikinashiLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotHeikinashiOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotHeikinashiOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotHeikinashiOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotHeikinashiOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotHeikinashiOnPointPositionOptions {
        /**
     ...
     */
    interface PlotHeikinashiOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotHeikinashiDataLabelsOptions|Array<Highcharts.PlotHeikinashiDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotHeikinashiDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotHeikinashiOnPointOptions);
        /**
         ...
         */
        upColor?: Highcharts.ColorType;
        /**
         * (Highstock) The specific line color for up candle sticks. The default
         * is to inherit the general `lineColor` setting.
         */
        upLineColor?: Highcharts.ColorType;
        /**
     ...
     * line-type series.
     */
    interface PlotHeikinashiStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotHeikinashiStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotHeikinashiStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotHeikinashiTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotHeikinashiTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotHeikinashiTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesHeikinashiDataDataLabelsAnimationOptions {
        /**
    ...
    /**
     * (Highstock) A `heikinashi` series. If the type option is not specified,
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesHeikinashiOptions` via an interface to
     * allow custom properties: ``` declare interface SeriesHeikinashiOptions {
     * customProperty: string; }
     *
     */
    interface SeriesHeikinashiOptions extends Highcharts.PlotHeikinashiOptions, Highcharts.SeriesOptions {
        /**
         * (Highstock) An array of data points for the series. For the
         * `heikinashi` series type, points can be given in the following ways:
         *
