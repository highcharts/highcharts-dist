...
declare module "../highcharts.src" {
    ...
    interface PlotWordcloudOptions {
         ...
         * several chart types.
         */
        animation?: (boolean|Highcharts.AnimationOptionsObject|Highcharts.PlotWordcloudAnimationOptions);
        /**
         ...
         * weight and the largest occurring weight, multiplied with the value of
         * maxFontSize.
         */
        maxFontSize?: number;
        /**
         ...
         * placement, and rotation of a word. The choice of algorithm is
     ...
     * line-type series.
     */
    interface PlotWordcloudStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotWordcloudTooltipHeaderOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesWordcloudDataDataLabelsAnimationOptions {
        /**
