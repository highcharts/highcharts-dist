...
declare module "../highcharts" {
     ...
     */
    interface PlotHistogramAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotHistogramDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotHistogramDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotHistogramLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotHistogramOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotHistogramOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotHistogramOnPointPositionOptions);
    }
    /**
     * (Highcharts) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
    ...
    interface PlotHistogramOptions {
         ...
         * histogram may have a different number of bins. By default it is set
         * to the square root of the base series' data length. Available options
         * are: `square-root`, `sturges`, `rice`. You can also define a function
         * which takes a `baseSeries` as a parameter and should return a
         * positive integer.
         */
        binsNumber?: ("rice"|"square-root"|"sturges"|number|Function);
        /**
         * (Highcharts) Width of each bin. By default the bin's width is
         * calculated as `(max - min) / number of bins`. This option takes
         * precedence over binsNumber.
         */
        binWidth?: number;
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotHistogramDataLabelsOptions|Array<Highcharts.PlotHistogramDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotHistogramDataSortingOptions;
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotHistogramOnPointOptions);
        /**
     ...
     */
    interface PlotHistogramStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotHistogramTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
