...
declare module "../highcharts.src" {
     ...
     */
    interface PlotVbpAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotVbpDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotVbpDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotVbpDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
         ...
         */
        style?: (Highcharts.CSSObject|Highcharts.PlotVbpDataLabelsStyleOptions);
        /**
     ...
     * inside long words.
     */
    interface PlotVbpDataLabelsStyleOptions {
        fontSize?: number;
    }
    /**
     * (Highcharts, Highstock) Options for series data sorting.
     */
    interface PlotVbpDataSortingOptions {
        /**
     ...
     */
    interface PlotVbpLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotVbpMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotVbpMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotVbpOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotVbpOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotVbpOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotVbpOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotVbpOnPointPositionOptions {
        /**
    ...
    interface PlotVbpOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotVbpDataLabelsOptions|Array<Highcharts.PlotVbpDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotVbpDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotVbpOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotVbpParamsOptions;
        /**
         ...
         * positive/negative.
         */
        volumeDivision?: Highcharts.PlotVbpVolumeDivisionOptions;
        /**
         ...
         */
        zoneLines?: Highcharts.PlotVbpZoneLinesOptions;
        /**
     ...
     */
    interface PlotVbpParamsOptions {
        index?: string;
        period?: string;
        /**
     ...
     */
    interface PlotVbpStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotVbpStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotVbpTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotVbpTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotVbpTooltipPositionOptions {
        /**
     ...
     * positive/negative.
     */
    interface PlotVbpVolumeDivisionOptions {
        /**
         * (Highstock) Option to control if volume is divided.
         */
        enabled?: boolean;
        styles?: Highcharts.PlotVbpVolumeDivisionStylesOptions;
    }
    interface PlotVbpVolumeDivisionStylesOptions {
        /**
         * (Highstock) Color of negative volume bars.
         */
        negativeColor?: Highcharts.ColorString;
        /**
         * (Highstock) Color of positive volume bars.
         */
        positiveColor?: Highcharts.ColorString;
    }
    /**
     * (Highstock) The styles for lines which determine price zones.
     */
    interface PlotVbpZoneLinesOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesVbpOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesVbpOptions {
     * customProperty: string; }
     *
     */
    interface SeriesVbpOptions extends Highcharts.PlotVbpOptions, Highcharts.SeriesOptions {
        /**
