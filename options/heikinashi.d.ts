...
declare module "../highcharts" {
    ...
    interface PlotHeikinashiOptions {
         ...
         */
        dataSorting?: (Highcharts.DataSortingOptionsObject|Highcharts.PlotHeikinashiDataSortingOptions);
        /**
         ...
         */
        upLineColor?: (Highcharts.ColorString|Highcharts.GradientColorObject|Highcharts.PatternObject);
        /**
