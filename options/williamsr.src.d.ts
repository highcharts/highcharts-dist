...
declare module "../highcharts.src" {
     ...
     */
    interface PlotWilliamsrAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotWilliamsrDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotWilliamsrDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotWilliamsrLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotWilliamsrMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotWilliamsrMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotWilliamsrOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotWilliamsrOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotWilliamsrOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     ...
     */
    interface PlotWilliamsrOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotWilliamsrDataLabelsOptions|Array<Highcharts.PlotWilliamsrDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotWilliamsrDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotWilliamsrOnPointOptions);
        /**
        ...
        opacity?: number;
        /**
         * (Highstock) Parameters used in calculation of Williams %R series
         * points.
         */
        params?: Highcharts.PlotWilliamsrParamsOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotWilliamsrStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotWilliamsrStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotWilliamsrTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotWilliamsrTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotWilliamsrTooltipPositionOptions {
        /**
     ...
     *
     */
    interface SeriesWilliamsrOptions extends Highcharts.PlotWilliamsrOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
