...
declare module "../highcharts.src" {
     ...
     */
    interface PlotDemaAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotDemaDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotDemaDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotDemaDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotDemaDataSortingOptions {
        /**
     ...
     */
    interface PlotDemaLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotDemaMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotDemaMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotDemaOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotDemaOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotDemaOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotDemaOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotDemaOnPointPositionOptions {
        /**
    ...
    interface PlotDemaOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotDemaDataLabelsOptions|Array<Highcharts.PlotDemaDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotDemaDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotDemaOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotDemaParamsOptions;
        /**
     ...
     */
    interface PlotDemaParamsOptions {
        /**
     ...
     */
    interface PlotDemaStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotDemaStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotDemaTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotDemaTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotDemaTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesDemaOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesDemaOptions {
     * customProperty: string; }
     *
     */
    interface SeriesDemaOptions extends Highcharts.PlotDemaOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
