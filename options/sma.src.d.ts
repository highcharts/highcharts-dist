...
declare module "../highcharts.src" {
     ...
     */
    interface PlotSmaAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotSmaDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotSmaDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotSmaDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotSmaDataSortingOptions {
        /**
     ...
     */
    interface PlotSmaLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotSmaMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotSmaMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotSmaOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotSmaOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotSmaOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotSmaOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotSmaOnPointPositionOptions {
        /**
    ...
    interface PlotSmaOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotSmaDataLabelsOptions|Array<Highcharts.PlotSmaDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotSmaDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotSmaOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotSmaParamsOptions;
        /**
     ...
     */
    interface PlotSmaParamsOptions {
        /**
     ...
     */
    interface PlotSmaStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotSmaTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotSmaTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotSmaTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesSmaOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesSmaOptions {
     * customProperty: string; }
     *
     */
    interface SeriesSmaOptions extends Highcharts.PlotSmaOptions, Highcharts.SeriesOptions {
        /**
