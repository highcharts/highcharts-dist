...
declare module "../highcharts.src" {
     ...
     */
    interface PlotFlagsAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotFlagsDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotFlagsDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotFlagsDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotFlagsDataSortingOptions {
        /**
     ...
     */
    interface PlotFlagsLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotFlagsOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotFlagsOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotFlagsOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotFlagsOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotFlagsOnPointPositionOptions {
        /**
    ...
    interface PlotFlagsOptions {
         ...
         * `false`, the flags are moved sideways using an algorithm that seeks
         * to place every flag as close as possible to its original position.
         */
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotFlagsDataLabelsOptions|Array<Highcharts.PlotFlagsDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotFlagsDataSortingOptions;
        /**
         ...
         * flags series, the default is `flag-icon`, a pole with a pennant.
         */
         ...
         * to place it. Line and columns have one key, `y`. In range or
         * OHLC-type series, however, the flag can optionally be placed on the
         * `open`, `high`, `low` or `close` key.
         */
        onKey?: Highcharts.OptionsOnKeyValue;
        /**
         * (Highstock) Options for the _Series on point_ feature. Only `pie` and
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotFlagsOnPointOptions);
        /**
         ...
         * "circlepin", "squarepin", or an image of the format
         * `url(/path-to-image.jpg)`. Individual shapes can also be set for each
         * point.
         */
         ...
         */
        textAlign?: Highcharts.OptionsTextAlignValue;
        /**
         ...
         * tooltips are different from most other types in that a flag doesn't
         * have a data value, so the tooltip rather displays the `text` option
         * for each point.
         */
        tooltip?: Highcharts.SeriesTooltipOptionsObject;
        /**
         * (Highstock) Whether to use HTML to render the flag texts. Using HTML
         * allows for advanced formatting, images and reliable bi-directional
         * text rendering. Note that exported images won't respect the HTML, and
         ...
         * relative to either the series (if onSeries is defined), or the x
         * axis. Defaults to `-30`.
         */
        y?: number;
        /**
     ...
     * line-type series.
     */
    interface PlotFlagsStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotFlagsStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotFlagsStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotFlagsTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotFlagsTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotFlagsTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesFlagsOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesFlagsOptions {
     * customProperty: string; }
     *
     */
    interface SeriesFlagsOptions extends Highcharts.PlotFlagsOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
