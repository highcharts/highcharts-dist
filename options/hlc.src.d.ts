...
declare module "../highcharts.src" {
     ...
     */
    interface PlotHlcAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotHlcDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotHlcDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotHlcDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotHlcDataSortingOptions {
        /**
     ...
     */
    interface PlotHlcLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotHlcOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotHlcOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotHlcOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotHlcOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotHlcOnPointPositionOptions {
        /**
    ...
    interface PlotHlcOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotHlcDataLabelsOptions|Array<Highcharts.PlotHlcDataLabelsOptions>);
        /**
         ...
         * HLC series, the default is `hlc`, a vertical stem with a tick on the
         * right representing the closing value.
         */
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotHlcOnPointOptions);
        /**
        ...
        /**
         * (Highstock) Determines which one of `high`, `low`, `close` values
         * should be represented as `point.y`, which is later used to set
         * dataLabel position and compare.
         */
        pointValKey?: Highcharts.OptionsHLCPointValKeyValue;
        /**
     ...
     * line-type series.
     */
    interface PlotHlcStatesHoverAnimationOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotHlcStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotHlcTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotHlcTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotHlcTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesHlcDataDataLabelsAnimationOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesHlcOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesHlcOptions {
     * customProperty: string; }
     *
     */
    interface SeriesHlcOptions extends Highcharts.PlotHlcOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        borderRadius?: undefined;
        /**
         * (Highstock) An array of data points for the series. For the `hlc`
         * series type, points can be given in the following ways:
         *
         * 1. An array of arrays with 4 or 3 values. In this case, the values
         * correspond to `x,high,low,close`. If the first value is a string, it
         * is applied as the name of the point, and the `x` value is inferred.
         * The `x` value can also be omitted, in which case the inner arrays
         * should be of length of 3\. Then the `x` value is automatically
         ...
         */
        data?: Array<([(number|string), number, number]|[(number|string), number, number, number]|Highcharts.PointOptionsObject)>;
        /**
         * Not available
         */
        stack?: undefined;
