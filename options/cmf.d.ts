...
declare module "../highcharts" {
     ...
     */
    interface PlotCmfAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotCmfDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotCmfDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotCmfLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotCmfMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotCmfMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotCmfOnPointConnectorOptions {
        /**
     ...
     * series in the _Series on point_ feature.
     */
    interface PlotCmfOnPointPositionOptions {
        /**
    ...
    interface PlotCmfOptions {
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotCmfDataSortingOptions;
        /**
     ...
     */
    interface PlotCmfParamsOptions {
        index?: string;
        /**
     ...
     * line-type series.
     */
    interface PlotCmfStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotCmfStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotCmfTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotCmfTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotCmfTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesCmfOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesCmfOptions {
     * customProperty: string; }
     *
     */
    interface SeriesCmfOptions extends Highcharts.PlotCmfOptions, Highcharts.SeriesOptions {
        /**
