...
declare module "../highcharts.src" {
     ...
     */
    interface PlotAdAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotAdDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotAdDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotAdDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotAdDataSortingOptions {
        /**
     ...
     */
    interface PlotAdLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotAdMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotAdMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotAdOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotAdOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotAdOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotAdOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotAdOnPointPositionOptions {
        /**
    ...
    interface PlotAdOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotAdDataLabelsOptions|Array<Highcharts.PlotAdDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotAdDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotAdOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotAdParamsOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotAdStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotAdStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotAdStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotAdTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotAdTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotAdTooltipPositionOptions {
        /**
     ...
     * properties: ``` declare interface SeriesAdOptions { customProperty:
     * string; }
     *
     */
    interface SeriesAdOptions extends Highcharts.PlotAdOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
