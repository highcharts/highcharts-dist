...
declare module "../highcharts.src" {
     ...
     * (Highcharts) Animation when hovering over the marker.
     */
    interface PlotPackedbubbleMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
    ...
    interface PlotPackedbubbleOptions {
        ...
        /**
         * (Highcharts) When using automatic point colors pulled from the global
     ...
     */
    interface PlotPackedbubbleTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
