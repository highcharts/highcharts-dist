...
declare module "../highcharts" {
     ...
     */
    interface PlotLineMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface PlotLineMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
    ...
    interface PlotLineOptions {
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotLineDataSortingOptions;
        /**
     ...
     */
    interface PlotLineStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotLineTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * tooltip.
     */
    interface PlotLineTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotLineTooltipPositionOptions {
        /**
     ...
     */
    interface SeriesLineDataDragDropOptions {
        /**
         * (Highcharts, Highstock, Gantt) Enable dragging in the X dimension.
         */
        draggableX?: boolean;
        /**
         * (Highcharts, Highstock, Gantt) Enable dragging in the Y dimension.
         * Note that this is not supported for TreeGrid axes (the default axis
         * type in Gantt charts).
         */
        draggableY?: boolean;
        /**
         * (Highcharts, Highstock, Gantt) Options for the drag handles available
         * in column series.
         */
        dragHandle?: Highcharts.DragDropHandleOptionsObject;
        /**
         * (Highcharts, Highstock, Gantt) Set the maximum X value the points can
         * be moved to.
         */
        dragMaxX?: (number|string);
        /**
         * (Highcharts, Highstock, Gantt) Set the maximum Y value the points can
         * be moved to.
         */
        dragMaxY?: number;
        /**
         * (Highcharts, Highstock, Gantt) Set the minimum X value the points can
         * be moved to.
         */
        dragMinX?: (number|string);
        /**
         * (Highcharts, Highstock, Gantt) Set the minimum Y value the points can
         * be moved to.
         */
        dragMinY?: number;
        /**
         * (Highcharts, Highstock, Gantt) The X precision value to drag to for
         * this series. Set to 0 to disable. By default this is disabled, except
         * for category axes, where the default is `1`.
         */
        dragPrecisionX?: number;
        /**
         * (Highcharts, Highstock, Gantt) The Y precision value to drag to for
         * this series. Set to 0 to disable. By default this is disabled, except
         * for category axes, where the default is `1`.
         */
        dragPrecisionY?: number;
        /**
         * (Highcharts, Highstock, Gantt) The amount of pixels to drag the
         * pointer before it counts as a drag operation. This prevents drag/drop
         * to fire when just clicking or selecting points.
         */
        ...
        groupBy?: string;
        /**
         * (Highcharts, Highstock, Gantt) Style options for the guide box. The
         * guide box has one state by default, the `default` state.
         */
        guideBox?: (Highcharts.PlotOptionsSeriesDragDropGuideBoxOptions|Highcharts.Dictionary<Highcharts.DragDropGuideBoxOptionsObject>);
        /**
     ...
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesLineDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesLineDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
