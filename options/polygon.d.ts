...
declare module "../highcharts" {
     ...
     */
    interface PlotPolygonAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotPolygonDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotPolygonDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotPolygonDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotPolygonDataSortingOptions {
        /**
     ...
     */
    interface PlotPolygonLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotPolygonMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface PlotPolygonMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotPolygonOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotPolygonOnPointOptions {
        /**
         * (Highcharts, Highstock) Options for the connector in the _Series on
         * point_ feature.
         *
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotPolygonOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
    ...
    interface PlotPolygonOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotPolygonDataLabelsOptions|Array<Highcharts.PlotPolygonDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotPolygonDataSortingOptions;
        /**
        ...
        /**
         * (Highcharts, Highstock) Fill opacity for the polygon. When you set an
         ...
         */
        onPoint?: (object|Highcharts.PlotPolygonOnPointOptions);
        /**
     ...
     * line-type series.
     */
    interface PlotPolygonStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotPolygonStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotPolygonStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotPolygonTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * a split tooltip.
     */
    interface PlotPolygonTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotPolygonTooltipPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesPolygonDataDataLabelsAnimationOptions {
        /**
     ...
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesPolygonDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface SeriesPolygonDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     *
     */
    interface SeriesPolygonOptions extends Highcharts.PlotPolygonOptions, Highcharts.SeriesOptions {
        /**
         * (Highcharts, Highstock) An array of data points for the series. For
         * the `polygon` series type, points can be given in the following ways:
         *
