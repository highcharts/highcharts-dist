...
declare module "../highcharts.src" {
     ...
     */
    interface PlotSlowstochasticAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotSlowstochasticDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotSlowstochasticDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotSlowstochasticDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotSlowstochasticDataSortingOptions {
        /**
     ...
     */
    interface PlotSlowstochasticLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotSlowstochasticMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotSlowstochasticMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotSlowstochasticOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotSlowstochasticOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotSlowstochasticOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotSlowstochasticOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotSlowstochasticOnPointPositionOptions {
        /**
     ...
     */
    interface PlotSlowstochasticOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotSlowstochasticDataLabelsOptions|Array<Highcharts.PlotSlowstochasticDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotSlowstochasticDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotSlowstochasticOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotSlowstochasticParamsOptions;
        /**
         ...
         */
        smoothedLine?: Highcharts.PlotSlowstochasticSmoothedLineOptions;
        /**
     ...
     */
    interface PlotSlowstochasticParamsOptions {
        index?: string;
        period?: string;
        /**
         * (Highstock) Periods for Slow Stochastic oscillator: [%K, %D,
         * SMA(%D)].
         */
     ...
     * (Highstock) Smoothed line options.
     */
    interface PlotSlowstochasticSmoothedLineOptions {
        /**
         * (Highstock) Styles for a smoothed line.
         */
        styles?: Highcharts.PlotSlowstochasticSmoothedLineStylesOptions;
    }
    /**
     * (Highstock) Styles for a smoothed line.
     */
    interface PlotSlowstochasticSmoothedLineStylesOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotSlowstochasticStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotSlowstochasticStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotSlowstochasticStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotSlowstochasticTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotSlowstochasticTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotSlowstochasticTooltipPositionOptions {
        /**
    ...
    /**
     * (Highstock) A Slow Stochastic indicator. If the type option is not
     ...
     * SeriesSlowstochasticOptions { customProperty: string; }
     *
     */
    interface SeriesSlowstochasticOptions extends Highcharts.PlotSlowstochasticOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
