...
declare module "../highcharts" {
     ...
     */
    interface PlotOhlcAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotOhlcDataLabelsOptions {
        /**
         ...
         */
        animation?: (boolean|Highcharts.PlotOhlcDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
    ...
    interface PlotOhlcOptions {
         ...
         */
        dataSorting?: Highcharts.PlotOhlcDataSortingOptions;
        /**
         ...
         * OHLC series, the default is `ohlc`, a vertical stem with an open tick
         * on the left and a close tick on the right.
         */
     ...
     */
    interface PlotOhlcTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotOhlcTooltipPositionOptions {
        /**
