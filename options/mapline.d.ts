...
declare module "../highcharts" {
     ...
     *
     */
    interface SeriesMaplineOptions extends Highcharts.PlotMaplineOptions, Highcharts.SeriesOptions {
        /**
         * (Highmaps) An array of data points for the series. For the `mapline`
         * series type, points can be given in the following ways:
         *
         ...
         */
        data?: Array<(number|[string, (number|null)]|null|Highcharts.SeriesMaplineDataOptions)>;
        /**
