...
declare module "../highcharts.src" {
     ...
     */
    interface PlotColumnpyramidAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotColumnpyramidDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotColumnpyramidDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotColumnpyramidLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotColumnpyramidOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotColumnpyramidOnPointPositionOptions {
        /**
    ...
    interface PlotColumnpyramidOptions {
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotColumnpyramidDataSortingOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotColumnpyramidStatesHoverAnimationOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotColumnpyramidStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotColumnpyramidTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * tooltip.
     */
    interface PlotColumnpyramidTooltipHeaderOptions {
        /**
