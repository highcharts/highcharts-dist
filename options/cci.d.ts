...
declare module "../highcharts" {
     ...
     */
    interface PlotCciAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotCciDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotCciDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotCciDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotCciDataSortingOptions {
        /**
     ...
     */
    interface PlotCciLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotCciMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotCciMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotCciOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotCciOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotCciOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotCciOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotCciOnPointPositionOptions {
        /**
    ...
    interface PlotCciOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotCciDataLabelsOptions|Array<Highcharts.PlotCciDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotCciDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotCciOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotCciParamsOptions;
        /**
     ...
     */
    interface PlotCciParamsOptions {
        index?: string;
        /**
     ...
     * line-type series.
     */
    interface PlotCciStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotCciStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotCciStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotCciTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotCciTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotCciTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesCciOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesCciOptions {
     * customProperty: string; }
     *
     */
    interface SeriesCciOptions extends Highcharts.PlotCciOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
