...
declare module "../highcharts.src" {
     ...
     */
    interface PlotGeoheatmapAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotGeoheatmapDataLabelsOptions {
        /**
         ...
         */
        animation?: (boolean|Highcharts.PlotGeoheatmapDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotGeoheatmapTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     *
     * You have to extend the `SeriesGeoheatmapOptions` via an interface to
     * allow custom properties: ``` declare interface SeriesGeoheatmapOptions {
     * customProperty: string; }
     *
     */
    interface SeriesGeoheatmapOptions extends Highcharts.PlotGeoheatmapOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
         ...
         * `geoheatmap` series type, points can be given in the following ways:
         *
