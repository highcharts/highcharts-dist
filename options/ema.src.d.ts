...
declare module "../highcharts.src" {
     ...
     */
    interface PlotEmaAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotEmaDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotEmaDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotEmaLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotEmaMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotEmaMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotEmaOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotEmaOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotEmaOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
    ...
    interface PlotEmaOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotEmaDataLabelsOptions|Array<Highcharts.PlotEmaDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotEmaDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotEmaOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotEmaParamsOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotEmaStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotEmaStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotEmaTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotEmaTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotEmaTooltipPositionOptions {
        /**
