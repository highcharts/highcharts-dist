...
declare module "../highcharts" {
     ...
     */
    interface PlotTreemapAccessibilityPointOptions {
        /**
    ...
    interface PlotTreemapBreadcrumbsButtonThemeStyleOptions {
        color?: string;
    }
     ...
     */
    interface PlotTreemapBreadcrumbsOptions {
        /**
         ...
         * states.
         */
        buttonTheme?: (Highcharts.PlotTreemapBreadcrumbsButtonThemeOptions|Highcharts.SVGAttributes);
        events?: Highcharts.PlotTreemapBreadcrumbsEventsOptions;
        /**
         ...
         */
        position?: (Highcharts.BreadcrumbsAlignOptions|Highcharts.PlotTreemapBreadcrumbsPositionOptions);
        /**
         ...
         */
        separator?: Highcharts.PlotTreemapBreadcrumbsSeparatorOptions;
        /**
     ...
     * (Highcharts) Options object for Breadcrumbs separator.
     */
    interface PlotTreemapBreadcrumbsSeparatorOptions {
        /**
         ...
         */
        style?: (Highcharts.CSSObject|Highcharts.PlotTreemapBreadcrumbsSeparatorStyleOptions);
        text?: string;
    }
    /**
     * (Highcharts) CSS styles for the breadcrumbs separator.
    ...
    interface PlotTreemapClusterLayoutAlgorithmOptions {
        distance?: number;
        gridSize?: number;
     ...
     */
    interface PlotTreemapClusterOptions {
        /**
         * (Highcharts) An additional, individual class name for the grouped
         ...
         */
        enabled?: boolean;
        layoutAlgorithm?: Highcharts.PlotTreemapClusterLayoutAlgorithmOptions;
        marker?: Highcharts.PlotTreemapClusterMarkerOptions;
        /**
         * (Highcharts) Defines the minimum number of child nodes required to
         * create a group of small nodes.
         */
        minimumClusterSize?: number;
        /**
         * (Highcharts) The name of the point of grouped nodes shown in the
         * tooltip, dataLabels, etc. By default it is set to '+ n', where n is
         * number of grouped points.
         */
        name?: string;
        /**
         * (Highcharts) The pixel threshold height of area, which is used in
         * Treemap grouping.
         */
        pixelHeight?: number;
        /**
         * (Highcharts) The pixel threshold width of area, which is used in
         * Treemap grouping.
         */
        pixelWidth?: number;
        /**
         * (Highcharts) A configuration property that specifies the factor by
         * which the value and size of a grouped node are reduced. This can be
         * particularly useful when a grouped node occupies a disproportionately
         * large portion of the graph, ensuring better visual balance and
         * readability.
         */
    ...
    interface PlotTreemapDataLabelsOptions {
        ...
        /**
         * (Highcharts, Highstock, Highmaps, Gantt) Whether the data label
         * should act as a group-level header. For leaf nodes, headers are not
         * supported and the data label will be rendered inside.
         */
        headers?: boolean;
        /**
         ...
         */
        style?: (Highcharts.CSSObject|Highcharts.PlotTreemapDataLabelsStyleOptions);
        /**
     ...
     */
    interface PlotTreemapLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
    ...
    interface PlotTreemapLevelsDataLabelsOptions {
         ...
         * header. For leaf nodes, headers are not supported and the data label
     ...
     * inside long words.
     */
    interface PlotTreemapLevelsDataLabelsStyleOptions {
        textOverflow?: string;
    }
    /**
    ...
    interface PlotTreemapOptions {
        ...
        /**
         * (Highcharts) The color of the border surrounding each tree map item.
         */
        borderColor?: Highcharts.ColorString;
        /**
        ...
        borderRadius?: number;
        /**
         * (Highcharts) The width of the border surrounding each tree map item.
         */
        borderWidth?: number;
        /**
         * (Highcharts) Options for the breadcrumbs, the navigation at the top
         ...
         * @deprecated 9.3.3
         */
        traverseUpButton?: Highcharts.PlotTreemapTraverseUpButtonOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotTreemapStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotTreemapStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotTreemapStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotTreemapTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * a split tooltip.
     */
    interface PlotTreemapTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotTreemapTooltipPositionOptions {
        /**
     ...
     * @deprecated 9.3.3
     */
    interface PlotTreemapTraverseUpButtonOptions {
        /**
         * (Highcharts) The position of the button.
         *
         * @deprecated 9.3.3
         */
        position?: Highcharts.PlotTreemapTraverseUpButtonPositionOptions;
    }
    /**
     * (Highcharts) The position of the button.
     *
     * @deprecated 9.3.3
     */
    interface PlotTreemapTraverseUpButtonPositionOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesTreemapDataDataLabelsAnimationOptions {
        /**
     ...
     */
    interface SeriesTreemapDataMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highmaps) Animation when hovering over the marker.
     */
    interface SeriesTreemapDataMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
