...
declare module "../highcharts" {
     ...
     */
    interface PlotTrendlineAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotTrendlineDataLabelsOptions {
        /**
         ...
         */
        animation?: (boolean|Highcharts.PlotTrendlineDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotTrendlineLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotTrendlineOnPointOptions {
        /**
         ...
         */
        connectorOptions?: (Highcharts.PlotTrendlineOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
     ...
     */
    interface PlotTrendlineOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotTrendlineDataLabelsOptions|Array<Highcharts.PlotTrendlineDataLabelsOptions>);
        /**
         ...
         */
        dataSorting?: Highcharts.PlotTrendlineDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotTrendlineOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotTrendlineParamsOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotTrendlineStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotTrendlineTooltipHeaderOptions {
        /**
