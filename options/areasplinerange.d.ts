...
declare module "../highcharts" {
     ...
     */
    interface PlotAreasplinerangeAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotAreasplinerangeDataSortingOptions {
        /**
     ...
     */
    interface PlotAreasplinerangeLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotAreasplinerangeLowMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface PlotAreasplinerangeLowMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts, Highstock) Animation when hovering over the marker.
     ...
     * (Highcharts, Highstock) Animation when hovering over the marker.
     */
    interface PlotAreasplinerangeMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotAreasplinerangeOnPointOptions {
        /**
         * (Highcharts, Highstock) Options for the connector in the _Series on
         * point_ feature.
         *
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotAreasplinerangeOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotAreasplinerangeOnPointPositionOptions);
    }
    /**
     ...
     */
    interface PlotAreasplinerangeOptions {
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotAreasplinerangeDataSortingOptions;
        /**
         ...
         * arearange-like series. When `lowMarker` is not defined, options
         * inherit from the marker.
         */
         ...
         */
        onPoint?: (object|Highcharts.PlotAreasplinerangeOnPointOptions);
        /**
     ...
     * line-type series.
     */
    interface PlotAreasplinerangeStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotAreasplinerangeTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     * tooltip.
     */
    interface PlotAreasplinerangeTooltipHeaderOptions {
        /**
