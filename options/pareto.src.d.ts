...
declare module "../highcharts.src" {
     ...
     */
    interface PlotParetoAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotParetoDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotParetoDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotParetoLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotParetoMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highcharts) Animation when hovering over the marker.
     */
    interface PlotParetoMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotParetoOnPointConnectorOptions {
        /**
     ...
     * series in the _Series on point_ feature.
     */
    interface PlotParetoOnPointPositionOptions {
        /**
    ...
    interface PlotParetoOptions {
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotParetoDataSortingOptions;
        /**
     ...
     * line-type series.
     */
    interface PlotParetoStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotParetoStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotParetoStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotParetoTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotParetoTooltipHeaderOptions {
        /**
     ...
     * - `defer`: The animation delay time in milliseconds.
     */
    interface SeriesParetoDataDataLabelsAnimationOptions {
        /**
     ...
     * line-type series.
     */
    interface SeriesParetoDataStatesHoverAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * (Highcharts, Highstock) Animation when not hovering over the marker.
     */
    interface SeriesParetoDataStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface SeriesParetoDataStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
