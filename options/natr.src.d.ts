...
declare module "../highcharts.src" {
     ...
     */
    interface PlotNatrAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotNatrDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotNatrDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotNatrDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotNatrDataSortingOptions {
        /**
     ...
     */
    interface PlotNatrLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotNatrMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotNatrMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotNatrOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotNatrOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotNatrOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotNatrOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotNatrOnPointPositionOptions {
        /**
    ...
    interface PlotNatrOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotNatrDataLabelsOptions|Array<Highcharts.PlotNatrDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotNatrDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotNatrOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotNatrParamsOptions;
        /**
     ...
     */
    interface PlotNatrParamsOptions {
        index?: string;
        /**
     ...
     * line-type series.
     */
    interface PlotNatrStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotNatrStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotNatrStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotNatrTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotNatrTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotNatrTooltipPositionOptions {
        /**
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesNatrOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesNatrOptions {
     * customProperty: string; }
     *
     */
    interface SeriesNatrOptions extends Highcharts.PlotNatrOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
