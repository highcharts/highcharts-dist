...
declare module "../highcharts" {
     ...
     */
    interface PlotApoAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotApoDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotApoDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotApoDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotApoDataSortingOptions {
        /**
     ...
     */
    interface PlotApoLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotApoMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotApoMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotApoOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotApoOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotApoOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotApoOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotApoOnPointPositionOptions {
        /**
    ...
    interface PlotApoOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotApoDataLabelsOptions|Array<Highcharts.PlotApoDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotApoDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotApoOnPointOptions);
        /**
        ...
        opacity?: number;
        /**
         * (Highstock) Parameters used in calculation of Absolute Price
         * Oscillator series points.
         */
        params?: Highcharts.PlotApoParamsOptions;
        /**
     ...
     * series points.
     */
    interface PlotApoParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotApoStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotApoStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotApoStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotApoTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotApoTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotApoTooltipPositionOptions {
        /**
    ...
    /**
     * (Highstock) An `Absolute Price Oscillator` series. If the type option is
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesApoOptions` via an interface to allow
     * custom properties: ``` declare interface SeriesApoOptions {
     * customProperty: string; }
     *
     */
    interface SeriesApoOptions extends Highcharts.PlotApoOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
