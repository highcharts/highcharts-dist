...
declare module "../highcharts.src" {
     ...
     * (Highcharts) Animation when hovering over the marker.
     */
    interface PlotBellcurveMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
    ...
    interface PlotBellcurveOptions {
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotBellcurveDataSortingOptions;
        /**
     ...
     */
    interface PlotBellcurveStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotBellcurveTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotBellcurveTooltipPositionOptions {
        /**
