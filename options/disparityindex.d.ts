...
declare module "../highcharts" {
     ...
     */
    interface PlotDisparityindexAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotDisparityindexDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotDisparityindexDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotDisparityindexDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotDisparityindexDataSortingOptions {
        /**
     ...
     */
    interface PlotDisparityindexLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotDisparityindexMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotDisparityindexMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotDisparityindexOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotDisparityindexOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotDisparityindexOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotDisparityindexOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotDisparityindexOnPointPositionOptions {
        /**
     ...
     */
    interface PlotDisparityindexOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotDisparityindexDataLabelsOptions|Array<Highcharts.PlotDisparityindexDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotDisparityindexDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotDisparityindexOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotDisparityindexParamsOptions;
        /**
     ...
     */
    interface PlotDisparityindexParamsOptions {
        /**
         * (Highstock) The average used to calculate the Disparity Index
         * indicator. By default it uses SMA, with EMA as an option. To use
         * other averages, e.g. TEMA, the `stock/indicators/tema.js` file needs
         * to be loaded.
         *
         * If value is different than `ema`, `dema`, `tema` or `wma`, then sma
         * is used.
         */
        average?: string;
        /**
     ...
     * line-type series.
     */
    interface PlotDisparityindexStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotDisparityindexStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotDisparityindexStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotDisparityindexTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotDisparityindexTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotDisparityindexTooltipPositionOptions {
        /**
    ...
    /**
     * (Highstock) The Disparity Index indicator series. If the type option is
     ...
     * SeriesDisparityindexOptions { customProperty: string; }
     *
     */
    interface SeriesDisparityindexOptions extends Highcharts.PlotDisparityindexOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
