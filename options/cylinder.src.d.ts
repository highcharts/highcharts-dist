...
declare module "../highcharts.src" {
     ...
     */
    interface PlotCylinderAccessibilityPointOptions {
        /**
     ...
     * (see example).
     */
    interface PlotCylinderDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotCylinderDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotCylinderLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotCylinderOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotCylinderOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotCylinderOnPointPositionOptions);
    }
    /**
     * (Highcharts) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
    ...
    interface PlotCylinderOptions {
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotCylinderDataLabelsOptions|Array<Highcharts.PlotCylinderDataLabelsOptions>);
        /**
         ...
         */
        onPoint?: (object|Highcharts.PlotCylinderOnPointOptions);
        /**
     ...
     * line-type series.
     */
    interface PlotCylinderStatesHoverAnimationOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotCylinderStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotCylinderTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotCylinderTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotCylinderTooltipPositionOptions {
        /**
