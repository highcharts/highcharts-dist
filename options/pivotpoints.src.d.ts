...
declare module "../highcharts.src" {
     ...
     */
    interface PlotPivotpointsAccessibilityPointOptions {
        /**
     ...
     */
    interface PlotPivotpointsDataLabelsAnimationOptions {
        /**
     ...
     * (see example).
     */
    interface PlotPivotpointsDataLabelsOptions {
        /**
         ...
         * - `defer`: The animation delay time in milliseconds.
         */
        animation?: (boolean|Highcharts.PlotPivotpointsDataLabelsAnimationOptions|Partial<Highcharts.AnimationOptionsObject>);
        /**
     ...
     */
    interface PlotPivotpointsDataSortingOptions {
        /**
     ...
     */
    interface PlotPivotpointsLabelStyleOptions {
        fontSize?: number;
        fontWeight?: string;
    }
    /**
     ...
     */
    interface PlotPivotpointsMarkerStatesHoverAnimationOptions {
        duration?: number;
    }
    /**
     * (Highstock) Animation when hovering over the marker.
     */
    interface PlotPivotpointsMarkerStatesSelectAnimationOptions {
        duration?: number;
    }
    /**
     ...
     */
    interface PlotPivotpointsOnPointConnectorOptions {
        /**
     ...
     */
    interface PlotPivotpointsOnPointOptions {
        /**
         ...
         * `.highcharts-connector-seriesonpoint` class name.
         */
        connectorOptions?: (Highcharts.PlotPivotpointsOnPointConnectorOptions|Highcharts.SVGAttributes);
        /**
         ...
         */
        position?: (object|Highcharts.PlotPivotpointsOnPointPositionOptions);
    }
    /**
     * (Highstock) Options allowing to set a position and an offset of the
     * series in the _Series on point_ feature.
     */
    interface PlotPivotpointsOnPointPositionOptions {
        /**
     ...
     */
    interface PlotPivotpointsOptions {
        /**
         ...
         * (see example).
         */
        dataLabels?: (Highcharts.PlotPivotpointsDataLabelsOptions|Array<Highcharts.PlotPivotpointsDataLabelsOptions>);
        /**
         ...
         * (Highcharts, Highstock) Options for series data sorting.
         */
        dataSorting?: Highcharts.PlotPivotpointsDataSortingOptions;
        /**
         ...
         * `sunburst` series are supported at this moment.
         */
        onPoint?: (object|Highcharts.PlotPivotpointsOnPointOptions);
        /**
         ...
         * points.
         */
        params?: Highcharts.PlotPivotpointsParamsOptions;
        /**
     ...
     */
    interface PlotPivotpointsParamsOptions {
        /**
     ...
     * line-type series.
     */
    interface PlotPivotpointsStatesHoverAnimationOptions {
        /**
     ...
     */
    interface PlotPivotpointsStatesInactiveAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     * line-type series.
     */
    interface PlotPivotpointsStatesSelectAnimationOptions {
        /**
         * (Highcharts, Highstock) The duration of the hover animation in
         * milliseconds. By default the hover state animates quickly in, and
         * slowly back to normal.
     ...
     */
    interface PlotPivotpointsTooltipDateTimeLabelFormatsOptions {
        day?: string;
        hour?: string;
        millisecond?: string;
        minute?: string;
     ...
     */
    interface PlotPivotpointsTooltipHeaderOptions {
        /**
     ...
     */
    interface PlotPivotpointsTooltipPositionOptions {
        /**
    ...
    /**
     * (Highstock) A pivot points indicator. If the type option is not
     ...
     * documentation for example)
     *
     * You have to extend the `SeriesPivotpointsOptions` via an interface to
     * allow custom properties: ``` declare interface SeriesPivotpointsOptions {
     * customProperty: string; }
     *
     */
    interface SeriesPivotpointsOptions extends Highcharts.PlotPivotpointsOptions, Highcharts.SeriesOptions {
        /**
         * Not available
         */
        allAreas?: undefined;
