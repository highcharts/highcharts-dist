 ...
 */
export type ExportingMimeTypeValue = 'image/png' | 'image/jpeg' | 'application/pdf' | 'image/svg+xml';
export type ExportingMenuItemDefinitionsOptions = Record<string, Exporting.MenuObject> & ExportMenuItemDefinitionsDefaults;
