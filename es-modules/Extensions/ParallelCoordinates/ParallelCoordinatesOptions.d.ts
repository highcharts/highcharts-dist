...
interface ParallelAxesOptions extends DeepPartial<Omit<AxisOptions, 'alternateGridColor' | 'breaks' | 'id' | 'gridLineColor' | 'gridLineDashStyle' | 'gridLineWidth' | 'minorGridLineColor' | 'minorGridLineDashStyle' | 'minorGridLineWidth' | 'plotBands' | 'plotLines' | 'angle' | 'gridLineInterpolation' | 'maxColor' | 'maxZoom' | 'minColor' | 'scrollbar' | 'stackLabels' | 'stops'>> {
    /**
     * @default 1
     */
