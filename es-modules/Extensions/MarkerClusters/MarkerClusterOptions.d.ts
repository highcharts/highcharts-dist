...
import type { PointClickEvent, PointMarkerOptions, PointMarkerStateHoverOptions, PointMarkerStatesOptions } from '../../Core/Series/PointOptions';
...
export interface MarkerClusterStatesOptions extends PointMarkerStatesOptions<MarkerClusterOptions> {
    hover?: MarkerClusterStateHoverOptions & StateGenericOptions<MarkerClusterOptions>;
}
