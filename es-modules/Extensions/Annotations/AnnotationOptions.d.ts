...
import type { DataLabelsOverflowValue } from '../../Core/Series/DataLabelOptions';
 ...
 * @requires modules/annotations
 */
export type AnnotationMockPointOptions = (string | AnnotationMockPointOptionsObject | AnnotationMockPointFunction);
/**
...
export interface AnnotationMockPointFunction {
    (controllable: Controllable): AnnotationMockPointOptionsObject | Point;
}
