...
import type { RangeSelectorButtonOptions } from '../../Stock/RangeSelector/RangeSelectorOptions';
...
export type AxisLabelFormatterCallback = FormatterCallback<AxisLabelFormatterContextObject, AxisLabelFormatterContextObject>;
...
export interface AxisTickPositionerCallback {
    (this: Axis, min: number, max: number, ctx?: Axis): (TickPositionsArray | undefined);
}
