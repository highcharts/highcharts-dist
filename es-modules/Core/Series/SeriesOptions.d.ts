...
import type { StateGenericOptions, StateHoverOptions, StateInactiveOptions, StateNormalOptions, StateSelectOptions, StatesOptions } from './StatesOptions';
...
export type NonPlotOptions = ('data' | 'id' | 'index' | 'legendIndex' | 'mapData' | 'name' | 'stack' | 'treemap' | 'type' | 'xAxis' | 'yAxis' | 'zIndex');
export type PlotOptionsOf<T extends Series = Series> = (Omit<T['options'], NonPlotOptions>);
/**
 ...
 *        arrow functions.
 */
export type SeriesAfterAnimateCallbackFunction = EventCallback<Series, SeriesAfterAnimateEventObject>;
/**
 ...
 *        arrow functions.
 */
export type SeriesClickCallbackFunction = EventCallback<Series, SeriesClickEventObject>;
/**
 ...
 *        arrow functions.
 */
export type SeriesMouseOutCallbackFunction = EventCallback<Series, PointerEvent>;
/**
 ...
 *        arrow functions.
 */
export type SeriesMouseOverCallbackFunction = EventCallback<Series, PointerEvent>;
/**
