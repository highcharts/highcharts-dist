import type { AxisOptions, YAxisOptions } from '../../Core/Axis/AxisOptions';
...
import type { SeriesTypeOptions, SeriesTypePlotOptions } from '../../Core/Series/SeriesType';
type NavigatorSeriesOptions<T extends keyof SeriesTypePlotOptions = 'areaspline'> = SeriesTypeOptions & NonNullable<SeriesTypePlotOptions[T]>;
