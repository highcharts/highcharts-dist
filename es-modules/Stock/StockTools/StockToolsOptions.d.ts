import type { LangNavigationOptions } from '../../Extensions/Annotations/NavigationBindingsOptions';
/**
...
export interface StockToolsGuiDefinitionsOptions {
    [key: string]: (StockToolsGuiDefinitionsButtonOptions | StockToolsGuiDefinitionsButtonsOptions);
