...
arguments,c=this;b.isParentLoaded(f,"ema",c.type,function(b){b.prototype.init.apply(c,a)})},getValues:function(a,b){var d=b.periods,c=b.index;b=[];var h=[],k=[],e;if(2!==d.length||d[1]<=d[0])g('Error: "APO requires two periods. Notice, first period should be lower than the second one."');else{var l=f.prototype.getValues.call(this,a,{index:c,period:d[0]});a=f.prototype.getValues.call(this,a,{index:c,period:d[1]});if(l&&a){d=d[1]-d[0];for(e=0;e<a.yData.length;e++)c=l.yData[e+d]-a.yData[e],b.push([a.xData[e],
c]),h.push(a.xData[e]),k.push(c);return{values:b,xData:h,yData:k}}}}});""});b(a,"masters/indicators/apo.src.js",[],function(){})});
