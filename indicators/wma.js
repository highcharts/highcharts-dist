...
(c+1)/2;return a.reduce(function(a,k,c){return[null,a[1]+k[1]*(c+1)]})[1]/c}function h(a,c,e,b){e=g(a,a.length);c=c[b-1];a.shift();return[c,e]}var q=b.isArray;a=a.seriesType;a("wma","sma",{params:{index:3,period:9}},{getValues:function(a,c){var e=c.period,b=a.xData,g=(a=a.yData)?a.length:0,d=1,k=b[0],p=a[0],l=[],m=[],n=[],f=-1;if(!(b.length<e)){q(a[0])&&(f=c.index,p=a[0][f]);for(c=[[k,p]];d!==e;)c.push([b[d],0>f?a[d]:a[d][f]]),d++;for(e=d;e<g;e++)d=h(c,b,a,e),l.push(d),m.push(d[0]),n.push(d[1]),c.push([b[e],
0>f?a[e]:a[e][f]]);d=h(c,b,a,e);l.push(d);m.push(d[0]);n.push(d[1]);return{values:l,xData:m,yData:n}}}});""});b(a,"masters/indicators/wma.src.js",[],function(){})});
