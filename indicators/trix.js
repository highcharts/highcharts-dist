...
function(b){b.prototype.init.apply(d,a)})},getTemaPoint:function(a,b,e,c){if(c>b)var d=[a[c-3],0!==e.prevLevel3?f(e.level3-e.prevLevel3)/e.prevLevel3*100:null];return d}})});b(a,"masters/indicators/trix.src.js",[],function(){})});
