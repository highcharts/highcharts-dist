...
(function (A11yI18nComposition) {
    ...
    function formatExtendedStatement(statement, ctx) {
        ...
        if (eachStart > -1) {
            ...
            result = '';
            arr = (0,external_highcharts_src_js_default_namespaceObject.getNestedProperty)(eachArguments[0], ctx);
            if (arr) {
        ...
        if (indexStart > -1) {
            ...
            let val;
            arr = (0,external_highcharts_src_js_default_namespaceObject.getNestedProperty)(arrayName, ctx);
            if (!isNaN(ix) && arr) {
                if (ix < 0) {
...
function fireEventOnWrappedOrUnwrappedElement(el, eventObject) {
    ...
    if (!!ChartUtilities_doc?.createEvent &&
        ...
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(el, type, eventObject);
    }
    else if (el.element) {
...
function getSeriesFirstPointElement(series) {
    if (series.points && series.points.length) {
        const firstPointWithGraphic = (0,external_highcharts_src_js_default_namespaceObject.find)(series.points, (p) => !!p.graphic);
...
function getPointFromXY(series, x, y) {
    ...
    while (i--) {
        res = (0,external_highcharts_src_js_default_namespaceObject.find)(series[i].points || [], function (p) {
            return p.x === x && p.y === y;
        });
        if (res) {
            return res;
...
function scrollAxisToPoint(point) {
    ...
    if (scrollbar && (0,external_highcharts_src_js_default_namespaceObject.defined)(scrollbar.to) && (0,external_highcharts_src_js_default_namespaceObject.defined)(scrollbar.from)) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(scrollbar, 'changed', {
            from: scrollbar.from,
            to: scrollbar.to,
            trigger: 'scrollbar',
            DOMEvent: null
...
class KeyboardNavigationHandler {
    ...
    run(e) {
        ...
        const handlerCodeSet = (0,external_highcharts_src_js_default_namespaceObject.find)(this.keyCodeMap, function (codeSet) {
    ...
    function chartSetFocusToElement(svgElement, focusElement) {
        ...
        if (browserFocusElement &&
            ...
            if (!(browserFocusElement.hcEvents &&
                ...
                (0,external_highcharts_src_js_default_namespaceObject.addEvent)(browserFocusElement, 'focusin', function () { });
            }
            browserFocusElement.focus();
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(this, 'endResize', function () {
...
class Announcer {
    ...
    announce(message) {
        ...
        if (this.clearAnnouncementRegionTimer) {
            (0,external_highcharts_src_js_default_namespaceObject.internalClearTimeout)(this.clearAnnouncementRegionTimer);
        }
    ...
    addAnnounceRegion(type) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.attr)(div, {
            'aria-hidden': false,
            'aria-live': type,
            'aria-atomic': true
        });
    ...
    createAnnouncerContainer() {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.attr)(container, {
            'aria-hidden': false,
...
class InfoRegionsComponent extends Accessibility_AccessibilityComponent {
    ...
    setScreenReaderSectionAttribs(sectionDiv, regionKey) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.attr)(sectionDiv, {
            id: sectionId,
...
class MenuComponent extends Accessibility_AccessibilityComponent {
    ...
    addAccessibleContextMenuAttribs() {
        ...
        if (exportList && exportList.length) {
            ...
            if (parentDiv) {
                (0,external_highcharts_src_js_default_namespaceObject.attr)(parentDiv, {
                    'aria-hidden': void 0,
...
class KeyboardNavigation {
    ...
    removeExitAnchor() {
        ...
        if (this.exitAnchor) {
            ...
            if (el && (0,external_highcharts_src_js_default_namespaceObject.defined)(el.remover)) {
...
(function (KeyboardNavigation) {
    ...
    function compose(ChartClass) {
        ...
        if (!chartProto.dismissPopupContent) {
            ...
            if (KeyboardNavigation_doc) {
                (0,external_highcharts_src_js_default_namespaceObject.addEvent)(KeyboardNavigation_doc, 'keydown', documentOnKeydown);
            }
        }
        return ChartClass;
    }
    ...
    function chartDismissPopupContent() {
        const chart = this;
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(this, 'dismissPopupContent', {}, function () {
            if (chart.tooltip) {
...
function setLegendItemHoverState(hoverActive, item) {
    ...
    for (const key of ['group', 'label', 'symbol']) {
        ...
        if (element) {
            (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(element, hoverActive ? 'mouseover' : 'mouseout');
        }
    }
}
/* *
        ...
        this.addEvent((external_highcharts_src_js_default_Legend_default()), 'afterRender', function () {
            if (this.chart === component.chart &&
                ...
                (0,external_highcharts_src_js_default_namespaceObject.syncTimeout)(() => component.proxyProvider
                    .updateGroupProxyElementPositions('legend'), animObject((0,external_highcharts_src_js_default_namespaceObject.pick)(this.chart.renderer.globalAnimation, true)).duration);
            }
        });
    }
    /**
...
(function (LegendComponent) {
    ...
    function chartHighlightLegendItem(ix) {
        ...
        if (itemToHighlight) {
            if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(oldIx) && items[oldIx]) {
    ...
    function compose(ChartClass, LegendClass) {
        ...
        if (!chartProto.highlightLegendItem) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(LegendClass, 'afterColorizeItem', legendOnAfterColorizeItem);
        }
    }
...
function navigatorHandle(_x, _y, width, height, options = {}) {
    const halfWidth = options.width ? options.width / 2 : width, markerPosition = 1.5, r = (0,external_highcharts_src_js_default_namespaceObject.relativeLength)(options.borderRadius || 0, Math.min(halfWidth * 2, height));
...
function NavigatorComposition_compose(ChartClass, AxisClass, SeriesClass) {
    ...
    if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(composed, 'Navigator')) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.extend)(defaultOptions, { navigator: Navigator_NavigatorDefaults });
...
class NavigatorComponent extends Accessibility_AccessibilityComponent {
    ...
    init() {
        ...
        this.addEvent(Navigator_Navigator, 'afterRender', function () {
            if (this.chart === component.chart &&
                ...
                }, NavigatorComponent_animObject((0,external_highcharts_src_js_default_namespaceObject.pick)(this.chart.renderer.globalAnimation, true)).duration);
            }
        });
    }
    /**
                    ...
                    function (keyCode) {
                        if (proxyEl) {
                            const delta = keyCode === keys.left ||
                                keyCode === keys.up ? -1 : 1;
                            proxyEl.value = '' + (0,external_highcharts_src_js_default_namespaceObject.clamp)(parseFloat(proxyEl.value) + delta, 0, 100);
    ...
    destroy() {
        if (this.updateNavigatorThrottleTimer) {
            (0,external_highcharts_src_js_default_namespaceObject.internalClearTimeout)(this.updateNavigatorThrottleTimer);
        }
        this.proxyProvider.removeGroup('navigator');
        if (this.announcer) {
            this.announcer.destroy();
...
function findFirstPointWithGraphic(point) {
    ...
    return (0,external_highcharts_src_js_default_namespaceObject.find)(point.series.data, function (p) {
        return !!(p &&
...
function setPointScreenReaderAttribs(point, pointElement) {
    const series = point.series, seriesPointA11yOptions = series.options.accessibility?.point || {}, a11yPointOptions = series.chart.options.accessibility.point || {}, label = SeriesDescriber_stripHTMLTags(((0,external_highcharts_src_js_default_namespaceObject.isString)(seriesPointA11yOptions.descriptionFormat) &&
        ...
        ((0,external_highcharts_src_js_default_namespaceObject.isString)(a11yPointOptions.descriptionFormat) &&
...
class NewDataAnnouncer {
    ...
    onSeriesAdded(series) {
        if (chartHasAnnounceEnabled(this.chart)) {
            ...
            this.dirty.newSeries = (0,external_highcharts_src_js_default_namespaceObject.defined)(this.dirty.newSeries) ?
                void 0 : series;
        }
    }
    /**
        ...
        if (annOptions.enabled) {
            ...
            if (message) {
                ...
                if (this.queuedAnnouncement) {
                    (0,external_highcharts_src_js_default_namespaceObject.internalClearTimeout)(this.queuedAnnouncementTimer);
                }
...
(function (NewDataAnnouncer) {
    ...
    function compose(SeriesClass) {
        if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(NewDataAnnouncer_composed, 'A11y.NDA')) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'updatedData', seriesOnUpdatedData);
        }
    }
    ...
    function seriesOnAddPoint(e) {
        ...
        if (newDataAnnouncer &&
            ...
            newDataAnnouncer.dirty.newPoint = ((0,external_highcharts_src_js_default_namespaceObject.defined)(newDataAnnouncer.dirty.newPoint) ?
                void 0 :
                e.point);
        }
    }
...
class ProxyElement {
    ...
    updateTarget(target, attributes) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.attr)(this.innerElement, (0,external_highcharts_src_js_default_namespaceObject.merge)(targetAriaLabel ? {
    ...
    refreshPosition() {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.css)(this.innerElement, {
...
class ProxyProvider {
    ...
    addGroup(groupKey, groupElementType = 'div', attributes) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.attr)(groupElement, attributes || {});
...
class RangeSelectorComponent extends Accessibility_AccessibilityComponent {
    ...
    setRangeInputAttrs(input, langKey) {
        const chart = this.chart;
        (0,external_highcharts_src_js_default_namespaceObject.attr)(input, {
            tabindex: -1,
    ...
    onInputNavInit(direction) {
        ...
        if (svgEl && minInput && maxInput) {
            ...
            const minRemover = (0,external_highcharts_src_js_default_namespaceObject.addEvent)(minInput, 'keydown', keydownHandler);
            const maxRemover = (0,external_highcharts_src_js_default_namespaceObject.addEvent)(maxInput, 'keydown', keydownHandler);
            this.removeInputKeydownHandler = () => {
                minRemover();
                maxRemover();
            };
    ...
    initDropdownNav() {
        ...
        if (rangeSelector && dropdown) {
            ...
            // automatically, so we manually catch and handle it when relevant.
            this.removeDropdownKeydownHandler = (0,external_highcharts_src_js_default_namespaceObject.addEvent)(dropdown, 'keydown', (e) => {
...
(function (RangeSelectorComponent) {
    ...
    function compose(ChartClass, RangeSelectorClass) {
        ...
        if (!chartProto.highlightRangeSelectorButton) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(RangeSelectorClass, 'afterBtnClick', rangeSelectorAfterBtnClick);
        }
    }
...
(function (ForcedMarkersComposition) {
    ...
    function compose(SeriesClass) {
        if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(ForcedMarkers_composed, 'A11y.FM')) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'render', seriesOnRender);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'afterRender', seriesOnAfterRender);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'renderCanvas', seriesOnRenderCanvas);
        }
    }
    ...
    function seriesOnRenderCanvas() {
        if (this.boosted && this.a11yMarkersForced) {
            (0,external_highcharts_src_js_default_namespaceObject.merge)(true, this.options, {
                marker: {
                    enabled: false
                }
            });
...
class SeriesKeyboardNavigation {
    ...
    onDrillupAll() {
        ...
        let point;
        if (last && series && (0,external_highcharts_src_js_default_namespaceObject.defined)(last.x) && (0,external_highcharts_src_js_default_namespaceObject.defined)(last.y)) {
                ...
                [
                    ...
                    function (keyCode, event) {
                        ...
                        if (point) {
                            ...
                            (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(point.series, 'click', event);
...
(function (SeriesKeyboardNavigation) {
    ...
    function chartHighlightAdjacentPointVertical(down) {
        ...
        if (!(0,external_highcharts_src_js_default_namespaceObject.defined)(curPoint.plotX) || !(0,external_highcharts_src_js_default_namespaceObject.defined)(curPoint.plotY)) {
            return false;
        }
        this.series.forEach((series) => {
            ...
            series.points.forEach((point) => {
                if (!(0,external_highcharts_src_js_default_namespaceObject.defined)(point.plotY) || !(0,external_highcharts_src_js_default_namespaceObject.defined)(point.plotX) ||
                    point === curPoint) {
                    return;
                }
    ...
    function getClosestPoint(point, series, xWeight, yWeight) {
        ...
        const hasUndefinedPosition = (point) => (!((0,external_highcharts_src_js_default_namespaceObject.defined)(point.plotX) && (0,external_highcharts_src_js_default_namespaceObject.defined)(point.plotY)));
        ...
        return (0,external_highcharts_src_js_default_namespaceObject.defined)(minIx) ? series.points[minIx] : void 0;
    }
    /**
...
function copyDeprecatedChartOptions(chart) {
    ...
    ['description', 'typeDescription'].forEach(function (prop) {
        if (chartOptions[prop]) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.error)(32, false, chart, { [`chart.${prop}`]: `use accessibility.${prop}` });
        }
    });
}
/**
...
class Accessibility {
    ...
    initComponents() {
        ...
        if (a11yOptions.customComponents) {
            (0,external_highcharts_src_js_default_namespaceObject.extend)(this.components, a11yOptions.customComponents);
        }
    ...
    update() {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'beforeA11yUpdate');
        ...
        this.getComponentOrder().forEach(function (componentName) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'afterA11yComponentUpdate', {
                name: componentName,
...
(function (Accessibility) {
    ...
    function compose(ChartClass, LegendClass, PointClass, SeriesClass, SVGElementClass, RangeSelectorClass) {
        ...
        if (!chartProto.updateA11yEnabled) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'destroy', chartOnDestroy);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'render', chartOnRender);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'update', chartOnUpdate);
            // Mark dirty for update
            ['addSeries', 'init'].forEach((event) => {
                (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, event, function () {
                    this.a11yDirty = true;
                });
            });
            // Direct updates (events happen after render)
            ['afterApplyDrilldown', 'drillupall'].forEach((event) => {
                (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, event, function chartOnAfterDrilldown() {
                    const a11y = this.accessibility;
                    if (a11y && !a11y.zombie) {
                        a11y.update();
                    }
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(PointClass, 'update', pointOnUpdate);
            // Mark dirty for update
            ['update', 'updatedData', 'remove'].forEach((event) => {
                (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, event, function () {
 ...
 * */
// Add default options
(0,external_highcharts_src_js_default_namespaceObject.merge)(true, Accessibility_defaultOptions, A11yDefaults, {
    accessibility: {
