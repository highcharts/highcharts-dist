...
class Exporting {
    ...
    getSVG(chartOptions, async) {
        ...
        const postprocessAndGetSVG = (chartCopy) => {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'getSVG', { chartCopy: chartCopy });
    ...
    applyShadowDOMStyles(chartCopy) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(chart, 'getSVG', () => {
    ...
    async localExport(exportingOptions, chartOptions) {
        ...
        const unbindGetSVG = (0,external_highcharts_src_js_default_namespaceObject.addEvent)(chart, 'getSVG', (e) => {
