...
class Fullscreen {
    ...
    static compose(ChartClass) {
        if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(composed, 'Fullscreen')) {
    ...
    close() {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'fullscreenClose', void 0, function () {
    ...
    open() {
        const fullscreen = this, chart = fullscreen.chart, optionsChart = chart.options.chart;
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'fullscreenOpen', void 0, function () {
            if (optionsChart) {
            ...
            if (fullscreen.browserProps) {
                const unbindChange = (0,external_highcharts_src_js_default_namespaceObject.addEvent)(chart.container.ownerDocument, // Chart's document
                ...
                const unbindDestroy = (0,external_highcharts_src_js_default_namespaceObject.addEvent)(chart, 'destroy', unbindChange);
...
class Exporting {
     ...
     */
    addButton(options) {
        const exporting = this, chart = exporting.chart, renderer = chart.renderer, btnOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(chart.options.navigation?.buttonOptions, options), onclick = btnOptions.onclick, menuItems = btnOptions.menuItems, symbolSize = btnOptions.symbolSize || 12;
        let symbol;
    ...
    afterPrint() {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'afterPrint');
    }
    /**
    ...
    beforePrint() {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'beforePrint');
    ...
    contextMenu(className, items, x, y, width, height, button) {
        ...
        if (!menu) {
            ...
            innerMenu = (0,external_highcharts_src_js_default_namespaceObject.createElement)('ul', { className: 'highcharts-menu' }, chart.styledMode ? {} : {
                listStyle: 'none',
                margin: 0,
                padding: 0
            }, menu);
            // Presentational CSS
            if (!chart.styledMode) {
                (0,external_highcharts_src_js_default_namespaceObject.css)(innerMenu, (0,external_highcharts_src_js_default_namespaceObject.extend)({
            ...
            exporting.events?.push((0,external_highcharts_src_js_default_namespaceObject.addEvent)(menu, 'mouseleave', function () {
                menu.hideTimer = Exporting_win.setTimeout(menu.hideMenu, 500);
            }), (0,external_highcharts_src_js_default_namespaceObject.addEvent)(menu, 'mouseenter', function () {
                (0,external_highcharts_src_js_default_namespaceObject.internalClearTimeout)(menu.hideTimer);
            }), 
            // Hide it on clicking or touching outside the menu (#2258,
            // #2335, #2407)
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(Exporting_doc, 'mouseup', function (e) {
                if (!chart.pointer?.inClass(e.target, className)) {
                    menu.hideMenu();
                }
            }), (0,external_highcharts_src_js_default_namespaceObject.addEvent)(menu, 'click', function () {
            ...
            items.forEach(function (item) {
                ...
                if ((0,external_highcharts_src_js_default_namespaceObject.isObject)(item, true)) {
                    let element;
                    if (item.separator) {
                        element = (0,external_highcharts_src_js_default_namespaceObject.createElement)('li', {
                        ...
                        if (!chart.styledMode) {
                            element.onmouseover = function () {
                                (0,external_highcharts_src_js_default_namespaceObject.css)(this, navOptions?.menuItemHoverStyle || {});
                            };
                            element.onmouseout = function () {
                                (0,external_highcharts_src_js_default_namespaceObject.css)(this, navOptions?.menuItemStyle || {});
                            };
                            (0,external_highcharts_src_js_default_namespaceObject.css)(element, (0,external_highcharts_src_js_default_namespaceObject.extend)({ cursor: 'pointer' }, navOptions?.menuItemStyle || {}));
                        }
                    }
    ...
    destroy(e) {
        ...
        divElements.forEach(function (elem, i) {
            if (elem) {
                ...
                (0,external_highcharts_src_js_default_namespaceObject.internalClearTimeout)(elem.hideTimer); // #5427
                (0,external_highcharts_src_js_default_namespaceObject.removeEvent)(elem, 'mouseleave');
                ...
                (0,external_highcharts_src_js_default_namespaceObject.discardElement)(elem);
            }
        });
    ...
    async downloadSVG(svg, exportingOptions) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(Exporting.prototype, 'downloadSVG', eventArgs);
    ...
    async exportChart(exportingOptions, chartOptions) {
        // Merge the options
        exportingOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(this.options, exportingOptions);
    ...
    async fallbackToServer(exportingOptions, err) {
        if (exportingOptions.fallbackToExportServer === false) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.error)(err.message, false);
        }
    }
    /**
    ...
    getChartHTML(applyStyleSheets) {
        ...
        chart.container.querySelectorAll('canvas').forEach(function (canvas) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.css)(imageElem.element, {
    ...
    getSVG(chartOptions, async) {
        ...
        options = (0,external_highcharts_src_js_default_namespaceObject.merge)(chart.options, chartOptions);
        // Use userOptions to make the options chain in series right (#3881)
        options.plotOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(chart.userOptions.plotOptions, chartOptions?.plotOptions);
        // ... and likewise with time, avoid that undefined time properties are
        // merged over legacy global time options
        options.time = (0,external_highcharts_src_js_default_namespaceObject.merge)(chart.userOptions.time, chartOptions?.time);
        // Create a sandbox where a new chart will be generated
        const sandbox = (0,external_highcharts_src_js_default_namespaceObject.createElement)('div', void 0, {
            position: 'absolute',
            top: '-9999em',
        ...
        (0,external_highcharts_src_js_default_namespaceObject.extend)(options.chart, {
            animation: false,
            renderTo: sandbox,
            forExport: true,
        ...
        chart.series.forEach(function (s) {
            seriesOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(s.userOptions, {
        ...
        chart.axes.forEach(function (axis) {
            ...
            if (!axis.userOptions.internalKey) { // #6444
                axis.userOptions.internalKey = (0,external_highcharts_src_js_default_namespaceObject.uniqueKey)();
            }
            if (options && !axis.options.isInternal) {
                ...
                options[axis.coll].push((0,external_highcharts_src_js_default_namespaceObject.merge)(axis.userOptions, {
        ...
        const postprocessAndGetSVG = (chartCopy) => {
            ...
            chart.axes.forEach(function (axis) {
                const axisCopy = (0,external_highcharts_src_js_default_namespaceObject.find)(chartCopy.axes, (copy) => copy.options.internalKey === axis.userOptions.internalKey);
                if (axisCopy) {
                    ...
                    exportOverride = (0,external_highcharts_src_js_default_namespaceObject.splat)(chartOptions?.[axis.coll] || {})[0], userMin = 'min' in exportOverride ?
                        exportOverride.min :
            ...
            (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'afterGetSVG', { chartCopy, svg });
            // Free up memory
            options = void 0;
            chartCopy.destroy();
            (0,external_highcharts_src_js_default_namespaceObject.discardElement)(sandbox);
            return svg;
        };
        ...
        return new Promise((resolve) => new chart.constructor(options || {}, function (e) {
            ...
            // chart copy (#24537)
            const unbindRender = (0,external_highcharts_src_js_default_namespaceObject.addEvent)(this, 'render', function () {
                unbindRender();
     ...
     * @requires modules/exporting
     */
    applyShadowDOMStyles(chartCopy) {
        // Get the original chart
        const chart = this.chart, shadowStyles = [];
        // Set the original chart's container as the first node
        let node = chart.container, rootNode;
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(chart, 'afterGetSVG', () => {
    ...
    async getSVGForExport(exportingOptions, chartOptions) {
        ...
        return await this.getSVG((0,external_highcharts_src_js_default_namespaceObject.merge)({ chart: { borderRadius: 0 } }, currentExportingOptions.chartOptions, chartOptions, {
            exporting: {
    ...
    inlineStyles() {
        ...
        // this body
        const iframe = (0,external_highcharts_src_js_default_namespaceObject.createElement)('iframe', void 0, {
            width: '1px',
            height: '1px',
            visibility: 'hidden'
        }, Exporting_doc.body);
    ...
    async localExport(exportingOptions, chartOptions) {
        ...
        // (#8273)
        const unbindGetSVG = (0,external_highcharts_src_js_default_namespaceObject.addEvent)(chart, 'afterGetSVG', (e) => {
        ...
        try {
            ...
            if (sanitizedSVG.indexOf('<foreignObject') > -1 &&
                ...
                await exporting.downloadSVG(sanitizedSVG, (0,external_highcharts_src_js_default_namespaceObject.extend)({ filename: exporting.getFilename() }, exportingOptions));
            }
    ...
    render() {
        ...
        if (isDirty && options.enabled !== false) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.objectEach)(options?.buttons, function (button) {
...
(function (Exporting) {
    ...
    function compose(ChartClass, SVGRendererClass) {
        ...
        if (!(0,external_highcharts_src_js_default_namespaceObject.pushUnique)(Exporting_composed, 'Exporting')) {
            return;
        }
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'layOutTitle', onChartLayOutTitle);
        if (Exporting_isSafari) {
    ...
    function chartCallback(chart) {
        ...
        if (exporting) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(chart, 'redraw', function () {
    ...
    function onChartLayOutTitle({ alignTo, key, textPxLength }) {
        const exportingOptions = this.options.exporting, { align, buttonSpacing = 0, verticalAlign, width = 0 } = (0,external_highcharts_src_js_default_namespaceObject.merge)(this.options.navigation?.buttonOptions, exportingOptions?.buttons?.contextButton), space = alignTo.width - textPxLength, widthAdjust = width + buttonSpacing;
