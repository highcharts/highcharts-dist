...
function average(arr) {
    ...
    if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(ret) && len) {
        ret = (0,external_highcharts_src_js_default_namespaceObject.correctFloat)(ret / len);
    }
    return ret;
}
/**
...
function high(arr) {
    return arr.length ?
        (0,external_highcharts_src_js_default_namespaceObject.arrayMax)(arr) :
        (arr.hasNulls ? null : void 0);
}
/**
...
function hlc(high, low, close) {
    ...
    if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(high) ||
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(low) ||
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(close)) {
        return [high, low, close];
    }
}
function low(arr) {
    return arr.length ?
        (0,external_highcharts_src_js_default_namespaceObject.arrayMin)(arr) :
        (arr.hasNulls ? null : void 0);
}
function ohlc(open, high, low, close) {
    ...
    low = DataGrouping_ApproximationRegistry.low(low);
    close = DataGrouping_ApproximationRegistry.close(close);
    if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(open) ||
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(high) ||
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(low) ||
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(close)) {
...
function range(low, high) {
    low = DataGrouping_ApproximationRegistry.low(low);
    high = DataGrouping_ApproximationRegistry.high(high);
    if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(low) || (0,external_highcharts_src_js_default_namespaceObject.isNumber)(high)) {
        return [low, high];
    }
...
(0,external_highcharts_src_js_default_namespaceObject.extend)(DataGrouping_ApproximationRegistry, ApproximationDefaults);
/** @internal */
...
function compose(AxisClass) {
    ...
    if (!axisProto.applyGrouping) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(AxisClass, 'postProcessData', applyGrouping);
        (0,external_highcharts_src_js_default_namespaceObject.extend)(axisProto, {
            applyGrouping,
            getGroupPixelWidth,
            setDataGrouping
        });
    ...
    if (this instanceof AxisConstructor) {
        ...
        this.chart.options.series.forEach(function (seriesOptions) {
            ...
            seriesOptions.dataGrouping = typeof dataGrouping === 'boolean' ?
                dataGrouping :
                (0,external_highcharts_src_js_default_namespaceObject.merge)(dataGrouping, seriesOptions.dataGrouping);
        });
    }
...
(function (DateTimeAxis) {
    ...
    class Additions {
        ...
        normalizeTimeTickInterval(tickInterval, unitsOption) {
            ...
            // Get the count
            const count = (0,external_highcharts_src_js_default_namespaceObject.normalizeTickInterval)(tickInterval / interval, multiples, unit[0] === 'year' ? // #1913, #2360
                Math.max((0,external_highcharts_src_js_default_namespaceObject.getMagnitude)(tickInterval / interval), 1) :
                1);
            return {
                unitRange: interval,
                count: count,
...
function adjustExtremes(xAxis, groupedXData) {
    ...
    if ((0,external_highcharts_src_js_default_namespaceObject.defined)(groupedXData[0]) &&
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(xAxis.min) &&
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(xAxis.dataMin) &&
        groupedXData[0] < xAxis.min) {
        if ((!(0,external_highcharts_src_js_default_namespaceObject.defined)(xAxis.options.min) &&
    ...
    if ((0,external_highcharts_src_js_default_namespaceObject.defined)(groupedXData[groupedXData.length - 1]) &&
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(xAxis.max) &&
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(xAxis.dataMax) &&
        groupedXData[groupedXData.length - 1] > xAxis.max) {
        if ((!(0,external_highcharts_src_js_default_namespaceObject.defined)(xAxis.options.max) &&
            (0,external_highcharts_src_js_default_namespaceObject.isNumber)(xAxis.dataMax) &&
...
function anchorPoints(series, groupedXData, xMax) {
    ...
    if (firstAnchor && xData[0] >= groupedXData[0]) {
        ...
        let firstGroupEnd;
        if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(groupStart) && (0,external_highcharts_src_js_default_namespaceObject.isNumber)(groupLength)) {
...
function DataGroupingSeriesComposition_applyGrouping(hasExtremesChanged) {
    ...
    if (groupPixelWidth &&
        ...
        table.rowCount &&
        plotSizeX &&
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(extremes.min)) {
        hasGroupedData = true;
...
function DataGroupingSeriesComposition_compose(SeriesClass) {
    ...
    if (!seriesProto.applyGrouping) {
        ...
        // grouped points.
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(PointClass, 'update', function () {
            if (this.dataGroup) {
                (0,external_highcharts_src_js_default_namespaceObject.error)(24, false, this.series.chart);
                return false;
            }
        });
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'afterSetOptions', onAfterSetOptions);
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'destroy', destroyGroupedData);
        (0,external_highcharts_src_js_default_namespaceObject.extend)(seriesProto, {
    ...
    for (let i = 0; i <= dataLength; i++) {
        ...
        while ((typeof groupPositions[pos + 1] !== 'undefined' &&
            ...
            if (series.pointClass &&
                !(0,external_highcharts_src_js_default_namespaceObject.defined)(series.dataGroupInfo.options) &&
                dataOptions) {
                // Convert numbers and arrays into objects
                series.dataGroupInfo.options = (0,external_highcharts_src_js_default_namespaceObject.merge)(series.pointClass.prototype
            ...
            if (typeof groupedY !== 'undefined') {
                ...
                const groupedValuesArr = (0,external_highcharts_src_js_default_namespaceObject.splat)(groupedY);
        ...
        if (pointArrayMap) {
            ...
            for (let j = 0; j < pointArrayMapLength; j++) {
                ...
                if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(val)) {
                    values[j].push(val);
                }
                else if (val === null) {
            ...
            if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(pointY)) {
...
function onAfterSetOptions(e) {
    ...
    if (plotOptions && (seriesSpecific[type] || baseOptions)) { // #1284
        ...
        if (!defaultOptions) {
            defaultOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(DataGrouping_DataGroupingDefaults.common, seriesSpecific[type]);
        }
        options.dataGrouping = (0,external_highcharts_src_js_default_namespaceObject.merge)(baseOptions, defaultOptions, plotOptions.series && plotOptions.series.dataGrouping, // #1228
        // Set by the StockChart constructor:
        plotOptions[type].dataGrouping, this.userOptions.dataGrouping, !options.isInternal &&
            rangeSelector &&
            (0,external_highcharts_src_js_default_namespaceObject.isNumber)(rangeSelector.selected) &&
...
function onTooltipHeaderFormatter(e) {
    ...
    if (xAxis &&
        ...
        dataGroupingOptions &&
        (0,external_highcharts_src_js_default_namespaceObject.isNumber)(point.key)) {
        // Set variables
        ...
        e.text = format(formatString, {
            point: (0,external_highcharts_src_js_default_namespaceObject.extend)(point, { key: formattedKey }),
            series
        }, chart);
        e.preventDefault();
    }
