...
class Oscillator {
    ...
    scheduleFilterTrackingChange(frequency, time, glideDuration) {
        const opts = this.options, rampTime = glideDuration ? glideDuration / 1000 :
            ...
            const multiplier = getPitchTrackedMultiplierVal(filterOptions.frequencyPitchTrackingMultiplier || 1, frequency), f = (0,external_highcharts_src_js_default_namespaceObject.clamp)((filterOptions.frequency || 1000) * multiplier, 0, 21000);
    ...
    createGain() {
        const opts = this.options, needsGainNode = (0,external_highcharts_src_js_default_namespaceObject.defined)(opts.volume) ||
...
class SynthPatch {
    constructor(audioContext, options) {
        ...
        this.oscillators = (this.options.oscillators || []).map((oscOpts) => new Oscillator(audioContext, oscOpts, (0,external_highcharts_src_js_default_namespaceObject.defined)(oscOpts.fmOscillator) || (0,external_highcharts_src_js_default_namespaceObject.defined)(oscOpts.vmOscillator) ?
            void 0 : inputNode));
        ...
        this.oscillators.forEach((osc) => {
            ...
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(osc.fmOscillatorIx)) {
                connectTarget('getFMTarget', this.oscillators[osc.fmOscillatorIx]);
            }
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(osc.vmOscillatorIx)) {
...
class SonificationInstrument {
    constructor(audioContext, outputNode, options) {
        ...
        this.createNodesFromCapabilities((0,external_highcharts_src_js_default_namespaceObject.extend)({
            pan: true
    ...
    scheduleEventAtTime(time, params) {
        const mergedParams = (0,external_highcharts_src_js_default_namespaceObject.extend)(this.curParams, params), freq = (0,external_highcharts_src_js_default_namespaceObject.defined)(params.frequency) ?
            params.frequency : (0,external_highcharts_src_js_default_namespaceObject.defined)(params.note) ?
            SonificationInstrument.musicalNoteToFrequency(params.note) :
            220;
        if ((0,external_highcharts_src_js_default_namespaceObject.defined)(freq)) {
            this.synthPatch.playFreqAtTime(time, freq, mergedParams.noteDuration);
        }
        if ((0,external_highcharts_src_js_default_namespaceObject.defined)(mergedParams.tremoloDepth) ||
            (0,external_highcharts_src_js_default_namespaceObject.defined)(mergedParams.tremoloSpeed)) {
            this.setTremoloAtTime(time, mergedParams.tremoloDepth, mergedParams.tremoloSpeed);
        }
        if ((0,external_highcharts_src_js_default_namespaceObject.defined)(mergedParams.pan)) {
            this.setPanAtTime(time, mergedParams.pan);
        }
        if ((0,external_highcharts_src_js_default_namespaceObject.defined)(mergedParams.volume)) {
            this.setVolumeAtTime(time, mergedParams.volume);
        }
        if ((0,external_highcharts_src_js_default_namespaceObject.defined)(mergedParams.lowpassFreq) ||
            (0,external_highcharts_src_js_default_namespaceObject.defined)(mergedParams.lowpassResonance)) {
            this.setFilterAtTime('lowpass', time, mergedParams.lowpassFreq, mergedParams.lowpassResonance);
        }
        if ((0,external_highcharts_src_js_default_namespaceObject.defined)(mergedParams.highpassFreq) ||
            (0,external_highcharts_src_js_default_namespaceObject.defined)(mergedParams.highpassResonance)) {
    ...
    setFilterAtTime(filter, time, frequency, resonance) {
        ...
        if (node) {
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(resonance)) {
                node.Q.setTargetAtTime(resonance, audioTime, SonificationInstrument.rampTime);
            }
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(frequency)) {
    ...
    setTremoloAtTime(time, depth, speed) {
        ...
        if (this.tremoloDepth && (0,external_highcharts_src_js_default_namespaceObject.defined)(depth)) {
            this.tremoloDepth.gain.setTargetAtTime(depth, audioTime, SonificationInstrument.rampTime);
        }
        if (this.tremoloOsc && (0,external_highcharts_src_js_default_namespaceObject.defined)(speed)) {
...
function filterChannels(filter, channels) {
    ...
    return filtered.map((c) => (new Sonification_TimelineChannel(c.channel.type, c.channel.engine, c.channel.showPlayMarker, c.filteredEvents.map((e) => (0,external_highcharts_src_js_default_namespaceObject.merge)(e, { time: e.time - minTime })), c.channel.muted)));
}
/**
                    ...
                    this.scheduledCallbacks.push(setTimeout(() => {
                        ...
                        if (point) {
                            ...
                            chart && chart.hoverPoints &&
                                ...
                                (0,external_highcharts_src_js_default_namespaceObject.find)(chart.hoverPoints, (p) => p === point) &&
    ...
    playClosestToPropValue(prop, targetVal, onEnd, onBoundaryHit, eventFilter) {
        ...
        (this.playingChannels || this.channels).forEach((channel) => {
            ...
            while (i--) {
                ...
                const val = events[i].relatedPoint[prop], diff = (0,external_highcharts_src_js_default_namespaceObject.defined)(val) && Math.abs(targetVal - val);
...
function getPointPropValue(point, prop) {
    ...
    if (prop) {
        ...
        ret = (0,external_highcharts_src_js_default_namespaceObject.getNestedProperty)(prop, point);
    }
...
function getChartExtremesForProps(chart, props, perSeriesProps) {
    const series = chart.series, numProps = props.length, numSeriesProps = perSeriesProps.length, initCache = (propList) => propList.reduce((cache, prop) => {
        ...
        let val = point[prop];
        if (val === void 0) {
            val = (0,external_highcharts_src_js_default_namespaceObject.getNestedProperty)(prop, point);
        }
    ...
    chart.series.forEach((series) => {
        ...
        if (series.visible && !(sOpts && sOpts.enabled === false)) {
            if (hasCommonTimeProps) {
                seriesTimeProps[series.index] = (0,external_highcharts_src_js_default_namespaceObject.merge)(commonTimeProps);
            }
            if (sOpts) {
...
function mapToVirtualAxis(value, valueExtremes, virtualAxisExtremes, invert, logarithmic // Virtual axis is logarithmic
    ...
    return (0,external_highcharts_src_js_default_namespaceObject.clamp)(val, virtualAxisExtremes.min, virtualAxisExtremes.max);
}
/**
...
function getMappingParameterValue(context, propMetrics, useSeriesExtremes, defaultMapping, mappingOptions, contextValueProp) {
    ...
    if (typeof mappingOptions === 'function') {
        return mappingOptions((0,external_highcharts_src_js_default_namespaceObject.extend)({ time: 0 }, context));
    }
    ...
    if (!useContextValue) {
        ...
        if (value === void 0) {
            value = (0,external_highcharts_src_js_default_namespaceObject.getNestedProperty)(mapTo, context.point);
        }
    }
    ...
    if (context.point) {
        if (within === 'xAxis' || within === 'yAxis') {
            ...
            if (axis && (0,external_highcharts_src_js_default_namespaceObject.defined)(axis.dataMin) && (0,external_highcharts_src_js_default_namespaceObject.defined)(axis.dataMax)) {
                extremes = {
                    min: axis.dataMin,
                    max: axis.dataMax
                };
        ...
        if (eventOpts.note > -1) {
            ...
            eventsAdded.push(channel.addEvent({
                ...
                instrumentEventOptions: ix !== void 0 ?
                    (0,external_highcharts_src_js_default_namespaceObject.extend)({}, eventOpts) : eventOpts
            }));
        }
    };
...
function timelineFromChart(audioContext, destinationNode, chart) {
    const options = chart.options.sonification ||
        {}, defaultInstrOpts = options.defaultInstrumentOptions, defaultSpeechOpts = options.defaultSpeechOptions, defaultPointGroupOpts = (0,external_highcharts_src_js_default_namespaceObject.merge)({
        enabled: true,
        groupTimespan: 15,
        algorithm: 'minmax',
        prop: 'y'
    ...
    chart.series.forEach((series, seriesIx) => {
        ...
        if (series.visible && sOptions.enabled !== false) {
            const seriesDuration = isSequential ? getAvailableDurationForSeries(series, totalDuration, propMetrics, afterSeriesWait) : totalDuration, seriesDefaultInstrOpts = (0,external_highcharts_src_js_default_namespaceObject.merge)(defaultInstrOpts, sOptions.defaultInstrumentOptions), seriesDefaultSpeechOpts = (0,external_highcharts_src_js_default_namespaceObject.merge)(defaultSpeechOpts, sOptions.defaultSpeechOptions), seriesPointGroupOpts = (0,external_highcharts_src_js_default_namespaceObject.merge)(defaultPointGroupOpts, sOptions.pointGrouping), mainTracks = (sOptions.tracks || [seriesDefaultInstrOpts])
            ...
            mainTracks.forEach((trackOpts) => {
                const mergedOpts = (0,external_highcharts_src_js_default_namespaceObject.merge)({
            ...
            contextTracks.forEach((trackOpts) => {
                const mergedOpts = trackOpts.type === 'speech' ?
                    (0,external_highcharts_src_js_default_namespaceObject.merge)(defaultSpeechOpts, trackOpts) :
                    (0,external_highcharts_src_js_default_namespaceObject.merge)(defaultInstrOpts, {
                ...
                const { timeInterval, valueInterval } = mergedOpts, valueProp = mergedOpts.valueProp || 'x', activeWhen = mergedOpts.activeWhen, contextExtremes = propMetrics
                    ...
                    if (!mergedOpts.mapping ||
                        !isActive({ time, value }, typeof activeWhen === 'object' ?
                            (0,external_highcharts_src_js_default_namespaceObject.extend)({ prop: valueProp }, activeWhen) :
...
class Sonification {
    constructor(chart) {
        ...
        this.lastUpdate = 0;
        this.chart = chart;
        this.unbindKeydown = (0,external_highcharts_src_js_default_namespaceObject.addEvent)(Sonification_doc, 'keydown', function (e) {
    ...
    speak(text, speakerOptions, delayMs = 0) {
        const speaker = new Sonification_SonificationSpeaker((0,external_highcharts_src_js_default_namespaceObject.merge)({
            language: 'en-US',
            rate: 1.5,
            volume: 0.4
        }, speakerOptions || {}));
    ...
    update() {
        ...
        if (now - this.lastUpdate < updateInterval && !this.forceReady) {
            (0,external_highcharts_src_js_default_namespaceObject.internalClearTimeout)(this.scheduledUpdate);
    ...
    initBoundaryInstrument() {
        if (!this.boundaryInstrument) {
            this.boundaryInstrument = new Sonification_SynthPatch(this.audioContext, (0,external_highcharts_src_js_default_namespaceObject.merge)(Sonification_InstrumentPresets.chop, { masterVolume: 0.3 }));
...
(function (Sonification) {
    ...
    function chartOnUpdate(e) {
        ...
        if (newOptions) {
            (0,external_highcharts_src_js_default_namespaceObject.merge)(true, this.options.sonification, newOptions);
    ...
    function compose(ChartClass, SeriesClass, PointClass) {
        ...
        if (composedClasses.indexOf(ChartClass) === -1) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.extend)(ChartClass.prototype, {
...
// Add default options
(0,external_highcharts_src_js_default_namespaceObject.merge)(true, defaultOptions, Sonification_Options);
/* *
 *
 *  Default Export
 *
