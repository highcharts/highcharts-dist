...
(function (ExportData) {
    ...
    function compose(ChartClass, ExportingClass, SeriesClass) {
        ...
        if (!(0,external_highcharts_src_js_default_namespaceObject.pushUnique)(composed, 'ExportData')) {
            return;
        }
        ...
        if (!exportingProto.downloadCSV) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'afterViewData', onChartAfterViewData);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'render', onChartRenderer);
    ...
    function getDataRows(multiLevelHeaders) {
        ...
        getCategoryAndDateTimeMap = function (series, pointArrayMap, pIdx) {
            ...
            pointArrayMap.forEach(function (prop) {
                ...
                axis = (0,external_highcharts_src_js_default_namespaceObject.isNumber)(pIdx) ?
        ...
        chart.series.forEach(function (series) {
            ...
            if (series.options.includeInDataExport !== false &&
                ...
                if (!(0,external_highcharts_src_js_default_namespaceObject.find)(xAxisIndices, function (index) {
        ...
        while (i--) { // Start from end to splice in
            ...
            row) {
                ...
                if (xAxis && !(0,external_highcharts_src_js_default_namespaceObject.defined)(category)) {
                    if (xAxis.dateTime) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'exportData', { dataRows });
        return dataRows;
    }
    /**
    ...
    function getTableAST(useLocalDecimalPoint) {
        let rowLength = 0;
        const treeChildren = [], exporting = this, chart = exporting.chart, options = chart.options, decimalPoint = useLocalDecimalPoint ? (1.1).toLocaleString()[1] : '.', useMultiLevelHeaders = (0,external_highcharts_src_js_default_namespaceObject.pick)(exporting.options.useMultiLevelHeaders, true), rows = exporting.getDataRows(useMultiLevelHeaders), topHeaders = useMultiLevelHeaders ? rows.shift() : null, subHeaders = rows.shift(), 
        ...
        getCellHTMLFromValue = function (tagName, classes, attributes, value) {
            ...
            attributes = (0,external_highcharts_src_js_default_namespaceObject.extend)({ 'class': className }, attributes);
            const result = {
                tagName,
                attributes
            };
        ...
        (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'afterGetTableAST', e);
        return e.tree;
    }
    /**
    ...
    function toggleDataTable(show) {
        ...
        if (this.dataTableDiv) {
            ...
            if (show) {
                ...
                (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'afterViewData', {
                    element: this.dataTableDiv,
                    wasHidden: createContainer || oldDisplay !== style.display
                });
            }
            else {
                (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(chart, 'afterHideData');
            }
        }
        // Set the flag
    ...
    function onChartAfterViewData() {
        const exporting = this.exporting, dataTableDiv = exporting?.dataTableDiv, langOptions = this.options.lang, decimalPoint = langOptions?.decimalPoint || '.', thousandsSep = langOptions?.thousandsSep || ',', getCellValue = (tr, index) => tr.children[index].textContent || '', parseNumber = (value) => {
            ...
            return (0,external_highcharts_src_js_default_namespaceObject.isNumber)(number) ? number : null;
