...
(function (ColorAxisComposition) {
    ...
    function compose(ColorAxisClass, ChartClass, FxClass, LegendClass, SeriesClass) {
        ...
        if (!chartProto.collectionsWithUpdate.includes('colorAxis')) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(LegendClass, 'afterColorizeItem', onLegendAfterColorizeItem);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(LegendClass, 'afterUpdate', onLegendAfterUpdate);
            (0,external_highcharts_src_js_default_namespaceObject.extend)(seriesProto, {
                optionalAxis: 'colorAxis',
                translateColors: seriesTranslateColors
            });
            (0,external_highcharts_src_js_default_namespaceObject.extend)(seriesProto.pointClass.prototype, {
                setVisible: pointSetVisible
            });
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'afterTranslate', onSeriesAfterTranslate, { order: 1 });
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'bindAxes', onSeriesBindAxes);
        }
    }
    ...
    function onChartAfterCreateAxes() {
        ...
        if (userOptions.colorAxis) {
            userOptions.colorAxis = (0,external_highcharts_src_js_default_namespaceObject.splat)(userOptions.colorAxis);
    ...
    function wrapChartCreateAxis(ChartClass) {
        ...
        ChartClass.prototype.createAxis = function (type, options) {
            ...
            const axis = new ColorAxisConstructor(chart, (0,external_highcharts_src_js_default_namespaceObject.merge)(options.axis, {
...
const TilemapShapes = {
    ...
    hexagon: {
        ...
        translate: function () {
            ...
            for (const point of series.points) {
                let x1 = (0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.floor(xAxis.len -
                    xAxis.translate(point.x - xPad * 2, 0, 1, 0, 1)), -xAxis.len, 2 * xAxis.len), x2 = (0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.floor(xAxis.len -
                    xAxis.translate(point.x - xPad, 0, 1, 0, 1)), -xAxis.len, 2 * xAxis.len), x3 = (0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.floor(xAxis.len -
                    xAxis.translate(point.x + xPad, 0, 1, 0, 1)), -xAxis.len, 2 * xAxis.len), x4 = (0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.floor(xAxis.len -
                    xAxis.translate(point.x + xPad * 2, 0, 1, 0, 1)), -xAxis.len, 2 * xAxis.len), y1 = (0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.floor(yAxis.translate(point.y - yPad, 0, 1, 0, 1)), -yAxis.len, 2 * yAxis.len), y2 = (0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.floor(yAxis.translate(point.y, 0, 1, 0, 1)), -yAxis.len, 2 * yAxis.len), y3 = (0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.floor(yAxis.translate(point.y + yPad, 0, 1, 0, 1)), -yAxis.len, 2 * yAxis.len);
    ...
    diamond: {
        ...
        translate: function () {
            ...
            series.generatePoints();
            for (const point of series.points) {
                let x1 = (0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.round(xAxis.len -
    ...
    circle: {
        ...
        translate: function () {
            ...
            series.generatePoints();
            for (const point of series.points) {
                const x = (0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.round(xAxis.len -
                    xAxis.translate(point.x, 0, 1, 0, 0)), -xAxis.len, 2 * xAxis.len);
                let pointPadding = seriesPointPadding, hasPerPointPadding = false, y = (0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.round(yAxis.translate(point.y, 0, 1, 0, 0)), -yAxis.len, 2 * yAxis.len);
                ...
                */
                if (!radius || forceNextRadiusCompute) {
                    colsizePx = Math.abs((0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.floor(xAxis.len -
                        xAxis.translate(point.x + colsize, 0, 1, 0, 0)), -xAxis.len, 2 * xAxis.len) - x);
                    yRadiusPx = Math.abs((0,external_highcharts_src_js_default_namespaceObject.clamp)(Math.floor(yAxis.translate(point.y + yRadius, 0, 1, 0, 0)), -yAxis.len, 2 * yAxis.len) - y);
