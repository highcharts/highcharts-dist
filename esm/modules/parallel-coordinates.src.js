...
(function (ParallelAxis) {
    ...
    function compose(AxisClass) {
        if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(composed, 'Axis.ParallelCoordinates')) {
            const axisCompo = AxisClass;
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(axisCompo, 'init', onInit);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(axisCompo, 'afterSetOptions', onAfterSetOptions);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(axisCompo, 'getSeriesExtremes', onGetSeriesExtremes);
        }
    }
    ...
    function onAfterSetOptions(e) {
        ...
        if (chart.hasParallelCoordinates) {
            ...
            if (axis.isXAxis) {
                axis.options = (0,external_highcharts_src_js_default_namespaceObject.merge)(axis.options, ParallelCoordinates_ParallelCoordinatesDefaults.xAxis, e.userOptions);
            }
            else {
    ...
    function onGetSeriesExtremes(e) {
        ...
        if (chart && chart.hasParallelCoordinates && !axis.isXAxis) {
            ...
            axis.series.forEach(function (series) {
                if (series.visible && (0,external_highcharts_src_js_default_namespaceObject.isNumber)(index)) {
            ...
            currentPoints = currentPoints.filter(external_highcharts_src_js_default_namespaceObject.isNumber);
            axis.dataMin = (0,external_highcharts_src_js_default_namespaceObject.arrayMin)(currentPoints);
            axis.dataMax = (0,external_highcharts_src_js_default_namespaceObject.arrayMax)(currentPoints);
            e.preventDefault();
        }
    }
    /**
...
const { composed: ParallelSeries_composed } = (external_highcharts_src_js_default_default());
...
(function (ParallelSeries) {
    ...
    function compose(SeriesClass) {
        if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(ParallelSeries_composed, 'ParallelSeries')) {
            const CompoClass = SeriesClass;
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(CompoClass, 'afterTranslate', onSeriesAfterTranslate, { order: 1 });
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(CompoClass, 'bindAxes', onSeriesBindAxes);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(CompoClass, 'destroy', onSeriesDestroy);
    ...
    function onSeriesAfterTranslate() {
        ...
        if (this.chart.hasParallelCoordinates) {
            for (let i = 0; i < dataLength; i++) {
                point = points[i];
                if ((0,external_highcharts_src_js_default_namespaceObject.defined)(point.y)) {
                    if (chart.polar) {
                    ...
                    // Range series (#15752)
                    if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(point.high)) {
    ...
    function onSeriesBindAxes(e) {
        ...
        if (chart.hasParallelCoordinates) {
            ...
            for (const axis of chart.axes) {
                (0,external_highcharts_src_js_default_namespaceObject.insertItem)(series, axis.series);
                axis.isDirty = true;
            }
    ...
    function onSeriesDestroy() {
        ...
        if (chart.hasParallelCoordinates) {
            for (const axis of (chart.axes || [])) {
                if (axis && axis.series) {
                    (0,external_highcharts_src_js_default_namespaceObject.erase)(axis.series, series);
    ...
    function onSeriesAfterGeneratePoints() {
        ...
        if (chart?.hasParallelCoordinates) {
            for (const point of this.points) {
                ...
                let formattedValue;
                if (labelFormat) {
                    formattedValue = format(labelFormat, (0,external_highcharts_src_js_default_namespaceObject.extend)(point, { value: point.y }), chart);
                }
                ...
                else if ((0,external_highcharts_src_js_default_namespaceObject.isArray)(yAxisOptions.categories)) {
...
(function (ParallelCoordinates) {
    ...
    function compose(AxisClass, ChartClass, highchartsDefaultOptions, SeriesClass) {
        ...
        if (!chartProto.setParallelInfo) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartCompo, 'init', onChartInit);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartCompo, 'update', onChartUpdate);
            (0,external_highcharts_src_js_default_namespaceObject.merge)(true, highchartsDefaultOptions.chart, ParallelCoordinates_ParallelCoordinatesDefaults.chart);
        }
    }
    ...
    function onChartInit(e) {
        const chart = this, options = e.args[0], defaultYAxis = (0,external_highcharts_src_js_default_namespaceObject.splat)(options.yAxis || {}), newYAxes = [];
        ...
        if (chart.hasParallelCoordinates) {
            ...
            options.xAxis = (0,external_highcharts_src_js_default_namespaceObject.merge)(ParallelCoordinates_ParallelCoordinatesDefaults.xAxis, // Docs
            (0,external_highcharts_src_js_default_namespaceObject.splat)(options.xAxis || {})[0]);
        }
    }
    /**
     * Initialize parallelCoordinates
    ...
    function onChartUpdate(e) {
        ...
        if (options.chart) {
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(options.chart.parallelCoordinates)) {
                chart.hasParallelCoordinates =
                    options.chart.parallelCoordinates;
            }
            chart.options.chart.parallelAxes = (0,external_highcharts_src_js_default_namespaceObject.merge)(chart.options.chart.parallelAxes, options.chart.parallelAxes);
        }
        if (chart.hasParallelCoordinates) {
            // (#10081)
            if (options.series) {
