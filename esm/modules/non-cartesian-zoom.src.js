...
class NonCartesianSeriesZoom {
    ...
    static compose(ChartClass, SeriesClass, TooltipClass) {
        if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(composed, 'NonCartesianSeriesZoom')) {
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'afterDrawChartBox', onAfterDrawChartBox);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'transform', onTransform);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'afterSetChartSize', onAfterSetChartSize);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'getPlotBox', onGetPlotBox);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'initDataLabelsGroup', onInitDataLabelsGroup);
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(TooltipClass, 'getAnchor', onGetAnchor);
        }
    }
}
/* *
