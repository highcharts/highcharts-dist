...
function composePriceIndication(SeriesClass) {
    if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(composed, 'PriceIndication')) {
...
function onSeriesAfterRender() {
    ...
    if ((lastVisiblePrice || lastPrice) &&
        ...
        if (lastVisiblePrice?.enabled && pLength > 0) {
            yAxis.crosshair = yAxis.options.crosshair = (0,external_highcharts_src_js_default_namespaceObject.merge)({
