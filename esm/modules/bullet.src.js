...
class BulletSeries extends (external_highcharts_src_js_default_Series_types_column_default()) {
    ...
    drawPoints() {
        ...
        for (const point of series.points) {
            ...
            if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(targetVal) && targetVal !== null) {
                targetOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(options.targetOptions, pointOptions.targetOptions);
                height = targetOptions.height;
                let shapeArgs = point.shapeArgs;
                // #15547
                if (point.dlBox && shapeArgs && !(0,external_highcharts_src_js_default_namespaceObject.isNumber)(shapeArgs.width)) {
                    shapeArgs = point.dlBox;
                }
                width = (0,external_highcharts_src_js_default_namespaceObject.relativeLength)(targetOptions.width, shapeArgs.width);
                ...
                if (targetGraphic) {
                    ...
                    if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(pointVal) && pointVal !== null) {
