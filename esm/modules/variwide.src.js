...
function compose(AxisClass, TickClass) {
    if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(composed, 'Variwide')) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.wrap)(tickProto, 'getLabelPosition', wrapTickGetLabelPosition);
    }
}
/**
...
class VariwideSeries extends ColumnSeries {
    ...
    getXExtremes(xData) {
        ...
        return {
            min: (0,external_highcharts_src_js_default_namespaceObject.arrayMin)(xData),
...
(0,external_highcharts_src_js_default_namespaceObject.addEvent)(VariwideSeries, 'afterColumnTranslate', function () {
    ...
    for (const point of this.points) {
        ...
        if (this.crispOption) {
            left = (0,external_highcharts_src_js_default_namespaceObject.crisp)(left, this.borderWidth);
            right = (0,external_highcharts_src_js_default_namespaceObject.crisp)(right, this.borderWidth);
        }
        shapeArgs.x = left;
...
(0,external_highcharts_src_js_default_namespaceObject.extend)(VariwideSeries.prototype, {
