...
const markerClusterAlgorithms = {
    ...
    kmeans: function (dataX, dataY, dataIndexes, options) {
        const series = this, clusters = [], noise = [], group = {}, pointMaxDistance = Number(options.processedDistance ??
            (0,external_highcharts_src_js_default_namespaceObject.relativeLength)(options.distance ||
            ...
            for (const cluster of series.baseClusters.clusters) {
                ...
                for (const dataPoint of cluster.data) {
                    ...
                    if (distance > radius + offset &&
                        (0,external_highcharts_src_js_default_namespaceObject.defined)(cluster.pointsOutside)) {
                        cluster.pointsOutside.push(dataPoint);
                    }
                    else if ((0,external_highcharts_src_js_default_namespaceObject.defined)(cluster.pointsInside)) {
...
function compose(highchartsDefaultOptions, ScatterSeriesClass) {
    ...
    if (!scatterProto.markerClusterAlgorithms) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ScatterSeriesClass, 'destroy', scatterProto.destroyClusteredData);
        if (highchartsDefaultOptions.plotOptions) {
            highchartsDefaultOptions.plotOptions.series = (0,external_highcharts_src_js_default_namespaceObject.merge)(highchartsDefaultOptions.plotOptions.series, MarkerClusters_MarkerClusterDefaults);
        }
    }
}
/**
...
function seriesAnimateClusterPoint(clusterObj) {
    ...
    if (oldState && newState) {
        ...
        if (newPointObj.parentsId.length === 1) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.syncTimeout)(function () {
                // Fade in new point.
...
function seriesGeneratePoints() {
    ...
    if (clusterOptions?.enabled &&
        ...
        layoutAlgOptions.processedGridSize = (0,external_highcharts_src_js_default_namespaceObject.relativeLength)(layoutAlgOptions.gridSize ||
            clusterDefaults.layoutAlgorithm.gridSize, chart.plotWidth);
        layoutAlgOptions.processedDistance = (0,external_highcharts_src_js_default_namespaceObject.relativeLength)(layoutAlgOptions.distance ||
        ...
        for (let i = 0; i < xData.length; i++) {
            if (!series.dataMaxX) {
                if (!(0,external_highcharts_src_js_default_namespaceObject.defined)(seriesMaxX) ||
                    !(0,external_highcharts_src_js_default_namespaceObject.defined)(seriesMinX) ||
                    !(0,external_highcharts_src_js_default_namespaceObject.defined)(seriesMaxY) ||
                    !(0,external_highcharts_src_js_default_namespaceObject.defined)(seriesMinY)) {
                    seriesMaxX = seriesMinX = xData[i];
                    seriesMaxY = seriesMinY = yData[i];
                }
                else if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(yData[i]) &&
                    (0,external_highcharts_src_js_default_namespaceObject.isNumber)(seriesMaxY) &&
                    (0,external_highcharts_src_js_default_namespaceObject.isNumber)(seriesMinY)) {
        ...
        if ((0,external_highcharts_src_js_default_namespaceObject.defined)(seriesMaxX) && (0,external_highcharts_src_js_default_namespaceObject.defined)(seriesMinX) &&
            (0,external_highcharts_src_js_default_namespaceObject.isNumber)(seriesMaxY) && (0,external_highcharts_src_js_default_namespaceObject.isNumber)(seriesMinY)) {
            series.dataMaxX = seriesMaxX;
            series.dataMinX = seriesMinX;
            series.dataMaxY = seriesMaxY;
            series.dataMinY = seriesMinY;
        }
        if ((0,external_highcharts_src_js_default_namespaceObject.isFunction)(type)) {
            algorithm = type;
        }
        ...
        if (clusteredData && series.markerClusterInfo) {
            ...
            series.markerClusterInfo.clusters?.forEach((cluster) => {
                ...
                (0,external_highcharts_src_js_default_namespaceObject.addEvent)(point, 'click', onPointDrillToCluster);
            });
...
function seriesGetClusteredData(groupedData, options) {
    ...
    if ((0,external_highcharts_src_js_default_namespaceObject.isFunction)(options.layoutAlgorithm.type) &&
        ...
        if (groupedData[k].length >= minimumClusterSize) {
            ...
            groupMap.push({
                options: {
                    ...
                    marker: (0,external_highcharts_src_js_default_namespaceObject.merge)(options.marker, {
            ...
            if (data?.length) {
                for (let i = 0; i < pointsLen; i++) {
                    if ((0,external_highcharts_src_js_default_namespaceObject.isObject)(data[points[i].dataIndex])) {
            ...
            for (let i = 0; i < groupedData[k].length; i++) {
                ...
                if (pointUserOptions &&
                    ...
                    !(0,external_highcharts_src_js_default_namespaceObject.isArray)(pointUserOptions)) {
                    pointOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(pointUserOptions, { x: point.x, y: point.y });
                }
                else {
                    pointOptions = {
...
function seriesGetScaledGridSize(options) {
    const series = this, xAxis = series.xAxis, mapView = series.chart.mapView, processedGridSize = Number(options.processedGridSize ??
        (0,external_highcharts_src_js_default_namespaceObject.relativeLength)(options.gridSize || clusterDefaults.layoutAlgorithm.gridSize, series.chart.plotWidth));
...
function seriesIsValidGroupedDataObject(groupedData) {
    let result = false;
    if (!(0,external_highcharts_src_js_default_namespaceObject.isObject)(groupedData)) {
        return false;
    }
    (0,external_highcharts_src_js_default_namespaceObject.objectEach)(groupedData, (elem) => {
        result = true;
        if (!(0,external_highcharts_src_js_default_namespaceObject.isArray)(elem) || !elem.length) {
            result = false;
            return;
        }
        for (let i = 0; i < elem.length; i++) {
            if (!(0,external_highcharts_src_js_default_namespaceObject.isObject)(elem[i]) || (!elem[i].x || !elem[i].y)) {
                result = false;
                return;
            }
        }
            ...
            if (zoneOptions) {
                ...
                for (let i = 0; i < zoneOptions.length; i++) {
                    if (pointsLen >= zoneOptions[i].from &&
                        ...
                        if ((0,external_highcharts_src_js_default_namespaceObject.defined)(zoneOptions[i].marker?.radius)) {
 ...
 *
 * */
(defaultOptions.plotOptions || {}).series = (0,external_highcharts_src_js_default_namespaceObject.merge)((defaultOptions.plotOptions || {}).series, MarkerClusters_MarkerClusterDefaults);
/* *
 *
 *  Functions
 *
...
function MarkerClusters_compose(AxisClass, ChartClass, highchartsDefaultOptions, SeriesClass) {
    if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(composed, 'MarkerClusters')) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(PointClass, 'drillToCluster', MarkerClusters_onPointDrillToCluster);
...
function MarkerClusters_onPointDrillToCluster(event) {
    ...
    if ((0,external_highcharts_src_js_default_namespaceObject.isFunction)(onDrillToCluster)) {
    ...
    if (series.markerClusterInfo && series.markerClusterInfo.clusters) {
        for (const cluster of series.markerClusterInfo.clusters) {
            if (cluster.point && cluster.point.graphic) {
                ...
                if ((0,external_highcharts_src_js_default_namespaceObject.defined)(cluster.clusterZone)) {
