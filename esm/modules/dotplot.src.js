...
class DotPlotSeries extends ColumnSeries {
    ...
    drawPoints() {
        ...
        if (!(0,external_highcharts_src_js_default_namespaceObject.isNumber)(slotsPerBar)) {
            slotsPerBar = 1;
            ...
            if (typeof point.y === 'number') {
                ...
                for (let val = 0; val < positiveYValue; val++) {
                    ...
                    if (graphic) {
                        ...
                        graphic = renderer
                            .symbol(symbol)
                            .attr((0,external_highcharts_src_js_default_namespaceObject.extend)(attr, pointAttr))
                            .add(point.graphic);
                    }
