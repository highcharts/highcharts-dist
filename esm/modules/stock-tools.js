...
<g>
    <g>
        <path fill="${W}" d="M16.001,20.25c-2.344,0-4.25-1.906-4.25-4.25c0-2.343,1.906-4.25,4.25-4.25s4.25,1.907,4.25,4.25
    ...
    <g>
        <path fill="${W}" d="M16.001,23.238L16.001,23.238c-2.729-0.001-5.302-1.062-7.246-2.988L4.465,16l4.29-4.25
...
`,"annotations-visible.svg":`${Y(32)}
<g>
    <path fill="${W}" d="M11.751,16c0,0.427,0.082,0.831,0.2,1.22l1.309-1.31c0.048-1.443,1.208-2.604,2.652-2.651l1.309-1.309
        c-0.389-0.118-0.793-0.2-1.22-0.2C13.657,11.75,11.751,13.656,11.751,16z"/>
    <path fill="${W}" d="M16.087,18.741l-1.308,1.308c0.389,0.119,0.794,0.201,1.222,0.201c2.344,0,4.25-1.906,4.25-4.25
        c0-0.428-0.083-0.832-0.2-1.223l-1.309,1.309C18.696,17.533,17.533,18.695,16.087,18.741z"/>
    <path fill="${W}" d="M23.247,11.75c-0.028-0.028-0.06-0.052-0.089-0.08l-1.061,1.062c0.029,0.029,0.062,0.054,0.093,0.083
    ...
    <path fill="${W}" d="M8.842,20.328l1.062-1.061c-0.03-0.029-0.062-0.053-0.092-0.082L6.454,16l3.356-3.185
        ...
        <rect x="3.272" y="15.25" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -6.6276 15.9997)" fill="${W}" width="25.456" height="1.501"/>
</g>
</svg>
`,"arrow-bottom.svg":`${Y(32)}
<g>
    <polygon fill="${W}" transform="rotate(45,15,15)" points="12.78,25.03 11.72,23.97 19.689,16 11.72,8.03 12.78,6.97 21.811,16"/>
</g>
</svg>
`,"arrow-left.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="19.22,25.03 10.189,16 19.22,6.97 20.28,8.03 12.311,16 20.28,23.97"/>
</g>
</svg>
`,"arrow-line.svg":`${Y(32)}
<path fill="${W}" d="M26.679,8.25L28,4l-4.25,1.321l0.934,0.935l-3.502,3.502c-0.212-0.083-0.44-0.133-0.682-0.133
...
`,"arrow-ray.svg":`${Y(32)}
<path fill="${W}" d="M25.429,9.5L27,5l-4.5,1.571l0.934,0.935l-5.252,5.252c-0.212-0.083-0.44-0.133-0.682-0.133
    c-1.035,0-1.875,0.84-1.875,1.875c0,0.241,0.05,0.47,0.133,0.682l-7.576,7.576c-0.212-0.083-0.44-0.133-0.682-0.133
...
`,"arrow-right.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="12.78,25.03 11.72,23.97 19.689,16 11.72,8.03 12.78,6.97 21.811,16"/>
</g>
</svg>
`,"arrow-segment.svg":`${Y(32)}
<g>
    <circle fill="${W}" cx="24.5" cy="7.5" r="1.875"/>
    <path fill="${W}" d="M19.684,11.256L8.182,22.758c-0.212-0.083-0.44-0.133-0.682-0.133c-1.035,0-1.875,0.84-1.875,1.875
...
`,"circle.svg":`${Y(32)}
<path fill="${W}" d="M26.249,15.999c0.001-2.737-1.065-5.312-3.002-7.248C21.312,6.815,18.737,5.749,16,5.75
...
`,"close.svg":`${Y(32)}
<polygon fill="${W}" points="24.308,8.756 23.248,7.695 16.002,14.941 8.757,7.695 7.695,8.754 14.941,16.001 7.696,23.246
    8.755,24.308 16.002,17.061 23.247,24.307 24.308,23.248 17.062,16.001"/>
</svg>
`,"crooked-3.svg":`${Y(32)}
<g>
    <g>
        <path fill="${W}" d="M5.048,22.258c-0.234,0-0.464-0.109-0.61-0.312c-0.241-0.338-0.164-0.806,0.173-1.047l14.468-10.37
...
`,"crooked-5.svg":`${Y(32)}
<g>
    <path fill="${W}" d="M27.53,14.03c0.293-0.293,0.293-0.768,0-1.061l-5.064-5.064l-7.5,8.5L10.461,11.9l-7.027,8.109
...
`,"current-price-hide.svg":`${Y(32)}
<g>
    <g opacity="0.5">
        <polygon fill="${W}" points="12.509,22.893 12.509,17.428 11.409,17.428 9.651,18.718 10.229,19.507 11.363,18.628
            11.363,22.893"/>
        <path fill="${W}" d="M17.962,19.832c-0.341-0.326-0.759-0.492-1.242-0.492c-0.141,0-0.264,0.02-0.365,0.058l-0.276,0.104
        ...
        <path fill="${W}" d="M20.639,21.805c-0.141-0.135-0.302-0.201-0.495-0.201c-0.198,0-0.364,0.067-0.507,0.205
        ...
        <path fill="${W}" d="M22.962,19.063c0.04-0.23,0.13-0.423,0.268-0.574c0.164-0.179,0.372-0.269,0.618-0.269
    ...
    <path opacity="0.5" fill="${W}" d="M17.486,12.742c-0.809,0.626-1.691,1.131-2.631,1.5H27.75v11.5H8.25v-3.061l-2.939-2.689
        l2.939-2.689l0.001-2.122l-4.812,4.812l3.311,3.311v3.939h22.5v-14.5H17.486z"/>
    <g>
        <path fill="${W}" d="M17.121,10.432c-1.659,1.659-3.865,2.573-6.211,2.573l0,0c-0.723,0-1.43-0.097-2.113-0.266l1.096-1.097
        ...
        <path fill="${W}" d="M3.351,8.091c0.035-0.043,0.882-1.045,1.351-1.512c1.658-1.66,3.864-2.574,6.209-2.574
            ...
            <rect x="2.731" y="7.861" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -2.8175 10.2057)" fill="${W}" width="16.359" height="1.286"/>
    </g>
</g>
</svg>
`,"current-price-show.svg":`${Y(32)}
<g>
    <g>
        <polygon fill="${W}" points="12.509,22.893 12.509,17.428 11.409,17.428 9.651,18.718 10.229,19.507 11.363,18.628
            11.363,22.893"/>
    ...
    <path fill="${W}" d="M17.486,12.742c-0.809,0.626-1.691,1.131-2.631,1.5H27.75v11.5H8.25v-3.061l-2.939-2.689l2.939-2.689V14.65
        c-0.512-0.131-1.015-0.287-1.5-0.489v2.521l-3.311,3.311l3.311,3.311v3.939h22.5v-14.5H17.486z"/>
    <g>
        <path fill="${W}" d="M10.911,10.741c-1.24,0-2.249-1.009-2.249-2.249s1.009-2.249,2.249-2.249s2.249,1.009,2.249,2.249
    ...
    <g>
        <path fill="${W}" d="M10.911,12.992L10.911,12.992c-2.346,0-4.553-0.915-6.211-2.573C4.233,9.951,3.387,8.949,3.35,8.906
...
`,"destroy.svg":`${Y(32)}
<g>
    <rect x="12.75" y="14" fill="${W}" width="1.5" height="10"/>
    <rect x="17.75" y="14" fill="${W}" width="1.5" height="10"/>
    <path fill="${W}" d="M25.25,10.5c0-1.517-1.233-2.75-2.75-2.75h-3.25V7c0-1.24-1.01-2.25-2.25-2.25h-2
...
`,"drawing.svg":`${Y(32)}<path fill="${W}" d="M18.3,8.6c-0.5,0.2-0.8,0.7-0.9,1.2l-1,7.6l0.5,0.3l3.1-4.5c-0.1-0.1-0.2-0.3-0.2-0.5c-0.1-0.7,0.3-1.3,1-1.4
...
<path fill="${W}" d="M17.1,18.9c-0.8-0.2-3.8-0.2-4,1.6c0,0.9,0.1,1.9,0.5,2.7c0.4,0.7,0.7,0.9,0.7,1.4c0,0.8-0.5,1.5-1.2,1.8
...
`,"edit.svg":`${Y(32)}
<path fill="${W}" d="M22.125,3.814L5.817,20.122l-1.818,7.879l7.879-1.818L28.186,9.875L22.125,3.814z M26.064,9.875
...
<g>
    ...
    <g>
        <g>
            <path fill="${W}" d="M6.483,24.807c0.35,0.532,0.524,1.266,0.524,2.201s-0.175,1.67-0.524,2.201
            ...
            <path fill="${W}" d="M5,30.058c-0.659,0-1.177-0.276-1.538-0.82c-0.355-0.536-0.535-1.286-0.535-2.229
    ...
    <g>
        <g>
            <path fill="${W}" d="M24,27.008v-6h2.339c0.508,0,0.942,0.125,1.301,0.373s0.538,0.627,0.538,1.135
    ...
    <g>
        <g>
            <path fill="${W}" d="M15.958,9.008l2.61-6h0.924l2.584,6h-1.221l-0.559-1.373h-2.602l-0.542,1.373H15.958z M18.06,6.72h1.864
...
<g>
    <path fill="${W}" d="M27.53,14.03c0.293-0.293,0.293-0.768,0-1.061l-5.064-5.064l-7.5,8.5L10.461,11.9l-7.027,8.109
        c-0.271,0.313-0.238,0.786,0.075,1.058C3.65,21.189,3.825,21.25,4,21.25c0.21,0,0.419-0.088,0.566-0.259l5.973-6.891l4.495,4.495
        l7.5-8.5l3.936,3.936C26.763,14.323,27.237,14.323,27.53,14.03z"/>
    <path fill="${W}" d="M3.999,22.9c-0.569,0-1.017,0.238-1.327,0.709c-0.304,0.459-0.457,1.096-0.457,1.891
    ...
    <path fill="${W}" d="M9.522,9.9h1.952l0.448,1.1h1.19l-2.129-4.941L10.959,6h-0.867l-2.116,4.864L7.917,11h1.171L9.522,9.9z
         M10.5,7.337l0.639,1.686H9.851L10.5,7.337z"/>
    <path fill="${W}" d="M16.416,22.34c0.151-0.079,0.279-0.182,0.383-0.307c0.163-0.198,0.246-0.443,0.246-0.729
        ...
        />
    <path fill="${W}" d="M22.539,7c0.78,0,1.401-0.282,1.845-0.837l0.062-0.077l-0.808-0.568l-0.055,0.073
    ...
    <path fill="${W}" d="M29.075,17.328c-0.163-0.338-0.386-0.604-0.66-0.792c-0.271-0.185-0.563-0.321-0.871-0.407
...
`,"ellipse.svg":`${Y(32)}<path fill="${W}" d="M16.3,7.2C10.1,7.2,5,11.1,5,15.9s5.1,8.7,11.3,8.7s11.3-3.9,11.3-8.7S22.5,7.2,16.3,7.2z M16.3,23.3
    c-5.5,0-9.9-3.3-9.9-7.4s4.4-7.4,9.9-7.4s9.9,3.3,9.9,7.4S21.8,23.3,16.3,23.3L16.3,23.3z"/>
<circle fill="${W}" cx="23.5" cy="22.2" r="2.3"/>
<rect fill="none" width="32" height="32"/>
</svg>
`,"fibonacci-timezone.svg":`${Y(32)}
<polyline fill="${W}" points="5.2,7.3 5.2,5.6 3.6,5.6 3.6,23.3 3.6,24.8 3.6,27.5 5.2,27.5 5.2,8.8"/>
<polyline fill="${W}" points="9.6,7.3 9.6,5.6 8,5.6 8,23.3 8,24.8 8,27.5 9.6,27.5 9.6,8.8"/>
<polyline fill="${W}" points="11.6,7.3 11.6,5.6 10,5.6 10,23.3 10,24.8 10,27.5 11.6,27.5 11.6,8.8"/>
<polyline fill="${W}" points="14.2,7.3 14.2,5.6 12.6,5.6 12.6,23.3 12.6,24.8 12.6,27.5 14.2,27.5 14.2,8.8"/>
<polyline fill="${W}" points="19,7.3 19,5.6 17.4,5.6 17.4,23.3 17.4,24.8 17.4,27.5 19,27.5 19,8.8"/>
<polyline fill="${W}" points="27.5,7.3 27.5,5.6 25.9,5.6 25.9,23.3 25.9,24.8 25.9,27.5 27.5,27.5 27.5,8.8"/>
<rect fill="none" width="32" height="32"/>
</svg>
`,"fibonacci.svg":`${Y(32)}
<g>
    <rect x="19.5" y="19.75" fill="${W}" width="3" height="1.5"/>
    <rect x="24.5" y="19.75" fill="${W}" width="3" height="1.5"/>
    <rect x="9.5" y="19.75" fill="${W}" width="3" height="1.5"/>
    <rect x="14.5" y="19.75" fill="${W}" width="3" height="1.5"/>
    <rect x="4.5" y="19.75" fill="${W}" width="3" height="1.5"/>
    <rect x="19.5" y="15.75" fill="${W}" width="3" height="1.5"/>
    <rect x="24.5" y="15.75" fill="${W}" width="3" height="1.5"/>
    <rect x="9.5" y="15.75" fill="${W}" width="3" height="1.5"/>
    <rect x="14.5" y="15.75" fill="${W}" width="3" height="1.5"/>
    <rect x="4.5" y="15.75" fill="${W}" width="3" height="1.5"/>
    <rect x="19.5" y="10.75" fill="${W}" width="3" height="1.5"/>
    <rect x="24.5" y="10.75" fill="${W}" width="3" height="1.5"/>
    <rect x="9.5" y="10.75" fill="${W}" width="3" height="1.5"/>
    <rect x="14.5" y="10.75" fill="${W}" width="3" height="1.5"/>
    <rect x="4.5" y="10.75" fill="${W}" width="3" height="1.5"/>
    <rect x="4" y="4.75" fill="${W}" width="24" height="1.5"/>
    <rect x="4" y="25.75" fill="${W}" width="24" height="1.5"/>
</g>
</svg>
`,"flag-basic.svg":`${Y(32)}
<g>
    <path fill="${W}" d="M27.25,4.75H15V3h-1.65v22.175c0,0.456,0.369,0.825,0.825,0.825S15,25.631,15,25.175V16.25h12.25L21.5,10.5
        L27.25,4.75z M23.689,14.75H15v-8.5h8.689l-4.25,4.25L23.689,14.75z"/>
</g>
</svg>
`,"flag-diamond.svg":`${Y(32)}
<g>
    <path fill="${W}" d="M27.25,4.75H15V3h-1.65v20.175c0,0.456,0.369,0.825,0.825,0.825S15,23.631,15,23.175V16.25h12.25L21.5,10.5
        L27.25,4.75z M23.689,14.75H15v-8.5h8.689l-4.25,4.25L23.689,14.75z"/>
    <polygon fill="${W}" points="17,22.604 21.65,24 14,26.295 6.349,24 11,22.604 11,21.195 1.651,24 14,27.705 26.35,24
        17,21.195"/>
</g>
</svg>
`,"flag-elipse.svg":`${Y(32)}
<g>
    <path fill="${W}" d="M17,20.385v1.506c4.129,0.398,6.25,1.558,6.25,2.109c0,0.673-3.146,2.5-9.25,2.5S4.75,24.673,4.75,24
...
`,"flag-trapeze.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="19.29,20.3 17,20.3 17,21.7 18.71,21.7 23.311,26.3 6.133,26.3 8.433,21.7 11,21.7 11,20.3
        7.567,20.3 3.867,27.7 26.69,27.7"/>
    <g>
        <path fill="${W}" d="M27.25,4.75H15V3h-1.65v20.175c0,0.456,0.369,0.825,0.825,0.825S15,23.631,15,23.175V16.25h12.25
...
`,"fullscreen.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="22.593,21.657 19.297,18.361 18.413,19.244 21.71,22.541 20.465,23.786 24.75,24.75 23.786,20.464"/>
    <polygon fill="${W}" points="11.535,8.214 7.25,7.25 8.214,11.536 9.459,10.291 12.756,13.588 13.641,12.703 10.343,9.406"/>
    <polygon fill="${W}" points="19.27,13.613 22.566,10.316 23.786,11.535 24.75,7.25 20.464,8.214 21.684,9.433 18.387,12.729"/>
    <polygon fill="${W}" points="12.729,18.386 9.432,21.683 8.214,20.465 7.25,24.75 11.536,23.786 10.316,22.567 13.613,19.271"/>
</g>
</svg>
`,"horizontal-line.svg":`${Y(32)}
<path fill="${W}" d="M27,14.751H15.143c-0.289-0.663-0.948-1.126-1.718-1.126s-1.429,0.463-1.718,1.126H5v1.5h6.709
...
<g>
    <g>
        <g>
            <polygon fill="${W}" points="14.138,14.794 14.697,16.26 21.328,11.074 22.156,12.134 23.723,8.25 19.576,8.834 20.404,9.893"/>
            <polygon fill="${W}" points="10.841,17.372 3.761,22.909 4.685,24.091 11.401,18.838"/>
        </g>
        <g>
            <path fill="${W}" d="M17.075,24.159c-0.11,0-0.221-0.006-0.332-0.019c-1.334-0.154-2.439-1.211-3.113-2.976l-2.215-5.793
...
`,"label.svg":`${Y(32)}
<g>
    <path fill="${W}" d="M3.75,7.749v14.5h7.939L16,26.561l4.31-4.312h7.94v-14.5H3.75z M26.75,20.749h-7.062L16,24.439l-3.689-3.69
        H5.25v-11.5h21.5V20.749z"/>
    <polygon fill="${W}" points="9.291,18 10.735,18 10.735,13.251 12.426,13.251 12.426,12.018 7.601,12.018 7.601,13.251
        9.291,13.251"/>
    <polygon fill="${W}" points="14.712,18 15.971,15.888 17.28,18 19.063,18 16.9,14.84 18.793,12.018 17.111,12.018
        16.013,13.876 14.897,12.018 13.157,12.018 15.084,14.84 12.988,18"/>
    <polygon fill="${W}" points="21.265,18 22.709,18 22.709,13.251 24.399,13.251 24.399,12.018 19.574,12.018 19.574,13.251
        21.265,13.251"/>
</g>
</svg>
`,"line.svg":`${Y(32)}
<path fill="${W}" d="M27.03,6.03L25.97,4.97l-3.788,3.788c-0.212-0.083-0.44-0.133-0.682-0.133c-1.035,0-1.875,0.84-1.875,1.875
...
`,"linear.svg":`${Y(32)}<polyline fill="${W}" points="8.4,7 8.4,5.3 6.8,5.3 6.8,23 6.8,24.5 6.8,27.3 8.4,27.3 8.4,8.5"/>
<polyline fill="${W}" points="22.8,10.3 24.1,9 22.9,7.9 10.4,20.5 9.3,21.5 7.4,23.5 8.5,24.6 21.8,11.3"/>
<polyline fill="${W}" points="25.2,25.4 26.9,25.4 26.9,23.8 9.2,23.8 7.7,23.8 4.9,23.8 4.9,25.4 23.7,25.4"/>
<rect fill="none" width="32" height="32"/>
</svg>
`,"logarithmic.svg":`${Y(32)}<g data-name="Layer 2"><g data-name="Layer 7"><g><polyline fill="${W}" points="8.41 7.01 8.41 5.26 6.81 5.26 6.81 23.01 6.81 24.51 6.81 27.26 8.41 27.26 8.41 8.51"/><polyline fill="${W}" points="25.17 25.37 26.92 25.37 26.92 23.77 9.17 23.77 7.67 23.77 4.92 23.77 4.92 25.37 23.67 25.37"/><path fill="${W}" d="M24.66,12a2.18,2.18,0,0,0-.27-.11,12.35,12.35,0,0,0-16.64,12,9.8,9.8,0,0,0,1.88.14A10.51,10.51,0,0,1,23.77,13.61"/><rect fill="none" width="32" height="32"/></g></g></g></svg>`,"measure-x.svg":`${Y(32)}
<g>
    <g>
        <polygon fill="${W}" points="14.673,21 15.984,19.177 17.287,21 18.808,21 16.766,18.344 18.559,16 17.12,16 16.006,17.553
            14.923,16 13.422,16 15.225,18.344 13.193,21"/>
        <rect x="25.75" y="9.014" fill="${W}" width="1.5" height="2.986"/>
        <rect x="25.75" y="24.014" fill="${W}" width="1.5" height="2.986"/>
        <rect x="25.75" y="14.014" fill="${W}" width="1.5" height="2.986"/>
        <rect x="25.75" y="19.014" fill="${W}" width="1.5" height="2.986"/>
        <rect x="4.75" y="9.014" fill="${W}" width="1.5" height="2.986"/>
        <rect x="4.75" y="4.014" fill="${W}" width="1.5" height="2.986"/>
        <rect x="4.75" y="19.014" fill="${W}" width="1.5" height="2.986"/>
        <rect x="4.75" y="14.014" fill="${W}" width="1.5" height="2.986"/>
        <rect x="25.75" y="4" fill="${W}" width="1.5" height="3"/>
        <rect x="4.75" y="24" fill="${W}" width="1.5" height="2.986"/>
        <polygon fill="${W}" points="24.465,13.5 21,11.5 21,13 11,13 11,11.5 7.535,13.5 11,15.5 11,14 21,14 21,15.5"/>
    </g>
</g>
</svg>
`,"measure-xy.svg":`${Y(32)}
<g>
    <g>
        <rect x="26.75" y="19" fill="${W}" width="1.5" height="3"/>
        <rect x="26.75" y="14" fill="${W}" width="1.5" height="3"/>
        <rect x="26.75" y="9" fill="${W}" width="1.5" height="3"/>
        <rect x="20" y="25.75" fill="${W}" width="3" height="1.5"/>
        <rect x="15" y="25.75" fill="${W}" width="3" height="1.5"/>
        <rect x="10" y="25.75" fill="${W}" width="3" height="1.5"/>
        <rect x="4.75" y="9.001" fill="${W}" width="1.5" height="2.999"/>
        <rect x="4.75" y="14.001" fill="${W}" width="1.5" height="2.999"/>
        <rect x="4.75" y="19.001" fill="${W}" width="1.5" height="2.999"/>
        <rect x="10" y="3.751" fill="${W}" width="3" height="1.5"/>
        <rect x="15" y="3.751" fill="${W}" width="3" height="1.5"/>
        <rect x="20" y="3.751" fill="${W}" width="3" height="1.5"/>
    </g>
    <polygon fill="${W}" points="25,3.75 25,5.25 26.75,5.25 26.75,7 28.25,7 28.25,3.75"/>
    <polygon fill="${W}" points="4.75,7 6.25,7 6.25,5.25 8,5.25 8,3.75 4.75,3.75"/>
    <polygon fill="${W}" points="8,27.25 8,25.75 6.25,25.75 6.25,24 4.75,24 4.75,27.25"/>
    <polygon fill="${W}" points="28.25,24 26.75,24 26.75,25.75 25,25.75 25,27.25 28.25,27.25"/>
    <polygon fill="${W}" points="16.5,6.535 14.5,10 16,10 16,21 14.5,21 16.5,24.465 18.5,21 17,21 17,10 18.5,10"/>
    <polygon fill="${W}" points="25.465,15.5 22,13.5 22,15 11,15 11,13.5 7.535,15.5 11,17.5 11,16 22,16 22,17.5"/>
</g>
</svg>
`,"measure-y.svg":`${Y(32)}
<g>
    <g>
        <rect x="24" y="4.75" fill="${W}" width="3" height="1.5"/>
        <rect x="19" y="25.75" fill="${W}" width="3" height="1.5"/>
        <rect x="9" y="4.75" fill="${W}" width="3" height="1.5"/>
        <rect x="4" y="25.75" fill="${W}" width="3" height="1.5"/>
        <rect x="19" y="4.75" fill="${W}" width="3" height="1.5"/>
        <rect x="14" y="4.75" fill="${W}" width="3" height="1.5"/>
        <path fill="${W}" d="M18.13,19.851c-0.113,0.116-0.297,0.175-0.552,0.175c-0.163,0-0.321-0.024-0.478-0.074l-0.106,1.104
        ...
        <rect x="14" y="25.75" fill="${W}" width="3" height="1.5"/>
        <rect x="8.995" y="25.75" fill="${W}" width="3" height="1.5"/>
        <rect x="4" y="4.75" fill="${W}" width="3" height="1.5"/>
        <rect x="24" y="25.75" fill="${W}" width="3" height="1.5"/>
        <polygon fill="${W}" points="13.5,7.535 11.5,11 13,11 13,21 11.5,21 13.5,24.465 15.5,21 14,21 14,11 15.5,11"/>
    </g>
</g>
</svg>
`,"panning.svg":`${Y(32)}<path fill="${W}" d="M20.8,10.7v-0.4c0-1.4-1.1-2.6-2.5-2.6c-0.2,0-0.4,0-0.7,0.1C17,6.5,15.5,6,14.3,6.6
...
`,"parallel-channel.svg":`${Y(32)}
<g>
    <path fill="${W}" d="M17.258,7.802C17.487,7.896,17.737,7.95,18,7.95c1.077,0,1.95-0.873,1.95-1.95S19.077,4.05,18,4.05
        ...
        />
    <path fill="${W}" d="M28.03,13.03L26.97,11.97l-6.228,6.228C20.513,18.104,20.263,18.05,20,18.05c-1.077,0-1.95,0.873-1.95,1.95
...
`,"pitchfork.svg":`${Y(32)}
<path fill="${W}" d="M28.057,15.006l-1.059-1.062l-7.865,7.863c-0.212-0.083-0.441-0.133-0.683-0.133
...
`,"ray.svg":`${Y(32)}
<path fill="${W}" d="M27.03,6.03L25.97,4.97l-7.788,7.788c-0.212-0.083-0.44-0.133-0.682-0.133c-1.035,0-1.875,0.84-1.875,1.875
...
`,"rectangle.svg":`${Y(32)}
<path fill="${W}" d="M25.25,22.783V6.75H6.75v18.5h16.033c0.29,0.662,0.949,1.125,1.717,1.125c1.035,0,1.875-0.84,1.875-1.875
    C26.375,23.731,25.912,23.073,25.25,22.783z M23.75,22.783c-0.432,0.189-0.777,0.535-0.967,0.967H8.25V8.25h15.5V22.783z"/>
</svg>
`,"remove-annotations.svg":`${Y(32)}
<g>
    <rect x="5" y="23.7" fill="${W}" width="3" height="1.5"/>

        <rect x="7.69" y="26.011" transform="matrix(-0.7071 -0.7071 0.7071 -0.7071 -5.046 52.9314)" fill="${W}" width="1.5" height="3"/>
    <path fill="${W}" d="M16.311,23.7l10.625-10.625l-7.159-7.158c-1.001-1.002-2.019-0.786-2.806,0.003L6.72,16.17
...
`,"save-chart.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="8.749,21.25 12.75,21.25 12.75,26 14.25,26 14.25,19.75 12.37,19.75 15.999,16.12 19.629,19.75
        17.75,19.75 17.75,26 19.25,26 19.25,21.25 23.25,21.25 16,14"/>
    <polygon fill="${W}" points="15.34,6.75 12.84,3.75 5.75,3.75 5.75,21.138 7.25,19.638 7.25,5.25 12.16,5.25 14.66,8.25
        24.75,8.25 24.75,19.555 26.25,21.055 26.25,6.75"/>
</g>
</svg>
`,"segment.svg":`${Y(32)}
<path fill="${W}" d="M24.5,5.625c-1.035,0-1.875,0.84-1.875,1.875c0,0.241,0.05,0.47,0.133,0.682L8.182,22.758
...
`,"series-candlestick.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="7,26 8,26 8,23 9,23 9,18 8,18 8,14 7,14 7,18 6,18 6,23 7,23"/>
    <polygon fill="${W}" points="13,20 14,20 14,17 15,17 15,11 14,11 14,6 13,6 13,11 12,11 12,17 13,17"/>
    <polygon fill="${W}" points="19,25 20,25 20,22 21,22 21,18 20,18 20,14 19,14 19,18 18,18 18,22 19,22"/>
    <polygon fill="${W}" points="24,17 25,17 25,14 26,14 26,10 25,10 25,6 24,6 24,10 23,10 23,14 24,14"/>
</g>
</svg>
`,"series-heikin-ashi.svg":`${Y(32)}<g data-name="Layer 2"><g><g data-name="heikin-ashi-series"><rect fill="${W}" x="10.77" y="7.42" width="3.11" height="16.29"/><rect fill="${W}" x="11.76" y="12.19" width="1.06" height="14.01"/><rect fill="${W}" x="4.83" y="5.24" width="3.11" height="5.05"/><rect fill="${W}" x="5.83" y="7.96" width="1.06" height="4.68"/><rect fill="${W}" x="17.71" y="13.5" width="3.11" height="5.05"/><rect fill="${W}" x="18.7" y="16.21" width="1.06" height="6.74"/><polygon fill="${W}" points="24.68 16.6 25.7 16.6 25.7 13.51 26.73 13.51 26.73 9.39 25.7 9.39 25.7 5.27 24.68 5.27 24.68 9.39 23.64 9.39 23.64 13.51 24.68 13.51 24.68 16.6"/><rect fill="none" width="32" height="32"/></g></g></g></svg>`,"series-hlc.svg":`${Y(32)}<g data-name="Layer 2"><g><g data-name="hlc-series"><polyline fill="${W}" points="5.11 12.22 5.11 24.97 6.71 24.97 6.71 20.22 9.65 20.22 9.65 18.72 6.71 18.72 6.71 6.97 5.11 6.97 5.11 10.72"/><polyline fill="${W}" points="14.2 18.14 14.2 19.89 15.8 19.89 15.8 14.14 18.75 14.14 18.75 12.64 15.8 12.64 15.8 9.89 14.2 9.89 14.2 16.64"/><polyline fill="${W}" points="22.2 22.77 22.2 5.02 23.8 5.02 23.8 6.77 26.75 6.77 26.75 8.27 23.8 8.27 23.8 27.02 22.2 27.02 22.2 24.27"/><rect fill="none" width="32" height="32"/></g></g></g></svg>`,"series-hollow-candlestick.svg":`${Y(32)}<g data-name="Layer 2"><g><g data-name="hollow-candlestick-series"><rect fill="${W}" x="11.07" y="14.05" width="3.25" height="8.37"/><rect fill="${W}" x="12.11" y="6.89" width="1.11" height="10.88"/><rect fill="${W}" x="12.11" y="21.4" width="1.11" height="5.38"/><path fill="${W}" d="M19.77,10.19v9.58H18.68V10.19h1.09m1.08-1.07H17.6V20.84h3.25V9.12Z"/><rect fill="${W}" x="18.64" y="20.55" width="1.11" height="2.88"/><rect fill="${W}" x="18.64" y="5.25" width="1.11" height="3.93"/><path fill="${W}" d="M6.66,17.23v5.14H5.57V17.23H6.66m1.08-1.08H4.49v7.3H7.74v-7.3Z"/><rect fill="${W}" x="5.53" y="12.35" width="1.11" height="4.31"/><rect fill="${W}" x="5.53" y="22.43" width="1.11" height="4.43"/><rect fill="${W}" x="24.01" y="12.33" width="3.25" height="8.37"/><rect fill="${W}" x="25.05" y="20.68" width="1.11" height="5.53"/><rect fill="none" width="32" height="32"/></g></g></g></svg>`,"series-line.svg":`${Y(32)}
<g>
    <path fill="${W}" d="M4.125,28.95c-0.079,0-0.16-0.012-0.239-0.035c-0.436-0.132-0.683-0.593-0.551-1.028L8.844,9.664
...
`,"series-ohlc.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="8.3,6.001 6.7,6.001 6.7,9.75 3.75,9.75 3.75,11.25 6.7,11.25 6.7,24 8.3,24 8.3,19.25
        11.25,19.25 11.25,17.75 8.3,17.75"/>
    <polygon fill="${W}" points="17.3,13 15.7,13 15.7,24.75 12.75,24.75 12.75,26.25 15.7,26.25 15.7,28 17.3,28 17.3,22.25
        20.25,22.25 20.25,20.75 17.3,20.75"/>
    <polygon fill="${W}" points="28.25,21.75 25.3,21.75 25.3,4 23.7,4 23.7,5.75 20.75,5.75 20.75,7.25 23.7,7.25 23.7,26 25.3,26
...
`,"time-cycles.svg":`${Y(32)}
<path fill="${W}" d="M12.1,27c0-2.2-1.8-4-4-4s-4,1.8-4,4 M5.5,27c-0.1-1.4,1-2.7,2.4-2.7c1.4-0.1,2.7,1,2.7,2.4c0,0.1,0,0.2,0,0.3"
    />
<path fill="${W}" d="M20.1,27c0-2.2-1.8-4-4-4s-4,1.8-4,4 M13.5,27c-0.1-1.4,1-2.7,2.4-2.7c1.4-0.1,2.7,1,2.7,2.4c0,0.1,0,0.2,0,0.3"/>
<path fill="${W}" d="M28,27c0-2.2-1.8-4-4-4s-4,1.8-4,4 M21.4,27c-0.1-1.4,1-2.7,2.4-2.7c1.4-0.1,2.7,1,2.7,2.4c0,0.1,0,0.2,0,0.3"
    />
<rect x="4.1" y="27" fill="${W}" width="23.9" height="1.4"/>
<rect x="23.3" y="20.4" fill="${W}" width="1.4" height="1.4"/>
<rect x="23.3" y="17.1" fill="${W}" width="1.4" height="1.4"/>
<rect x="23.3" y="13.7" fill="${W}" width="1.4" height="1.4"/>
<rect x="23.3" y="10.4" fill="${W}" width="1.4" height="1.4"/>
<rect x="23.3" y="7" fill="${W}" width="1.4" height="1.4"/>
<rect x="23.3" y="3.6" fill="${W}" width="1.4" height="1.4"/>
<rect x="15.5" y="20.4" fill="${W}" width="1.4" height="1.4"/>
<rect x="15.5" y="17.1" fill="${W}" width="1.4" height="1.4"/>
<rect x="15.5" y="13.7" fill="${W}" width="1.4" height="1.4"/>
<rect x="15.5" y="10.4" fill="${W}" width="1.4" height="1.4"/>
<rect x="15.5" y="7" fill="${W}" width="1.4" height="1.4"/>
<rect x="15.5" y="3.6" fill="${W}" width="1.4" height="1.4"/>
<rect x="7.5" y="20.4" fill="${W}" width="1.4" height="1.4"/>
<rect x="7.5" y="17.1" fill="${W}" width="1.4" height="1.4"/>
<rect x="7.5" y="13.7" fill="${W}" width="1.4" height="1.4"/>
<rect x="7.5" y="10.4" fill="${W}" width="1.4" height="1.4"/>
<rect x="7.5" y="7" fill="${W}" width="1.4" height="1.4"/>
<rect x="7.5" y="3.6" fill="${W}" width="1.4" height="1.4"/>
<rect fill="none" width="32" height="32"/>
</svg>
`,"vertical-arrow.svg":`${Y(32)}
<polygon fill="${W}" points="16.251,23.243 16.251,4.001 14.751,4.001 14.751,23.244 13,23.244 15.5,28 18,23.243"/>
</svg>
`,"vertical-counter.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="16.251,11 14.751,11 14.751,23.244 13,23.244 15.5,28 18,23.243 16.251,23.243"/>
    <polygon fill="${W}" points="9.085,5.241 9.693,6.074 10.618,5.36 10.618,9 11.794,9 11.794,4.044 10.716,4.044"/>
    <path fill="${W}" d="M14.778,5.118c0.126-0.138,0.285-0.206,0.477-0.206c0.187,0,0.336,0.055,0.448,0.164
    ...
    <path fill="${W}" d="M21.656,6.826C21.479,6.614,21.25,6.476,20.97,6.41V6.389c0.247-0.065,0.448-0.194,0.603-0.388
...
`,"vertical-double-arrow.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="18,10.243 16.251,10.243 16.251,4.001 14.751,4.001 14.751,10.244 13,10.244 15.5,15"/>
    <polygon fill="${W}" points="13,21.757 14.749,21.757 14.749,27.999 16.249,27.999 16.249,21.756 18,21.756 15.5,17"/>
</g>
</svg>
`,"vertical-label.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="16.251,11 14.751,11 14.751,23.244 13,23.244 15.5,28 18,23.243 16.251,23.243"/>
    <polygon fill="${W}" points="8.5,5.066 9.899,5.066 9.899,9 11.097,9 11.097,5.066 12.497,5.066 12.497,4.044 8.5,4.044"/>
    <polygon fill="${W}" points="17.813,4.044 16.421,4.044 15.511,5.584 14.587,4.044 13.145,4.044 14.74,6.382 13.005,9 14.433,9
        15.476,7.25 16.561,9 18.037,9 16.245,6.382"/>
    <polygon fill="${W}" points="18.504,4.044 18.504,5.066 19.903,5.066 19.903,9 21.101,9 21.101,5.066 22.501,5.066
        22.501,4.044"/>
</g>
</svg>
`,"vertical-line.svg":`${Y(32)}
<path fill="${W}" d="M17.375,18.574c0-0.769-0.463-1.427-1.124-1.716V5h-1.5v11.856c-0.663,0.29-1.126,0.949-1.126,1.718
    c0,0.771,0.463,1.429,1.126,1.718V27h1.5v-6.709C16.912,20.001,17.375,19.344,17.375,18.574z"/>
</svg>
`,"zoom-x.svg":`${Y(32)}
<g>
    <polygon fill="${W}" points="16.25,18 16.25,15.25 19,15.25 19,13.75 16.25,13.75 16.25,11 14.75,11 14.75,13.75 12,13.75
        12,15.25 14.75,15.25 14.75,18"/>
    <path fill="${W}" d="M15.5,8.251c2.359,0,4.416,1.314,5.479,3.249h1.665C21.47,8.713,18.71,6.751,15.5,6.751
        S9.53,8.713,8.355,11.5h1.665C11.084,9.565,13.141,8.251,15.5,8.251z"/>
    <path fill="${W}" d="M22.646,17.5H20.98c-1.062,1.936-3.121,3.251-5.48,3.251s-4.418-1.315-5.48-3.251H8.354
    ...
    <polygon fill="${W}" points="10,13.754 6.012,13.754 6.012,12.26 2.125,14.504 6.012,16.747 6.012,15.247 10,15.247"/>
    <polygon fill="${W}" points="21,15.253 24.988,15.253 24.988,16.747 28.875,14.504 24.988,12.261 24.988,13.761 21,13.761"/>
</g>
</svg>
`,"zoom-xy.svg":`${Y(32)}
<g>
    <path fill="${W}" d="M26.083,24.917l-5.556-5.555c1.075-1.331,1.723-3.021,1.723-4.861c0-4.273-3.477-7.75-7.75-7.75
    ...
    <polygon fill="${W}" points="15.25,11 13.75,11 13.75,13.75 11,13.75 11,15.25 13.75,15.25 13.75,18 15.25,18 15.25,15.25
        18,15.25 18,13.75 15.25,13.75"/>
</g>
</svg>
`,"zoom-y.svg":`${Y(32)}
<g>
    <path fill="${W}" d="M27.083,24.917l-5.567-5.566c1.075-1.331,1.734-3.01,1.734-4.85c0-3.21-1.962-5.97-4.75-7.146v1.665
