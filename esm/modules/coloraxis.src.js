...
(function (ColorAxisBase) {
    ...
    function initDataClasses(userOptions) {
        ...
        for (let i = 0, iEnd = userDataClasses.length; i < iEnd; ++i) {
            ...
            dataClass = (0,external_highcharts_src_js_default_namespaceObject.merge)(dataClass);
...
const { parse: ColorAxisComposition_color } = (external_highcharts_src_js_default_Color_default());
...
defaultOptions.colorAxis = (0,external_highcharts_src_js_default_namespaceObject.merge)(defaultOptions.xAxis, ColorAxisDefaults);
/* *
 *
 *  Class
 *
...
class ColorAxis extends (external_highcharts_src_js_default_Axis_default()) {
    ...
    init(chart, userOptions) {
        ...
        if ((0,external_highcharts_src_js_default_namespaceObject.isArray)(chart.userOptions.colorAxis)) {
    ...
    setOptions(userOptions) {
        ...
        const options = (0,external_highcharts_src_js_default_namespaceObject.merge)(sideSpecific, theme, userOptions, 
        // Forced options
        {
            showEmpty: false,
    ...
    getSeriesExtremes() {
        ...
        while (i--) { // X, y, value, other
            ...
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(cSeries.minColorValue) &&
                (0,external_highcharts_src_js_default_namespaceObject.defined)(cSeries.maxColorValue)) {
                this.dataMin =
    ...
    getDataClassLegendSymbols() {
        ...
        if (!legendItems.length) {
            axis.dataClasses.forEach((dataClass, i) => {
                ...
                legendItems.push((0,external_highcharts_src_js_default_namespaceObject.extend)({
                    chart,
                    name,
                    options: {},
                    ...
                    setVisible: function () {
                        ...
                        affectedSeries.forEach((series) => {
                            (0,external_highcharts_src_js_default_namespaceObject.fireEvent)(series, 'afterDataClassLegendClick');
                        });
                    }
                }, dataClass));
            });
