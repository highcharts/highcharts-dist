...
function composePatternFill(ChartClass, SeriesClass, SVGRendererClass) {
    ...
    if (!pointProto.calculatePatternDimensions) {
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'endResize', onChartEndResize);
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ChartClass, 'redraw', onChartRedraw);
        (0,external_highcharts_src_js_default_namespaceObject.extend)(pointProto, {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'render', onSeriesRender);
        (0,external_highcharts_src_js_default_namespaceObject.wrap)(SeriesClass.prototype, 'getColor', wrapSeriesGetColor);
        // Pattern scale corrections
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'afterRender', onPatternScaleCorrection);
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'mapZoomComplete', onPatternScaleCorrection);
        (0,external_highcharts_src_js_default_namespaceObject.extend)(SVGRendererClass.prototype, {
            addPattern: rendererAddPattern
        });
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SVGRendererClass, 'complexColor', onRendererComplexColor);
    }
}
/**
...
function createAnchoredPattern(pattern, element) {
    const anchoredPattern = (0,external_highcharts_src_js_default_namespaceObject.merge)({}, pattern);
    ...
    if (patterns.length) {
        ...
        for (const id of patterns) {
            if (!usedIds[id]) {
                ...
                (0,external_highcharts_src_js_default_namespaceObject.erase)(renderer.defIds, id);
...
function onPointAfterInit() {
    ...
    if (colorOptions &&
        ...
        point.color = point.options.color = (0,external_highcharts_src_js_default_namespaceObject.merge)(point.series.options.color, colorOptions);
    }
}
/**
...
function onRendererComplexColor(args) {
    ...
    if (pattern.image ||
        ...
        if (forceHashId || !pattern.id || pattern.anchorToPoint) {
            ...
            pattern = (0,external_highcharts_src_js_default_namespaceObject.merge)({}, pattern);
...
function pointCalculatePatternDimensions(pattern) {
    ...
    if (pattern.image) {
        ...
        if (!bBox.width || !bBox.height) {
            ...
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(scaleY) && scaleY < 0) {
...
function rendererAddPattern(options, animation) {
    ...
    if (options.path) {
        path = (0,external_highcharts_src_js_default_namespaceObject.isObject)(options.path) ?
            options.path :
            { d: options.path };
        // The background
...
function getStackMetrics(yAxis, shape) {
    ...
    if (shape && (0,external_highcharts_src_js_default_namespaceObject.defined)(shape.max)) {
    ...
    getExtremes() {
        ...
        if (paths) {
            paths.forEach(function (path) {
                if ((0,external_highcharts_src_js_default_namespaceObject.defined)(path.max) &&
                    (0,external_highcharts_src_js_default_namespaceObject.defined)(extremes.dataMax) &&
 ...
 *
 * */
(0,external_highcharts_src_js_default_namespaceObject.addEvent)(PictorialSeries, 'afterRender', function () {
...
function forEachStack(chart, callback) {
    if (chart.axes) {
        chart.axes.forEach(function (axis) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.objectEach)(stacks, function (type) {
                (0,external_highcharts_src_js_default_namespaceObject.objectEach)(type, function (stack) {
                    callback(stack);
                });
            });
        });
