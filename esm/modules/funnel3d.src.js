...
const { parse: SVGElement3DFunnel_color } = (external_highcharts_src_js_default_Color_default());
    ...
    fillSetter(fill) {
        ...
        if (fillColor.linearGradient) {
            ...
            for (const sideGroupName of funnel3d.sideGroups) {
                const box = funnel3d[sideGroupName].gradientBox, gradient = fillColor.linearGradient, alteredGradient = (0,external_highcharts_src_js_default_namespaceObject.merge)(fillColor, {
                    linearGradient: {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.merge)(true, partsWithColor, {
...
function rendererFunnel3dPath(shapeArgs) {
    ...
    // consistency
    cuboidData = this.cuboidPath.call(renderer, (0,external_highcharts_src_js_default_namespaceObject.merge)(shapeArgs, {
    ...
    //
    top = renderer.getCylinderEnd(chart, (0,external_highcharts_src_js_default_namespaceObject.merge)(shapeArgs, {
        x: shapeArgs.x - shapeArgs.width / 2,
        z: shapeArgs.z - shapeArgs.width / 2,
        alphaCorrection: alphaCorrection
    })), bottomWidth = shapeArgs.bottom.width, bottomArgs = (0,external_highcharts_src_js_default_namespaceObject.merge)(shapeArgs, {
        width: bottomWidth,
    ...
    if (hasMiddle) {
        ...
        middleTopArgs = (0,external_highcharts_src_js_default_namespaceObject.merge)(shapeArgs, {
            y: (shapeArgs.y +
    ...
    ret.rightUpper = renderer.getCylinderFront(renderer.getCylinderEnd(chart, (0,external_highcharts_src_js_default_namespaceObject.merge)(shapeArgs, {
        x: shapeArgs.x - shapeArgs.width / 2,
        z: shapeArgs.z - shapeArgs.width / 2,
        alphaCorrection: useAlphaCorrection ?
            -alphaCorrection : 0
    }), false), renderer.getCylinderEnd(chart, (0,external_highcharts_src_js_default_namespaceObject.merge)(middleTopArgs, {
        alphaCorrection: useAlphaCorrection ?
            -alphaCorrection : 0
    }), !hasMiddle));
    if (hasMiddle) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.merge)(true, ret, {
            frontLower: renderer.getCylinderFront(middleBottom, bottom),
            backLower: renderer.getCylinderBack(middleBottom, bottom),
            rightLower: renderer.getCylinderFront(renderer.getCylinderEnd(chart, (0,external_highcharts_src_js_default_namespaceObject.merge)(bottomArgs, {
                alphaCorrection: useAlphaCorrection ?
                    -alphaCorrection : 0
            }), true), renderer.getCylinderEnd(chart, (0,external_highcharts_src_js_default_namespaceObject.merge)(middleTopArgs, {
                alphaCorrection: useAlphaCorrection ?
                    -alphaCorrection : 0
            }), false)),
            zIndexes: {
...
class Funnel3DSeries extends Funnel3DSeries_ColumnSeries {
    ...
    bindAxes() {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.merge)(true, this.yAxis.options, {
            gridLineWidth: 0,
            title: void 0,
            labels: {
                enabled: false
    ...
    translate() {
        ...
        for (const point of points) {
            ...
            point.shapeArgs = (0,external_highcharts_src_js_default_namespaceObject.extend)(point.shapeArgs, shapeArgs);
...
Funnel3D_Funnel3DSeries.compose((external_highcharts_src_js_default_SVGRenderer_default()));
