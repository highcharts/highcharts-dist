...
const external_highcharts_src_js_default_Fx_namespaceObject = __WEBPACK_EXTERNAL_MODULE__highcharts_src_js_8202131d__["default"].Fx;
...
function onRecommendMapView(e) {
    ...
    if (twm && twm.provider && twm.provider.type && !twm.provider.url) {
        ...
        if (!(0,external_highcharts_src_js_default_namespaceObject.defined)(ProviderDefinition)) {
            (0,external_highcharts_src_js_default_namespaceObject.error)('Highcharts warning: Tiles Provider not defined in the ' +
...
class TiledWebMapSeries extends MapSeries {
    ...
    static compose(MapViewClass) {
        if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(composed, 'TiledWebMapSeries')) {
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(MapViewClass, 'onRecommendMapView', onRecommendMapView);
        }
    }
    /* *
     *
    ...
    drawPoints() {
        ...
        const tiles = (this.tiles = this.tiles || {}), transformGroups = (this.transformGroups = this.transformGroups || []), series = this, options = this.options, provider = options.provider, { zoom } = mapView, lambda = (0,external_highcharts_src_js_default_namespaceObject.pick)((mapView.projection.options.rotation &&
        ...
        if (provider && (provider.type || provider.url)) {
            if (provider.type && !provider.url) {
                ...
                if (!(0,external_highcharts_src_js_default_namespaceObject.defined)(ProviderDefinition)) {
                    (0,external_highcharts_src_js_default_namespaceObject.error)('Highcharts warning: Tiles Provider \'' +
                ...
                let theme, subdomain = '';
                if (provider.theme && (0,external_highcharts_src_js_default_namespaceObject.defined)(def.themes[provider.theme])) {
                    ...
                    (0,external_highcharts_src_js_default_namespaceObject.error)('Highcharts warning: The Tiles Provider\'s Theme \'' +
                ...
                else if ((0,external_highcharts_src_js_default_namespaceObject.defined)(def.subdomains) &&
                    // Do not show warning if no subdomain in URL
                    theme.url.indexOf('{s}') !== -1) {
                    subdomain = (0,external_highcharts_src_js_default_namespaceObject.pick)(def.subdomains && def.subdomains[0], '');
                    (0,external_highcharts_src_js_default_namespaceObject.error)('Highcharts warning: The Tiles Provider\'s Subdomain ' +
                ...
                if (def.requiresApiKey) {
                    if (provider.apiKey) {
                        ...
                        (0,external_highcharts_src_js_default_namespaceObject.error)('Highcharts warning: The Tiles Provider requires ' +
                ...
                const creditsText = (0,external_highcharts_src_js_default_namespaceObject.pick)(chart.userOptions.credits && chart.userOptions.credits.text, 'Highcharts.com ' + (0,external_highcharts_src_js_default_namespaceObject.pick)(theme.credits, def.defaultCredits));
                if (chart.credits) {
                    ...
                    chart.addCredits({
                        text: creditsText,
                        style: (0,external_highcharts_src_js_default_namespaceObject.pick)(chart.options.credits?.style, {})
                    });
                }
                if (mapView.projection.options.name !== providerProjection) {
                    (0,external_highcharts_src_js_default_namespaceObject.error)('Highcharts warning: The set projection is different ' +
            ...
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(this.minZoom) && zoomFloor < this.minZoom) {
            ...
            else if ((0,external_highcharts_src_js_default_namespaceObject.defined)(this.maxZoom) && zoomFloor > this.maxZoom) {
            ...
            for (const zoomKey of Object.keys(tiles)) {
                for (const key of Object.keys(tiles[zoomKey].tiles)) {
                    if (mapView.projection && mapView.projection.def) {
                        ...
                        if ((external_highcharts_src_js_default_Fx_default()).timers.length > 0) {
                            (0,external_highcharts_src_js_default_namespaceObject.stop)(tile, 'animator');
                        }
                        ...
                        if ((0,external_highcharts_src_js_default_namespaceObject.defined)(posX) &&
                            (0,external_highcharts_src_js_default_namespaceObject.defined)(posY) &&
                            (0,external_highcharts_src_js_default_namespaceObject.defined)(firstTile.posX) &&
                            (0,external_highcharts_src_js_default_namespaceObject.defined)(firstTile.posY)) {
    ...
    update(options) {
        ...
        if (mapView &&
            !(0,external_highcharts_src_js_default_namespaceObject.defined)(chart.userOptions.mapView?.projection) &&
            provider?.type) {
            const ProviderDefinition = TilesProviderRegistry[provider.type];
...
TiledWebMapSeries.defaultOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(MapSeries.defaultOptions, TiledWebMap_TiledWebMapSeriesDefaults);
