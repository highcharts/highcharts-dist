...
class GeoHeatmapSeries extends MapSeries {
    ...
    update() {
        const series = this;
        series.options = (0,external_highcharts_src_js_default_namespaceObject.merge)(series.options, arguments[0]);
     ...
     */
    getInterpolation() {
        if (!(0,external_highcharts_src_js_default_namespaceObject.isObject)(this.options.interpolation)) {
            return {
                blur: 1,
            ...
            if (canvas && ctx && colorAxis && topLeft && bottomRight) {
                ...
                series.isDirtyCanvas ||
                    ...
                    if (unEvenLon || unEvenLat) {
                        (0,external_highcharts_src_js_default_namespaceObject.error)('Highcharts Warning: For best performance,' +
                ...
                if (image) {
                    if (chart.renderer.globalAnimation && chart.hasRendered) {
                        ...
                        image
                            .attr((0,external_highcharts_src_js_default_namespaceObject.merge)({ animator: 0 }, series.isDirtyCanvas ? {
 ...
 */
GeoHeatmapSeries.defaultOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(MapSeries.defaultOptions, {
...
(0,external_highcharts_src_js_default_namespaceObject.addEvent)(GeoHeatmapSeries, 'afterDataClassLegendClick', function () {
    this.isDirtyCanvas = true;
    this.drawPoints();
});
(0,external_highcharts_src_js_default_namespaceObject.extend)(GeoHeatmapSeries.prototype, {
    type: 'geoheatmap',
    applyJitter: noop,
