...
(function (CircleUtilities) {
    ...
    function getAreaOfCircle(r) {
        ...
        return (0,external_highcharts_src_js_default_namespaceObject.correctFloat)(Math.PI * r * r);
    }
...
function addOverlapToSets(relations) {
    ...
    relations
        ...
        relation.sets.forEach((set, i, arr) => {
            if (!(0,external_highcharts_src_js_default_namespaceObject.isObject)(mapOfIdToProps[set])) {
                mapOfIdToProps[set] = {
                    totalOverlap: 0,
                    overlapping: {}
                };
    ...
    relations
        ...
        (0,external_highcharts_src_js_default_namespaceObject.extend)(set, properties);
    });
 ...
 */
function isSet(x) {
    return (0,external_highcharts_src_js_default_namespaceObject.isArray)(x.sets) && x.sets.length === 1;
}
// eslint-disable-next-line require-jsdoc
/**
 *
...
function isValidRelation(x) {
    const map = {};
    return ((0,external_highcharts_src_js_default_namespaceObject.isObject)(x) &&
        ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(x.value) && x.value > -1) &&
        ((0,external_highcharts_src_js_default_namespaceObject.isArray)(x.sets) && x.sets.length > 0) &&
        !x.sets.some(function (set) {
            let invalid = false;
            if (!map[set] && (0,external_highcharts_src_js_default_namespaceObject.isString)(set)) {
                map[set] = true;
            }
            else {
                invalid = true;
...
class VennSeries extends ScatterSeries {
    ...
    static updateFieldBoundaries(field, circle) {
        ...
        if (!(0,external_highcharts_src_js_default_namespaceObject.isNumber)(field.left) || field.left > left) {
            field.left = left;
        }
        if (!(0,external_highcharts_src_js_default_namespaceObject.isNumber)(field.right) || field.right < right) {
            field.right = right;
        }
        if (!(0,external_highcharts_src_js_default_namespaceObject.isNumber)(field.top) || field.top > top) {
            field.top = top;
        }
        if (!(0,external_highcharts_src_js_default_namespaceObject.isNumber)(field.bottom) || field.bottom < bottom) {
            field.bottom = bottom;
        }
        return field;
    }
    ...
    drawPoints() {
        ...
        for (const point of points) {
            const attribs = {
                zIndex: (0,external_highcharts_src_js_default_namespaceObject.isArray)(point.sets) ? point.sets.length : 0
            }, shapeArgs = point.shapeArgs;
            // Add point attribs
            if (!chart.styledMode) {
                (0,external_highcharts_src_js_default_namespaceObject.extend)(attribs, series.pointAttribs(point, point.state));
            }
    ...
    pointAttribs(point, state) {
        const series = this, seriesOptions = series.options || {}, pointOptions = point?.options || {}, stateOptions = (state && seriesOptions.states[state]) || {}, options = (0,external_highcharts_src_js_default_namespaceObject.merge)(seriesOptions, pointOptions, stateOptions);
    ...
    translate() {
        ...
        const field = Object.keys(mapOfIdToShape)
            ...
            return shape && (0,external_highcharts_src_js_default_namespaceObject.isNumber)(shape.r);
        })
        ...
        for (const point of this.points) {
            const sets = (0,external_highcharts_src_js_default_namespaceObject.isArray)(point.sets) ? point.sets : [], id = sets.join(), shape = mapOfIdToShape[id], dataLabelValues = mapOfIdToLabelValues[id] || {}, dlOptions = point.options?.dataLabels;
            ...
            if (shape) {
                ...
                if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(dataLabelWidth)) {
            ...
            if (dataLabelWidth && shapeArgs) {
                point.dlOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)({ style: { width: dataLabelWidth } }, (0,external_highcharts_src_js_default_namespaceObject.isObject)(dlOptions, true) ? dlOptions : void 0, { zIndex: void 0 });
