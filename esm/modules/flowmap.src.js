...
class FlowMapSeries extends MapLineSeries {
    ...
    animate(init) {
        ...
        if (!init) { // Run the animation
            points.forEach((point) => {
                if (point.shapeArgs &&
                    (0,external_highcharts_src_js_default_namespaceObject.isArray)(point.shapeArgs.d) &&
    ...
    getLinkWidth(point) {
        ...
        if (!(0,external_highcharts_src_js_default_namespaceObject.defined)(weight) || !smallestWeight || !greatestWeight) {
            return 0;
        }
    ...
    translate() {
        ...
        this.points.forEach((point) => {
            const chart = this.chart, mapView = chart.mapView, options = point.options, dirtySeries = () => {
                ...
                if ((foundPoint instanceof Point) &&
                    ...
                    // be also updated
                    (0,external_highcharts_src_js_default_namespaceObject.addEvent)(foundPoint, 'update', dirtySeries);
                    return {
                        x: foundPoint.plotX,
                        y: foundPoint.plotY
                    };
                ...
                if ((0,external_highcharts_src_js_default_namespaceObject.isArray)(lonLat)) {
                    return {
                        lon: lonLat[0],
                        lat: lonLat[1]
                    };
        ...
        this.greatestWeight = (0,external_highcharts_src_js_default_namespaceObject.arrayMax)(weights);
        this.centerOfPoints = {
    ...
    getPointShapeArgs(point) {
        ...
        if (offset) {
            ...
            offset = (0,external_highcharts_src_js_default_namespaceObject.relativeLength)(offset, finalWidth * 4);
