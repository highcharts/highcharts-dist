...
class AxisResizer {
    ...
    render() {
        ...
        pos = (0,external_highcharts_src_js_default_namespaceObject.clamp)(axis.top + axis.height + y, chart.plotTop, chart.plotTop + chart.plotHeight);
        let attr = {};
        if (!chart.styledMode) {
            attr = {
    ...
    addMouseEvents() {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(container, 'mousemove', mouseMoveHandler), (0,external_highcharts_src_js_default_namespaceObject.addEvent)(container.ownerDocument, 'mouseup', mouseUpHandler), (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ctrlLineElem, 'mousedown', mouseDownHandler), 
        // Touch events.
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(container, 'touchmove', mouseMoveHandler), (0,external_highcharts_src_js_default_namespaceObject.addEvent)(container.ownerDocument, 'touchend', mouseUpHandler), (0,external_highcharts_src_js_default_namespaceObject.addEvent)(ctrlLineElem, 'touchstart', mouseDownHandler));
    ...
    updateAxes(chartY) {
        ...
        axesConfigs = [], plotTop = chart.plotTop, plotHeight = chart.plotHeight, plotBottom = plotTop + plotHeight, calculatePercent = (value) => (value * 100 / plotHeight + '%'), normalize = (val, min, max) => (Math.round((0,external_highcharts_src_js_default_namespaceObject.clamp)(val, min, max)));
        // Normalize chartY to plot area limits
        chartY = (0,external_highcharts_src_js_default_namespaceObject.clamp)(chartY, plotTop, plotBottom);
        ...
        for (const axesGroup of [prevAxes, nextAxes]) {
            for (const axisInfo of axesGroup) {
                ...
                const axis = (0,external_highcharts_src_js_default_namespaceObject.isNumber)(axisInfo) ?
                ...
                top = axis.top;
                const minLength = Math.round((0,external_highcharts_src_js_default_namespaceObject.relativeLength)(axisOptions.minLength || NaN, plotHeight)), maxLength = Math.round((0,external_highcharts_src_js_default_namespaceObject.relativeLength)(axisOptions.maxLength || NaN, plotHeight));
...
function compose(AxisClass, PointerClass) {
    if ((0,external_highcharts_src_js_default_namespaceObject.pushUnique)(composed, 'Axis.DragPanes')) {
        (0,external_highcharts_src_js_default_namespaceObject.merge)(true, defaultOptions.yAxis, DragPanes_AxisResizerDefaults);
        ...
        (0,external_highcharts_src_js_default_namespaceObject.wrap)(PointerClass.prototype, 'runPointActions', wrapPointerRunPointActions);
        (0,external_highcharts_src_js_default_namespaceObject.wrap)(PointerClass.prototype, 'drag', wrapPointerDrag);
    }
}
/**
