...
class DataTable extends Data_DataTableCore {
    ...
    setOriginalRowIndexes(originalRowIndexes, omitLocalRowIndexes = false) {
        ...
        for (let i = 0, iEnd = originalRowIndexes.length, originalIndex; i < iEnd; ++i) {
            ...
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(originalIndex)) {
...
class DataConnector {
    ...
    describeColumn(name, columnMeta) {
        ...
        columns[name] = (0,external_highcharts_src_js_default_namespaceObject.merge)(columns[name] || {}, columnMeta);
    }
    /**
    ...
    async update(newOptions, reload = true) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.merge)(true, this.options, newOptions);
        const { options } = this;
...
function guessType(value, converter) {
    ...
    if (typeof value === 'string') {
        ...
        if (+innerTrimedValue === floatValue) {
            ...
            result = (0,external_highcharts_src_js_default_namespaceObject.isNumber)(dateValue) ? 'Date' : 'string';
        }
    }
    if (typeof value === 'number') {
...
class DataConverter {
    ...
    constructor(options) {
        ...
        const mergedOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(DataConverter.defaultOptions, options);
...
class DataPool {
     ...
     * */
    constructor(options) {
        this.options = (0,external_highcharts_src_js_default_namespaceObject.merge)(DataPool.defaultOptions, options);
        this.connectors = {};
        this.waiting = {};
    }
    /* *
...
function negativeReference(formula) {
    ...
    return (formula[formulaLength - 1] === '-' &&
        (0,external_highcharts_src_js_default_namespaceObject.isString)(priorFormula) &&
        !!priorFormula.match(/\*|\/|\^/));
}
/**
...
function applyOperator(values, operators) {
    ...
    if (!(0,external_highcharts_src_js_default_namespaceObject.defined)(secondValue) || !(0,external_highcharts_src_js_default_namespaceObject.defined)(firstValue) || !(0,external_highcharts_src_js_default_namespaceObject.defined)(operator)) {
        values.push(NaN);
    }
    else {
 ...
 *
 * */
const MODE = (/* unused pure expression or super */ null && ({
    MULT,
    SNGL
}));
...
class CSVConverter extends Converters_DataConverter {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(CSVConverter.defaultOptions, options);
        super(mergedOptions);
        /* *
         *
         *  Properties
    ...
    parse(options, eventDetail) {
        const converter = this, dataTypes = converter.dataTypes, parserOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(this.options, options), { beforeParse, lineDelimiter, firstRowAsNames, itemDelimiter } = parserOptions;
...
class CSVConnector extends Connectors_DataConnector {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(CSVConnector.defaultOptions, options);
        super(mergedOptions);
        this.options = mergedOptions;
        ...
        return Promise
            ...
            if (csv) {
                this.initConverters(csv, (key) => {
                    ...
                    return new Converters_CSVConverter((0,external_highcharts_src_js_default_namespaceObject.merge)(options, converterOptions));
...
class JSONConverter extends Converters_DataConverter {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(JSONConverter.defaultOptions, options);
        super(mergedOptions);
        /* *
         *
         *  Properties
    ...
    parse(options, eventDetail) {
        ...
        options = (0,external_highcharts_src_js_default_namespaceObject.merge)(converter.options, options);
    ...
    parseColumnsOrientation(columnsArray, data, firstRowAsNames, columnIds) {
        ...
        for (let i = 0, iEnd = data.length; i < iEnd; i++) {
            ...
            if (Array.isArray(converter.headers)) {
                ...
                (0,external_highcharts_src_js_default_namespaceObject.error)('JSONConverter: Invalid `columnIds` option.', false);
            }
        }
    }
    /**
    ...
    parseRowsOrientation(columnsArray, data, firstRowAsNames, columnIds) {
        ...
        for (let rowIndex = 0, iEnd = data.length; rowIndex < iEnd; rowIndex++) {
            ...
            if (!(0,external_highcharts_src_js_default_namespaceObject.isArray)(row)) {
    ...
    convertItemToRow(rowObj, columnIds) {
        ...
        if (columnIds && !(Array.isArray(columnIds))) {
            const newRow = [];
            (0,external_highcharts_src_js_default_namespaceObject.objectEach)(columnIds, (arrayWithPath, name) => {
...
class JSONConnector extends Connectors_DataConnector {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(JSONConnector.defaultOptions, options);
        super(mergedOptions);
        this.options = mergedOptions;
        if (mergedOptions.enablePolling) {
            this.startPolling(Math.max(mergedOptions.dataRefreshRate || 0, 1) * 1000);
...
class GoogleSheetsConverter extends Converters_DataConverter {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(GoogleSheetsConverter.defaultOptions, options);
        super(mergedOptions);
        this.header = [];
        this.options = mergedOptions;
    }
     ...
     */
    parse(options, eventDetail) {
        const converter = this, parseOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(converter.options, options);
        ...
        for (let i = 0, iEnd = columnsArray.length; i < iEnd; i++) {
            ...
            converter.header[i] = (parseOptions.firstRowAsNames ?
                `${column.shift()}` :
                (0,external_highcharts_src_js_default_namespaceObject.uniqueKey)());
            for (let j = 0, jEnd = column.length; j < jEnd; ++j) {
 ...
 */
    constructor(options) {
        const mergedOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(GoogleSheetsConnector.defaultOptions, options);
        super(mergedOptions);
        this.options = mergedOptions;
    }
    /* *
...
class HTMLTableConverter extends Converters_DataConverter {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(HTMLTableConverter.defaultOptions, options);
        super(mergedOptions);
        this.headers = [];
        this.options = mergedOptions;
     ...
     */
    parse(options, eventDetail) {
        const converter = this, columnsArray = [], headers = [], parseOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(converter.options, options), { endRow, startColumn, endColumn, firstRowAsNames } = parseOptions, tableHTML = parseOptions.tableElement || this.tableElement;
...
class HTMLTableConnector extends Connectors_DataConnector {
     ...
     */
    constructor(options) {
        const mergedOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(HTMLTableConnector.defaultOptions, options);
        super(mergedOptions);
        this.options = mergedOptions;
    ...
    async load(eventDetail) {
        ...
        const columns = converter.parse((0,external_highcharts_src_js_default_namespaceObject.merge)({ tableElement: connector.tableElement }, options), eventDetail);
...
class ChainModifier extends Modifiers_DataModifier {
    ...
    constructor(options, ...chain) {
        super();
        this.chain = chain;
        this.options = (0,external_highcharts_src_js_default_namespaceObject.merge)(ChainModifier.defaultOptions, options);
...
class InvertModifier extends Modifiers_DataModifier {
    ...
    constructor(options) {
        super();
        this.options = (0,external_highcharts_src_js_default_namespaceObject.merge)(InvertModifier.defaultOptions, options);
    }
    /* *
     *
     *  Functions
...
class RangeModifier extends Modifiers_DataModifier {
    ...
    constructor(options) {
        super();
        this.options = (0,external_highcharts_src_js_default_namespaceObject.merge)(RangeModifier.defaultOptions, options);
    }
    /* *
     *
     *  Functions
...
class SortModifier extends Modifiers_DataModifier {
    ...
    constructor(options) {
        super();
        this.options = (0,external_highcharts_src_js_default_namespaceObject.merge)(SortModifier.defaultOptions, options);
    }
    /* *
     *
     *  Functions
...
class FilterModifier extends Modifiers_DataModifier {
    ...
    static compile(condition) {
        if ((0,external_highcharts_src_js_default_namespaceObject.isFunction)(condition)) {
            return condition;
        }
    ...
    constructor(options) {
        super();
        this.options = (0,external_highcharts_src_js_default_namespaceObject.merge)(FilterModifier.defaultOptions, options);
    }
    /* *
     *
     *  Functions
