    ...
    translate() {
            ...
            return centerX + (half ? -1 : 1) *
                ((series.getWidthAt(reversed ? 2 * centerY - y : y) / 2) +
                    (point.dataLabel?.dataLabelPosition?.distance ??
                        (0,external_highcharts_src_js_default_namespaceObject.relativeLength)(this.options.dataLabels?.distance || 0, width)));
        };
        // Expose
        ...
        */
        ...
        for (const point of points) {
            ...
            if ((0,external_highcharts_src_js_default_namespaceObject.correctFloat)(y1) >= neckY) {
 ...
 */
PyramidSeries.defaultOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(Funnel_FunnelSeries.defaultOptions, Pyramid_PyramidSeriesDefaults);
