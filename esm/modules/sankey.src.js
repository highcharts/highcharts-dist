...
class SankeyPoint extends ColumnSeries.prototype.pointClass {
    ...
    applyOptions(options, x) {
        ...
        if ((0,external_highcharts_src_js_default_namespaceObject.defined)(this.options.level)) {
    ...
    setNodeColumn() {
        const node = this;
        if (!(0,external_highcharts_src_js_default_namespaceObject.defined)(node.options.column)) {
...
class SankeySeries extends SankeySeries_ColumnSeries {
    ...
    static getDLOptions(params) {
        const optionsPoint = ((0,external_highcharts_src_js_default_namespaceObject.isObject)(params.optionsPoint) ?
            params.optionsPoint.dataLabels :
            {}), optionsLevel = ((0,external_highcharts_src_js_default_namespaceObject.isObject)(params.level) ?
            params.level.dataLabels :
            {}), options = (0,external_highcharts_src_js_default_namespaceObject.merge)({
            style: {}
    ...
    generatePoints() {
        ...
        if (this.orderNodes) {
            ...
            (0,external_highcharts_src_js_default_namespaceObject.stableSort)(this.nodes, (a, b) => (a.level - b.level));
        }
    }
    /**
    ...
    pointAttribs(point, state) {
        ...
        const series = this, level = point.isNode ? point.level : point.fromNode.level, levelOptions = series.mapOptionsToLevel[level || 0] || {}, options = point.options, stateOptions = (levelOptions.states && levelOptions.states[state || '']) || {}, values = [
            ...
            obj[key] = (0,external_highcharts_src_js_default_namespaceObject.pick)(stateOptions[key], options[key], levelOptions[key], series.options[key]);
            return obj;
        }, {}), color = (0,external_highcharts_src_js_default_namespaceObject.pick)(stateOptions.color, options.color, values.colorByPoint ? point.color : levelOptions.color);
        // Node attributes
        if (point.isNode) {
            return {
                fill: color,
    ...
    translateLink(point, linkToY) {
        const fromNode = point.fromNode, toNode = point.toNode, chart = this.chart, { inverted } = chart, translationFactor = this.translationFactor, options = this.options, linkColorMode = (0,external_highcharts_src_js_default_namespaceObject.pick)(point.linkColorMode, options.linkColorMode), curvy = ((chart.inverted ? -this.colDistance : this.colDistance) *
    ...
    translateNode(node, column) {
        ...
        if (sum) {
            ...
            // #18956
            const r = (0,external_highcharts_src_js_default_namespaceObject.clamp)((0,external_highcharts_src_js_default_namespaceObject.relativeLength)((typeof borderRadius === 'object' ?
                borderRadius.radius :
 ...
 *
 * */
SankeySeries.defaultOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(SankeySeries_ColumnSeries.defaultOptions, Sankey_SankeySeriesDefaults);
Series_NodesComposition.compose(Sankey_SankeyPoint, SankeySeries);
(0,external_highcharts_src_js_default_namespaceObject.extend)(SankeySeries.prototype, {
