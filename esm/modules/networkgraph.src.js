...
(function (NodesComposition) {
    ...
    function compose(PointClass, SeriesClass) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(SeriesClass, 'afterUpdate', afterUpdate);
        return SeriesClass;
    }
    ...
    function createNode(id) {
        const PointClass = this.pointClass, findById = (nodes, id) => (0,external_highcharts_src_js_default_namespaceObject.find)(nodes, (node) => node.id === id);
        let node = findById(this.nodes, id), options;
        if (!node) {
            options = this.options.nodes && findById(this.options.nodes, id);
            const newNode = new PointClass(this, (0,external_highcharts_src_js_default_namespaceObject.extend)({
    ...
    function generatePoints() {
        ...
        this.points.forEach((point) => {
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(point.from)) {
            ...
            if ((0,external_highcharts_src_js_default_namespaceObject.defined)(point.to)) {
    ...
    function updateNode(options, redraw, animation, runEvent) {
        ...
        if (this.isNode) {
            ...
            nodeConfig = (0,external_highcharts_src_js_default_namespaceObject.merge)(nodes && nodes[nodeIndex] || {}, data?.[this.index] || {});
            // Restore link config
            if (data) {
                if (linkConfig) {
...
class NetworkgraphPoint extends Point {
    ...
    getLinkAttributes() {
        ...
        return {
            'stroke-width': (0,external_highcharts_src_js_default_namespaceObject.pick)(pointOptions.width, linkOptions.width),
            stroke: (pointOptions.color || linkOptions.color),
            dashstyle: (pointOptions.dashStyle || linkOptions.dashStyle),
            opacity: (0,external_highcharts_src_js_default_namespaceObject.pick)(pointOptions.opacity, linkOptions.opacity, 1)
        };
    }
    /**
    ...
    constructor(series, options, x) {
        ...
        if (this.series.options.draggable &&
            ...
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(this, 'mouseOver', function () {
                (0,external_highcharts_src_js_default_namespaceObject.css)(this.series.chart.container, { cursor: 'move' });
            });
            (0,external_highcharts_src_js_default_namespaceObject.addEvent)(this, 'mouseOut', function () {
                (0,external_highcharts_src_js_default_namespaceObject.css)(this.series.chart.container, { cursor: 'default' });
            });
        }
    }
    /**
     ...
     */
    isValid() {
        return !this.isNode || (0,external_highcharts_src_js_default_namespaceObject.defined)(this.id);
    }
    /**
     * Redraw link's path.
     * @private
...
(0,external_highcharts_src_js_default_namespaceObject.extend)(NetworkgraphPoint.prototype, {
...
const { composed: TextPath_composed, deg2rad } = (external_highcharts_src_js_default_default());
/* *
 *
 *  Functions
 *
...
class NetworkgraphSeries extends Series {
    ...
    generatePoints() {
        ...
        for (i = this.nodes.length - 1; i >= 0; i--) {
            ...
            node.radius = (0,external_highcharts_src_js_default_namespaceObject.pick)(node.marker && node.marker.radius, this.options.marker && this.options.marker.radius, 0);
            node.key = node.name;
    ...
    init(chart, options) {
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(this, 'updatedData', () => {
            if (this.layout) {
                this.layout.stop();
            }
        });
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(this, 'afterUpdate', () => {
            this.nodes.forEach((node) => {
                if (node && node.series) {
                    node.resolveColor();
                }
        ...
        (0,external_highcharts_src_js_default_namespaceObject.addEvent)(this, 'afterSimulation', function () {
            this.deferDataLabels = false;
            this.drawDataLabels();
        });
        return this;
    ...
    markerAttribs(point, state) {
        ...
        if (!(0,external_highcharts_src_js_default_namespaceObject.defined)(point.plotY)) {
            attribs.y = 0;
        }
        ...
        if (point && !point.isNode) {
            ...
            if (stateOptions) {
                attribs = {
                    ...
                    opacity: (0,external_highcharts_src_js_default_namespaceObject.pick)(stateOptions.linkOpacity, attribs.opacity),
...
NetworkgraphSeries.defaultOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)(Series.defaultOptions, Networkgraph_NetworkgraphSeriesDefaults);
(0,external_highcharts_src_js_default_namespaceObject.extend)(NetworkgraphSeries.prototype, {
