...
const ItemSeriesDefaults = {
     ...
     * @extends plotOptions.series.marker
     */
    marker: (0,external_highcharts_src_js_default_namespaceObject.merge)(SeriesDefaults.marker, {
        radius: null
    }),
    /**
...
class ItemSeries extends PieSeries {
        ...
        for (const point of series.points) {
            ...
            if (!point.isNull && point.visible) {
                ...
                for (let val = 0; val < (point.y || 0); ++val) {
                    ...
                    if (pointAttr) {
                        (0,external_highcharts_src_js_default_namespaceObject.extend)(attr, pointAttr);
                    }
    ...
    translate(positions) {
        ...
        if (this.total === 0 && // Check if that is a (semi-)circle
            (0,external_highcharts_src_js_default_namespaceObject.isNumber)(this.options.startAngle) &&
            (0,external_highcharts_src_js_default_namespaceObject.isNumber)(this.options.endAngle)) {
            this.center = this.getCenter();
        }
        if (!this.slots) {
            this.slots = [];
        }
        if ((0,external_highcharts_src_js_default_namespaceObject.isNumber)(this.options.startAngle) &&
            (0,external_highcharts_src_js_default_namespaceObject.isNumber)(this.options.endAngle)) {
