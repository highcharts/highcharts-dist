...
class RenkoSeries extends (external_highcharts_src_js_default_Series_types_column_default()) {
    ...
    getProcessedData() {
        ...
        const change = (0,external_highcharts_src_js_default_namespaceObject.isNumber)(boxSize) ? boxSize : (0,external_highcharts_src_js_default_namespaceObject.relativeLength)(boxSize, yData[0]);
 ...
 *
 * */
RenkoSeries.defaultOptions = (0,external_highcharts_src_js_default_namespaceObject.merge)((external_highcharts_src_js_default_Series_types_column_default()).defaultOptions, RenkoSeriesDefaults);
(0,external_highcharts_src_js_default_namespaceObject.extend)(RenkoSeries.prototype, {
